...
impl StoreNotMatch {
    ...
    // uint64 expect_store_id = 1;

    pub fn clear_expect_store_id(&mut self) {
        self.expect_store_id = 0;
    }

    // Param is passed by value, moved
    pub fn set_expect_store_id(&mut self, v: u64) {
        self.expect_store_id = v;
    }

    pub fn get_expect_store_id(&self) -> u64 {
        self.expect_store_id
    }

    // uint64 requested_store_id = 2;

    pub fn clear_requested_store_id(&mut self) {
        self.requested_store_id = 0;
    }

    // Param is passed by value, moved
    pub fn set_requested_store_id(&mut self, v: u64) {
        self.requested_store_id = v;
    }

    pub fn get_requested_store_id(&self) -> u64 {
        self.requested_store_id
    }
}
...
impl ::protobuf::Message for StoreNotMatch {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.expect_store_id != 0 {
            my_size += ::protobuf::rt::value_size(1, self.expect_store_id, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.requested_store_id != 0 {
            my_size += ::protobuf::rt::value_size(2, self.requested_store_id, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if self.expect_store_id != 0 {
            os.write_uint64(1, self.expect_store_id)?;
        }
        if self.requested_store_id != 0 {
            os.write_uint64(2, self.requested_store_id)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "expect_store_id",
                    |m: &StoreNotMatch| { &m.expect_store_id },
                    |m: &mut StoreNotMatch| { &mut m.expect_store_id },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "requested_store_id",
                    |m: &StoreNotMatch| { &m.requested_store_id },
                    |m: &mut StoreNotMatch| { &mut m.requested_store_id },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    r\"e\n\rStoreNotMatch\x12&\n\x0fexpect_store_id\x18\x01\x20\x01(\x04R\re\
    xpectStoreId\x12,\n\x12requested_store_id\x18\x02\x20\x01(\x04R\x10reque\
    ...
    \x04\x03\x02\x01\x03\x12\x03\x1c\x17\x18\n\x0b\n\x04\x04\x03\x02\x02\x12\
    ...
    \x03\x02\x03\x04\x12\x04\x1e\x04\x1d\x18\n\x0c\n\x05\x04\x03\x02\x03\x05\
