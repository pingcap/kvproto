...
pub struct File {
    ...
    pub first_indexes: ::std::vec::Vec<u64>,
    pub end_indexes: ::std::vec::Vec<u64>,
...
impl File {
    ...
    // repeated uint64 first_indexes = 4;

    pub fn clear_first_indexes(&mut self) {
        self.first_indexes.clear();
    }

    // Param is passed by value, moved
    pub fn set_first_indexes(&mut self, v: ::std::vec::Vec<u64>) {
        self.first_indexes = v;
    }

    // Mutable pointer to the field.
    pub fn mut_first_indexes(&mut self) -> &mut ::std::vec::Vec<u64> {
        &mut self.first_indexes
    }

    // Take field
    pub fn take_first_indexes(&mut self) -> ::std::vec::Vec<u64> {
        ::std::mem::replace(&mut self.first_indexes, ::std::vec::Vec::new())
    }

    pub fn get_first_indexes(&self) -> &[u64] {
        &self.first_indexes
    }

    // repeated uint64 end_indexes = 5;

    pub fn clear_end_indexes(&mut self) {
        self.end_indexes.clear();
    }

    // Param is passed by value, moved
    pub fn set_end_indexes(&mut self, v: ::std::vec::Vec<u64>) {
        self.end_indexes = v;
    }

    // Mutable pointer to the field.
    pub fn mut_end_indexes(&mut self) -> &mut ::std::vec::Vec<u64> {
        &mut self.end_indexes
    }

    // Take field
    pub fn take_end_indexes(&mut self) -> ::std::vec::Vec<u64> {
        ::std::mem::replace(&mut self.end_indexes, ::std::vec::Vec::new())
    }

    pub fn get_end_indexes(&self) -> &[u64] {
        &self.end_indexes
    }
...
impl ::protobuf::Message for File {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_repeated_uint64_into(wire_type, is, &mut self.first_indexes)?;
                },
                5 => {
                    ::protobuf::rt::read_repeated_uint64_into(wire_type, is, &mut self.end_indexes)?;
                },
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.first_indexes {
            my_size += ::protobuf::rt::value_size(4, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.end_indexes {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        for v in &self.first_indexes {
            os.write_uint64(4, *v)?;
        };
        for v in &self.end_indexes {
            os.write_uint64(5, *v)?;
        };
        if self.is_writable != false {
            os.write_bool(6, self.is_writable)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::Clear for File {
    fn clear(&mut self) {
        ...
        self.clear_first_indexes();
        self.clear_end_indexes();
        self.clear_is_writable();
        self.unknown_fields.clear();
    }
}
...
impl crate::text::PbPrint for File {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        crate::text::PbPrint::fmt(&self.first_indexes, "first_indexes", buf);
        crate::text::PbPrint::fmt(&self.end_indexes, "end_indexes", buf);
        crate::text::PbPrint::fmt(&self.is_writable, "is_writable", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for File {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        crate::text::PbPrint::fmt(&self.first_indexes, "first_indexes", &mut s);
        crate::text::PbPrint::fmt(&self.end_indexes, "end_indexes", &mut s);
        crate::text::PbPrint::fmt(&self.is_writable, "is_writable", &mut s);
        write!(f, "{}", s)
    }
}
...
impl BackupLogFileMeta {
    pub fn new() -> BackupLogFileMeta {
        ::std::default::Default::default()
    }

    // repeated .backup.File files = 1;
...
impl ::protobuf::Message for BackupLogFileMeta {
    fn is_initialized(&self) -> bool {
        for v in &self.files {
            if !v.is_initialized() {
                return false;
    ...
    fn new() -> BackupLogFileMeta {
        BackupLogFileMeta::new()
    }

    fn default_instance() -> &'static BackupLogFileMeta {
        static mut instance: ::protobuf::lazy::Lazy<BackupLogFileMeta> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const BackupLogFileMeta,
        };
        unsafe {
            instance.get(BackupLogFileMeta::new)
        }
    }
}

impl ::protobuf::Clear for BackupLogFileMeta {
    fn clear(&mut self) {
        self.clear_files();
        self.unknown_fields.clear();
    }
...
impl crate::text::PbPrint for BackupLogFileMeta {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut String) {
        crate::text::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::std::fmt::Debug for BackupLogFileMeta {
    #[allow(unused_variables)]
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = String::new();
...
impl ::protobuf::reflect::ProtobufValue for BackupLogFileMeta {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
