...
impl PDClient {
    ...
    pub fn region_heartbeat_opt(&self, opt: ::grpc::CallOption) -> ::grpc::Result<::grpc::DuplexStreamingCallHandler<super::pdpb::RegionHeartbeatRequest, super::pdpb::RegionHeartbeatResponse>> {
        self.client.duplex_streaming(&METHOD_REGION_HEARTBEAT, opt)
    }

    pub fn region_heartbeat(&self) -> ::grpc::Result<::grpc::DuplexStreamingCallHandler<super::pdpb::RegionHeartbeatRequest, super::pdpb::RegionHeartbeatResponse>> {
