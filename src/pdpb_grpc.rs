...
impl PDClient {
    ...
    pub fn region_heartbeat_opt(&self, opt: ::grpc::CallOption) -> ::grpc::DuplexCallHandler<super::pdpb::RegionHeartbeatRequest, super::pdpb::RegionHeartbeatResponse> {
        self.client.duplex_streaming(&METHOD_PD_REGION_HEARTBEAT, opt)
    }

    pub fn region_heartbeat(&self) -> ::grpc::DuplexCallHandler<super::pdpb::RegionHeartbeatRequest, super::pdpb::RegionHeartbeatResponse> {
