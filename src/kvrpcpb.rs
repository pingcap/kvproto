...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1e\x01\xc8\xe2\x1e\x01\xe0\xe2\x1e\x01J\xa5\x90\x01\n\x07\x12\x05\0\0\
    ...
    \x94\x01\x20For\x20compability,\x20`start_key`\x20is\x20always\x20inclus\
    ive\x20and\x20`end_key`\x20is\x20always\x20exclusive.\n\x20When\x20`reve\
    rse`\x20is\x20set,\x20`end_key`\x20is\x20an\x20exclusive\x20lower_bound.\
    \n\n\r\n\x05\x04\n\x02\x06\x04\x12\x04f\x04c\x15\n\x0c\n\x05\x04\n\x02\
    \x06\x05\x12\x03f\x04\t\n\x0c\n\x05\x04\n\x02\x06\x01\x12\x03f\n\x11\n\
