        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor(
                    "row_key",
                    CmdGetRequest::has_row_key,
                    CmdGetRequest::get_row_key,
                ));
...
pub struct CmdScanRequest {
    // message fields
    start_row_key: ::protobuf::SingularField<::std::vec::Vec<u8>>,
    columns: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
...
impl CmdScanRequest {
    ...
    pub fn default_instance() -> &'static CmdScanRequest {
        ...
        unsafe {
            instance.get(|| {
                CmdScanRequest {
                    start_row_key: ::protobuf::SingularField::none(),
                    columns: ::protobuf::RepeatedField::new(),
    ...
    // optional bytes start_row_key = 1;

    pub fn clear_start_row_key(&mut self) {
        self.start_row_key.clear();
    }

    pub fn has_start_row_key(&self) -> bool {
        self.start_row_key.is_some()
    }

    // Param is passed by value, moved
    pub fn set_start_row_key(&mut self, v: ::std::vec::Vec<u8>) {
        self.start_row_key = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_start_row_key(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.start_row_key.is_none() {
            self.start_row_key.set_default();
        };
        self.start_row_key.as_mut().unwrap()
    }

    // Take field
    pub fn take_start_row_key(&mut self) -> ::std::vec::Vec<u8> {
        self.start_row_key.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }

    pub fn get_start_row_key(&self) -> &[u8] {
        match self.start_row_key.as_ref() {
            Some(v) => &v,
            None => &[],
        }
    }
...
impl ::protobuf::Message for CmdScanRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !try!(is.eof()) {
            ...
            match field_number {
                1 => {
                    try!(::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.start_row_key));
                },
                2 => {
                    try!(::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.columns));
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in self.start_row_key.iter() {
            my_size += ::protobuf::rt::bytes_size(1, &value);
        };
        for value in self.columns.iter() {
            my_size += ::protobuf::rt::bytes_size(2, &value);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if let Some(v) = self.start_row_key.as_ref() {
            try!(os.write_bytes(1, &v));
        };
        for v in self.columns.iter() {
            try!(os.write_bytes(2, &v));
    ...
    fn descriptor_static(_: ::std::option::Option<CmdScanRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor(
                    "start_row_key",
                    CmdScanRequest::has_start_row_key,
                    CmdScanRequest::get_start_row_key,
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_bytes_accessor(
                    "columns",
...
impl ::std::cmp::PartialEq for CmdScanRequest {
    fn eq(&self, other: &CmdScanRequest) -> bool {
        self.start_row_key == other.start_row_key &&
        self.columns == other.columns &&
...
impl ::protobuf::Message for CmdCommitRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in self.row_keys.iter() {
            my_size += ::protobuf::rt::bytes_size(2, &value);
        };
    ...
    fn descriptor_static(_: ::std::option::Option<CmdBatchRollbackRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_bytes_accessor(
                    "row_keys",
                    CmdBatchRollbackRequest::get_row_keys,
                ));
    ...
    fn descriptor_static(_: ::std::option::Option<CmdCleanupRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor(
                    "row_key",
                    CmdCleanupRequest::has_row_key,
                    CmdCleanupRequest::get_row_key,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor(
                    "ts",
    ...
    fn descriptor_static(_: ::std::option::Option<CmdRollbackThenGetRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor(
                    "row_key",
                    CmdRollbackThenGetRequest::has_row_key,
                    CmdRollbackThenGetRequest::get_row_key,
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_bytes_accessor(
                    "columns",
    ...
    fn descriptor_static(_: ::std::option::Option<CmdCommitThenGetRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_bytes_accessor(
                    "row_key",
                    CmdCommitThenGetRequest::has_row_key,
                    CmdCommitThenGetRequest::get_row_key,
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_bytes_accessor(
                    "columns",
    ...
    fn descriptor_static(_: ::std::option::Option<CmdBatchGetRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_bytes_accessor(
                    "row_keys",
                    CmdBatchGetRequest::get_row_keys,
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_message_accessor(
                    "columns",
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    0x01, 0x02, 0x00, 0x12, 0x03, 0x1e, 0x04, 0x21, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x01, 0x02, 0x00,
    ...
    0x15, 0x1c, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x01, 0x02, 0x00, 0x03, 0x12, 0x03, 0x1e, 0x1f, 0x20,
    0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x01, 0x02, 0x01, 0x12, 0x03, 0x1f, 0x04, 0x21, 0x0a, 0x0c, 0x0a,
    ...
    0x12, 0x03, 0x1f, 0x1f, 0x20, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x01, 0x02, 0x02, 0x12, 0x03, 0x20,
    0x04, 0x21, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x01, 0x02, 0x02, 0x04, 0x12, 0x03, 0x20, 0x04, 0x0c,
    ...
    0x04, 0x01, 0x02, 0x02, 0x03, 0x12, 0x03, 0x20, 0x1f, 0x20, 0x0a, 0x0a, 0x0a, 0x02, 0x04, 0x02,
    ...
    0x0b, 0x0a, 0x04, 0x04, 0x03, 0x02, 0x00, 0x12, 0x03, 0x28, 0x04, 0x26, 0x0a, 0x0c, 0x0a, 0x05,
    ...
    0x01, 0x12, 0x03, 0x28, 0x14, 0x21, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x03, 0x02, 0x00, 0x03, 0x12,
    0x03, 0x28, 0x24, 0x25, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x03, 0x02, 0x01, 0x12, 0x03, 0x29, 0x04,
    0x26, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x03, 0x02, 0x01, 0x04, 0x12, 0x03, 0x29, 0x04, 0x0c, 0x0a,
    ...
    0x03, 0x02, 0x01, 0x03, 0x12, 0x03, 0x29, 0x24, 0x25, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x03, 0x02,
    0x02, 0x12, 0x03, 0x2a, 0x04, 0x26, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x03, 0x02, 0x02, 0x04, 0x12,
    ...
    0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x03, 0x02, 0x02, 0x03, 0x12, 0x03, 0x2a, 0x24, 0x25, 0x0a, 0x0b,
    0x0a, 0x04, 0x04, 0x03, 0x02, 0x03, 0x12, 0x03, 0x2b, 0x04, 0x26, 0x0a, 0x0c, 0x0a, 0x05, 0x04,
    ...
    0x2b, 0x24, 0x25, 0x0a, 0x0a, 0x0a, 0x02, 0x04, 0x04, 0x12, 0x04, 0x2e, 0x00, 0x30, 0x01, 0x0a,
    ...
    0x02, 0x01, 0x01, 0x12, 0x03, 0x3e, 0x15, 0x1d, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x07, 0x02, 0x01,
    ...
    0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x09, 0x02, 0x00, 0x12, 0x03, 0x47, 0x04, 0x21, 0x0a, 0x0c, 0x0a,
    ...
    0x12, 0x03, 0x47, 0x1f, 0x20, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x09, 0x02, 0x01, 0x12, 0x03, 0x48,
    0x04, 0x21, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x09, 0x02, 0x01, 0x04, 0x12, 0x03, 0x48, 0x04, 0x0c,
    0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x09, 0x02, 0x01, 0x05, 0x12, 0x03, 0x48, 0x0d, 0x12, 0x0a, 0x0c,
    0x0a, 0x05, 0x04, 0x09, 0x02, 0x01, 0x01, 0x12, 0x03, 0x48, 0x14, 0x1c, 0x0a, 0x0c, 0x0a, 0x05,
    0x04, 0x09, 0x02, 0x01, 0x03, 0x12, 0x03, 0x48, 0x1f, 0x20, 0x0a, 0x0a, 0x0a, 0x02, 0x04, 0x0a,
    ...
    0x0b, 0x0a, 0x04, 0x04, 0x0b, 0x02, 0x00, 0x12, 0x03, 0x50, 0x04, 0x20, 0x0a, 0x0c, 0x0a, 0x05,
    ...
    0x01, 0x12, 0x03, 0x50, 0x14, 0x1b, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x0b, 0x02, 0x00, 0x03, 0x12,
    0x03, 0x50, 0x1e, 0x1f, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x0b, 0x02, 0x01, 0x12, 0x03, 0x51, 0x04,
    0x20, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x0b, 0x02, 0x01, 0x04, 0x12, 0x03, 0x51, 0x04, 0x0c, 0x0a,
    ...
    0x0b, 0x02, 0x01, 0x03, 0x12, 0x03, 0x51, 0x1e, 0x1f, 0x0a, 0x0a, 0x0a, 0x02, 0x04, 0x0c, 0x12,
    ...
    0x00, 0x01, 0x12, 0x03, 0x5a, 0x14, 0x1b, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x0d, 0x02, 0x00, 0x03,
    ...
    0x05, 0x04, 0x0f, 0x02, 0x00, 0x01, 0x12, 0x03, 0x64, 0x14, 0x1b, 0x0a, 0x0c, 0x0a, 0x05, 0x04,
    ...
    0x0b, 0x0a, 0x04, 0x04, 0x12, 0x02, 0x00, 0x12, 0x03, 0x74, 0x04, 0x22, 0x0a, 0x0c, 0x0a, 0x05,
    ...
    0x01, 0x12, 0x03, 0x74, 0x15, 0x1d, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x12, 0x02, 0x00, 0x03, 0x12,
    0x03, 0x74, 0x20, 0x21, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x12, 0x02, 0x01, 0x12, 0x03, 0x75, 0x04,
    0x22, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x12, 0x02, 0x01, 0x04, 0x12, 0x03, 0x75, 0x04, 0x0c, 0x0a,
    ...
    0x12, 0x02, 0x01, 0x03, 0x12, 0x03, 0x75, 0x20, 0x21, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x12, 0x02,
    0x02, 0x12, 0x03, 0x76, 0x04, 0x22, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x12, 0x02, 0x02, 0x04, 0x12,
    ...
    0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x12, 0x02, 0x02, 0x03, 0x12, 0x03, 0x76, 0x20, 0x21, 0x0a, 0x0a,
