    ...
    fn descriptor_static(_: ::std::option::Option<RaftState>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor(
                    "hard_state",
                    RaftState::has_hard_state,
                    RaftState::get_hard_state,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor(
                    "applied_index",
                    RaftState::has_applied_index,
                    RaftState::get_applied_index,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor(
                    "last_index",
                    RaftState::has_last_index,
                    RaftState::get_last_index,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor(
                    "truncated_state",
                    RaftState::has_truncated_state,
                    RaftState::get_truncated_state,
                ));
...
impl ::std::cmp::PartialEq for RaftState {
    fn eq(&self, other: &RaftState) -> bool {
...
pub struct RegionLocalState {
    // message fields
    peer: ::std::option::Option<PeerState>,
    raft: ::protobuf::SingularPtrField<RaftState>,
    tombstone_epoch: ::protobuf::SingularPtrField<super::metapb::RegionEpoch>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::std::cell::Cell<u32>,
}
...
impl RegionLocalState {
        ...
        unsafe {
            instance.get(|| {
                RegionLocalState {
                    ...
                    tombstone_epoch: ::protobuf::SingularPtrField::none(),
                    unknown_fields: ::protobuf::UnknownFields::new(),
                    cached_size: ::std::cell::Cell::new(0),
                }
            })
    ...
    // optional .raft_serverpb.PeerState peer = 1;
    ...
    // Param is passed by value, moved
    pub fn set_peer(&mut self, v: PeerState) {
        self.peer = ::std::option::Option::Some(v);
    }

    pub fn get_peer(&self) -> PeerState {
        self.peer.unwrap_or(PeerState::Normal)
    }

    // optional .raft_serverpb.RaftState raft = 2;
    ...
    // Param is passed by value, moved
    pub fn set_raft(&mut self, v: RaftState) {
        self.raft = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_raft(&mut self) -> &mut RaftState {
    ...
    // Take field
    pub fn take_raft(&mut self) -> RaftState {
        self.raft.take().unwrap_or_else(|| RaftState::new())
    }

    pub fn get_raft(&self) -> &RaftState {
        self.raft.as_ref().unwrap_or_else(|| RaftState::default_instance())
    }

    // optional .metapb.RegionEpoch tombstone_epoch = 3;

    pub fn clear_tombstone_epoch(&mut self) {
        self.tombstone_epoch.clear();
    }

    pub fn has_tombstone_epoch(&self) -> bool {
        self.tombstone_epoch.is_some()
    }

    // Param is passed by value, moved
    pub fn set_tombstone_epoch(&mut self, v: super::metapb::RegionEpoch) {
        self.tombstone_epoch = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_tombstone_epoch(&mut self) -> &mut super::metapb::RegionEpoch {
        if self.tombstone_epoch.is_none() {
            self.tombstone_epoch.set_default();
        };
        self.tombstone_epoch.as_mut().unwrap()
    }

    // Take field
    pub fn take_tombstone_epoch(&mut self) -> super::metapb::RegionEpoch {
        self.tombstone_epoch.take().unwrap_or_else(|| super::metapb::RegionEpoch::new())
    }

    pub fn get_tombstone_epoch(&self) -> &super::metapb::RegionEpoch {
        self.tombstone_epoch.as_ref().unwrap_or_else(|| super::metapb::RegionEpoch::default_instance())
    }
}
...
impl ::protobuf::Message for RegionLocalState {
        ...
        while !try!(is.eof()) {
            ...
            match field_number {
                1 => {
                    ...
                    self.peer = ::std::option::Option::Some(tmp);
                },
                2 => {
                    try!(::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.raft));
                },
                3 => {
                    try!(::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.tombstone_epoch));
                },
                _ => {
                    try!(::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields()));
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in self.tombstone_epoch.iter() {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if let Some(v) = self.tombstone_epoch.as_ref() {
            try!(os.write_tag(3, ::protobuf::wire_format::WireTypeLengthDelimited));
            try!(os.write_raw_varint32(v.get_cached_size()));
            try!(v.write_to_with_cached_sizes(os));
        };
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_enum_accessor(
                    "peer",
                    RegionLocalState::has_peer,
                    RegionLocalState::get_peer,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor(
                    "raft",
                    RegionLocalState::has_raft,
                    RegionLocalState::get_raft,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor(
                    "tombstone_epoch",
                    RegionLocalState::has_tombstone_epoch,
                    RegionLocalState::get_tombstone_epoch,
                ));
...
impl ::std::cmp::PartialEq for RegionLocalState {
    fn eq(&self, other: &RegionLocalState) -> bool {
        ...
        self.tombstone_epoch == other.tombstone_epoch &&
        self.unknown_fields == other.unknown_fields
    }
}
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    ,
    ...
    0x04, 0x31, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x00, 0x04, 0x12, 0x03, 0x07, 0x04, 0x0c,
    ...
    0x04, 0x00, 0x02, 0x00, 0x03, 0x12, 0x03, 0x07, 0x2f, 0x30, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x00,
    0x02, 0x01, 0x12, 0x03, 0x08, 0x04, 0x31, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x01, 0x04,
    ...
    0x22, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x01, 0x03, 0x12, 0x03, 0x08, 0x2f, 0x30, 0x0a,
    0x0b, 0x0a, 0x04, 0x04, 0x00, 0x02, 0x02, 0x12, 0x03, 0x09, 0x04, 0x31, 0x0a, 0x0c, 0x0a, 0x05,
    ...
    0x03, 0x09, 0x2f, 0x30, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x00, 0x02, 0x03, 0x12, 0x03, 0x0a, 0x04,
    0x31, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x03, 0x04, 0x12, 0x03, 0x0a, 0x04, 0x0c, 0x0a,
    0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x03, 0x06, 0x12, 0x03, 0x0a, 0x0d, 0x1b, 0x0a, 0x0c, 0x0a,
    0x05, 0x04, 0x00, 0x02, 0x03, 0x01, 0x12, 0x03, 0x0a, 0x1c, 0x23, 0x0a, 0x0c, 0x0a, 0x05, 0x04,
    0x00, 0x02, 0x03, 0x03, 0x12, 0x03, 0x0a, 0x2f, 0x30, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x00, 0x02,
    0x04, 0x12, 0x03, 0x0b, 0x04, 0x31, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x04, 0x04, 0x12,
    ...
    ,
];
