...
impl RaftMessage {
    ...
    fn get_merge_target_for_reflect(&self) -> &::protobuf::SingularPtrField<super::metapb::Region> {
        &self.merge_target
    }

    fn mut_merge_target_for_reflect(&mut self) -> &mut ::protobuf::SingularPtrField<super::metapb::Region> {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::metapb::Region>>(
                    "merge_target",
                    RaftMessage::get_merge_target_for_reflect,
                    RaftMessage::mut_merge_target_for_reflect,
                ));
