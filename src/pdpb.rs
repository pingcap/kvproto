...
impl RegionHeartbeatRequest {
    ...
    // uint64 approximate_write_keys = 13;

    pub fn clear_approximate_write_keys(&mut self) {
        self.approximate_write_keys = 0;
    }

    // Param is passed by value, moved
    pub fn set_approximate_write_keys(&mut self, v: u64) {
        self.approximate_write_keys = v;
    }

    pub fn get_approximate_write_keys(&self) -> u64 {
        self.approximate_write_keys
    }
}
...
impl ::protobuf::Message for RegionHeartbeatRequest {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                13 => {
                    ...
                    let tmp = is.read_uint64()?;
                    self.approximate_write_keys = tmp;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.approximate_write_keys != 0 {
            my_size += ::protobuf::rt::value_size(13, self.approximate_write_keys, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.approximate_write_keys != 0 {
            os.write_uint64(13, self.approximate_write_keys)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    ...
                    |m: &RegionHeartbeatRequest| { &m.approximate_write_keys },
                    |m: &mut RegionHeartbeatRequest| { &mut m.approximate_write_keys },
                ));
...
impl ::protobuf::Clear for RegionHeartbeatRequest {
    fn clear(&mut self) {
        ...
        self.clear_interval();
        self.clear_approximate_write_keys();
        self.unknown_fields.clear();
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x124\n\x16approximate_write_keys\x18\r\x20\x01(\x04R\x14approximateWrit\
    eKeysJ\x04\x08\x0b\x10\x0c\"h\n\nChangePeer\x12\x20\n\x04peer\x18\x01\
    \x20\x01(\x0b2\x0c.metapb.PeerR\x04peer\x128\n\x0bchange_type\x18\x02\
    \x20\x01(\x0e2\x17.eraftpb.ConfChangeTypeR\nchangeType\"2\n\x0eTransferL\
    eader\x12\x20\n\x04peer\x18\x01\x20\x01(\x0b2\x0c.metapb.PeerR\x04peer\"\
    /\n\x05Merge\x12&\n\x06target\x18\x01\x20\x01(\x0b2\x0e.metapb.RegionR\
    ...
    \x02\x20\x01(\x04R\x0cnewSafePoint*e\n\tErrorType\x12\x06\n\x02OK\x10\0\
    ...
    p.tikv.kvproto\xe0\xe2\x1e\x01\xc8\xe2\x1e\x01\xd0\xe2\x1e\x01J\xebu\n\
    ...
    \xfa\x01\x1c\x1e\n7\n\x04\x04\x1d\x02\x0b\x12\x04\xfc\x01\x04'\x1a)\x20A\
    pproximate\x20number\x20of\x20keys\x20in\x20write\x20cf.\n\n\x0f\n\x05\
    \x04\x1d\x02\x0b\x04\x12\x06\xfc\x01\x04\xfa\x01\x1f\n\r\n\x05\x04\x1d\
    \x02\x0b\x05\x12\x04\xfc\x01\x04\n\n\r\n\x05\x04\x1d\x02\x0b\x01\x12\x04\
    \xfc\x01\x0b!\n\r\n\x05\x04\x1d\x02\x0b\x03\x12\x04\xfc\x01$&\n\x0c\n\
    ...
    \x04\x1e\x02\0\x06\x12\x04\x80\x02\x04\x0f\n\r\n\x05\x04\x1e\x02\0\x01\
    \x12\x04\x80\x02\x10\x14\n\r\n\x05\x04\x1e\x02\0\x03\x12\x04\x80\x02\x17\
    \x18\n\x0c\n\x04\x04\x1e\x02\x01\x12\x04\x81\x02\x04+\n\x0f\n\x05\x04\
    \x1e\x02\x01\x04\x12\x06\x81\x02\x04\x80\x02\x19\n\r\n\x05\x04\x1e\x02\
    \x01\x06\x12\x04\x81\x02\x04\x1a\n\r\n\x05\x04\x1e\x02\x01\x01\x12\x04\
