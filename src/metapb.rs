...
impl ::protobuf::Message for Region {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.last_split_timestamp != 0 {
            my_size += ::protobuf::rt::value_size(6, self.last_split_timestamp, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
...
impl ::protobuf::Clear for Region {
    fn clear(&mut self) {
        ...
        self.clear_peers();
        self.clear_last_split_timestamp();
        self.unknown_fields.clear();
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\x04R\x07version\"\xdc\x01\n\x06Region\x12\x0e\n\x02id\
    ...
    tikv.kvproto\xc8\xe2\x1e\x01\xd0\xe2\x1e\x01\xe0\xe2\x1e\x01J\xa9\x12\n\
    \x06\x12\x04\0\0<\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\
    \x12\x03\x01\x08\x0e\n\t\n\x02\x03\0\x12\x03\x03\x07\x1d\n\x08\n\x01\x08\
    \x12\x03\x05\0(\n\x0b\n\x04\x08\xe7\x07\0\x12\x03\x05\0(\n\x0c\n\x05\x08\
    \xe7\x07\0\x02\x12\x03\x05\x07\x20\n\r\n\x06\x08\xe7\x07\0\x02\0\x12\x03\
