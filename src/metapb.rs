...
pub struct StoreLabel {
    // message fields
    key: ::std::option::Option<::protobuf::chars::Chars>,
    value: ::std::option::Option<::protobuf::chars::Chars>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl StoreLabel {
    ...
    pub fn mut_key(&mut self) -> &mut ::protobuf::chars::Chars {
        if self.key.is_none() {
            self.key = ::std::option::Option::Some(::protobuf::chars::Chars::new());
        }
    ...
    pub fn take_key(&mut self) -> ::protobuf::chars::Chars {
        self.key.take().unwrap_or_else(|| ::protobuf::chars::Chars::new())
    }
    ...
    fn get_key_for_reflect(&self) -> &::std::option::Option<::protobuf::chars::Chars> {
        &self.key
    }

    fn mut_key_for_reflect(&mut self) -> &mut ::std::option::Option<::protobuf::chars::Chars> {
        &mut self.key
    }
    ...
    pub fn mut_value(&mut self) -> &mut ::protobuf::chars::Chars {
        if self.value.is_none() {
            self.value = ::std::option::Option::Some(::protobuf::chars::Chars::new());
        }
    ...
    pub fn take_value(&mut self) -> ::protobuf::chars::Chars {
        self.value.take().unwrap_or_else(|| ::protobuf::chars::Chars::new())
    }
    ...
    fn get_value_for_reflect(&self) -> &::std::option::Option<::protobuf::chars::Chars> {
        &self.value
    }

    fn mut_value_for_reflect(&mut self) -> &mut ::std::option::Option<::protobuf::chars::Chars> {
        &mut self.value
    }
}
...
pub struct Store {
    // message fields
    id: ::std::option::Option<u64>,
    address: ::std::option::Option<::protobuf::chars::Chars>,
...
impl Store {
    ...
    pub fn mut_address(&mut self) -> &mut ::protobuf::chars::Chars {
        if self.address.is_none() {
            self.address = ::std::option::Option::Some(::protobuf::chars::Chars::new());
        }
    ...
    pub fn take_address(&mut self) -> ::protobuf::chars::Chars {
        self.address.take().unwrap_or_else(|| ::protobuf::chars::Chars::new())
    }
    ...
    fn get_address_for_reflect(&self) -> &::std::option::Option<::protobuf::chars::Chars> {
        &self.address
    }

    fn mut_address_for_reflect(&mut self) -> &mut ::std::option::Option<::protobuf::chars::Chars> {
        &mut self.address
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_carllerche_string_into(wire_type, is, &mut self.address)?;
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
...
pub struct Region {
    // message fields
    id: ::std::option::Option<u64>,
    start_key: ::std::option::Option<::bytes::Bytes>,
    end_key: ::std::option::Option<::bytes::Bytes>,
...
impl Region {
    ...
    pub fn set_start_key(&mut self, v: ::bytes::Bytes) {
        self.start_key = ::std::option::Option::Some(v);
    }
    ...
    pub fn mut_start_key(&mut self) -> &mut ::bytes::Bytes {
        if self.start_key.is_none() {
            self.start_key = ::std::option::Option::Some(::bytes::Bytes::new());
        }
    ...
    pub fn take_start_key(&mut self) -> ::bytes::Bytes {
        self.start_key.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    fn get_start_key_for_reflect(&self) -> &::std::option::Option<::bytes::Bytes> {
        &self.start_key
    }

    fn mut_start_key_for_reflect(&mut self) -> &mut ::std::option::Option<::bytes::Bytes> {
        &mut self.start_key
    }
    ...
    pub fn set_end_key(&mut self, v: ::bytes::Bytes) {
        self.end_key = ::std::option::Option::Some(v);
    }
    ...
    pub fn mut_end_key(&mut self) -> &mut ::bytes::Bytes {
        if self.end_key.is_none() {
            self.end_key = ::std::option::Option::Some(::bytes::Bytes::new());
        }
    ...
    pub fn take_end_key(&mut self) -> ::bytes::Bytes {
        self.end_key.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    fn get_end_key_for_reflect(&self) -> &::std::option::Option<::bytes::Bytes> {
        &self.end_key
    }

    fn mut_end_key_for_reflect(&mut self) -> &mut ::std::option::Option<::bytes::Bytes> {
        &mut self.end_key
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_carllerche_bytes_into(wire_type, is, &mut self.start_key)?;
                },
                3 => {
                    ::protobuf::rt::read_singular_carllerche_bytes_into(wire_type, is, &mut self.end_key)?;
                },
                4 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04\xc8\xde\x1f\0\x12*\n\x0emax_peer_count\x18\x02\x20\x01(\rR\x0cmaxPe\
    erCountB\x04\xc8\xde\x1f\0\"@\n\nStoreLabel\x12\x16\n\x03key\x18\x01\x20\
    \x01(\tR\x03keyB\x04\xc8\xde\x1f\0\x12\x1a\n\x05value\x18\x02\x20\x01(\t\
    R\x05valueB\x04\xc8\xde\x1f\0\"\x99\x01\n\x05Store\x12\x14\n\x02id\x18\
    \x01\x20\x01(\x04R\x02idB\x04\xc8\xde\x1f\0\x12\x1e\n\x07address\x18\x02\
    \x20\x01(\tR\x07addressB\x04\xc8\xde\x1f\0\x12.\n\x05state\x18\x03\x20\
    \x01(\x0e2\x12.metapb.StoreStateR\x05stateB\x04\xc8\xde\x1f\0\x12*\n\x06\
    labels\x18\x04\x20\x03(\x0b2\x12.metapb.StoreLabelR\x06labels\"N\n\x0bRe\
    gionEpoch\x12\x1f\n\x08conf_ver\x18\x01\x20\x01(\x04R\x07confVerB\x04\
    \xc8\xde\x1f\0\x12\x1e\n\x07version\x18\x02\x20\x01(\x04R\x07versionB\
    \x04\xc8\xde\x1f\0\"\xb0\x01\n\x06Region\x12\x14\n\x02id\x18\x01\x20\x01\
    (\x04R\x02idB\x04\xc8\xde\x1f\0\x12\x1b\n\tstart_key\x18\x02\x20\x01(\
    ...
    \xc8\xde\x1f\0\x12\x1f\n\x08store_id\x18\x02\x20\x01(\x04R\x07storeIdB\
    \x04\xc8\xde\x1f\0*0\n\nStoreState\x12\x06\n\x02Up\x10\0\x12\x0b\n\x07Of\
    fline\x10\x01\x12\r\n\tTombstone\x10\x02B.\n\x18com.pingcap.tikv.kvproto\
    \xd0\xe2\x1e\x01\xe0\xe2\x1e\x01\xa0\xa7\x08\x01\xc8\xe2\x1e\x01\x98\xa7\
    \x08\x01J\xb5\x1c\n\x06\x12\x04\0\0>\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12