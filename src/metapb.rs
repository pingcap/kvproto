...
impl ::protobuf::ProtobufEnum for MergeDirection {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<MergeDirection> {
        match value {
            0 => ::std::option::Option::Some(MergeDirection::Forward),
            1 => ::std::option::Option::Some(MergeDirection::Backward),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [MergeDirection] = &[
    ...
    fn enum_descriptor_static(_: ::std::option::Option<MergeDirection>) -> &'static ::protobuf::reflect::EnumDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::EnumDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new("MergeDirection", file_descriptor_proto())
            })
        }
    }
}

impl ::std::marker::Copy for MergeDirection {
}

impl ::std::default::Default for MergeDirection {
    fn default() -> Self {
        MergeDirection::Forward
    }
}

impl ::protobuf::reflect::ProtobufValue for MergeDirection {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Enum(self.descriptor())
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    rgeDirection\x12\x0b\n\x07Forward\x10\0\x12\x0c\n\x08Backward\x10\x01B&\
    ...
    \0\x12\x03\x07\x07\"\n\x0e\n\x07\x08\xe7\x07\x02\x02\0\x01\x12\x03\x07\
    ...
    \x01\n\x04\x04\0\x02\x01\x12\x03\x0f\x04\x1e\x1a\\\x20max\x20peer\x20cou\
    nt\x20for\x20a\x20region.\n\x20pd\x20will\x20do\x20the\x20auto-balance\
    \x20if\x20region\x20peer\x20count\x20mismatches.\n\"\x17\x20more\x20attr\
