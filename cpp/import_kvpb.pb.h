...
#define PROTOBUF_INTERNAL_EXPORT_import_5fkvpb_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_import_5fkvpb_2eproto {
...
enum Mutation_OP {
  Mutation_OP_Put = 0,
  Mutation_OP_Mutation_OP_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  Mutation_OP_Mutation_OP_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class SwitchModeRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:import_kvpb.SwitchModeRequest) */ {
 ...
 private:
  ...
  friend struct ::TableStruct_import_5fkvpb_2eproto;
};
// -------------------------------------------------------------------
