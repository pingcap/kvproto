...
enum PeerState {
  ...
  Tombstone = 2,
  Merging = 3,
  PeerState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  PeerState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
inline void RaftSnapshotData::clear_file_size() {
  file_size_ = GOOGLE_PROTOBUF_ULONGLONG(0);
}
