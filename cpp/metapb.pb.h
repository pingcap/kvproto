...
enum StoreState {
  ...
  Offline = 1,
  Tombstone = 2,
  StoreState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  StoreState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
inline void RegionEpoch::clear_conf_ver() {
  conf_ver_ = GOOGLE_PROTOBUF_ULONGLONG(0);
}
