...
#define PROTOBUF_INTERNAL_EXPORT_import_5fsstpb_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_import_5fsstpb_2eproto {
...
enum SwitchMode {
  Normal = 0,
  Import = 1,
  SwitchMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  SwitchMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class SwitchModeRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:import_sstpb.SwitchModeRequest) */ {
 ...
 private:
  ...
  friend struct ::TableStruct_import_5fsstpb_2eproto;
};
// -------------------------------------------------------------------
...
inline void SSTMeta::clear_length() {
  length_ = GOOGLE_PROTOBUF_ULONGLONG(0);
}
...
inline void UploadRequest::set_allocated_data(::std::string* data) {
  ...
  if (data != NULL) {
    set_has_data();
    chunk_.data_.UnsafeSetDefault(data);
  }
