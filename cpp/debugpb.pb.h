...
#define PROTOBUF_INTERNAL_EXPORT_debugpb_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_debugpb_2eproto {
...
enum DB {
  ...
  KV = 1,
  RAFT = 2,
  DB_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  DB_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
enum MODULE {
  ...
  SECURITY = 9,
  IMPORT = 10,
  MODULE_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  MODULE_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
enum BottommostLevelCompaction {
  ...
  BottommostLevelCompaction_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  BottommostLevelCompaction_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class GetRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:debugpb.GetRequest) */ {
 ...
 private:
  ...
  friend struct ::TableStruct_debugpb_2eproto;
};
// -------------------------------------------------------------------
...
inline void RaftLogRequest::clear_log_index() {
  log_index_ = GOOGLE_PROTOBUF_ULONGLONG(0);
}
