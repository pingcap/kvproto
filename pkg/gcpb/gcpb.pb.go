...
/*
Package gcpb is a generated protocol buffer package.
...
func (ErrorType) EnumDescriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{0} }
...
func (*RequestHeader) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{0} }
...
func (*ResponseHeader) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{1} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{2} }
...
func (*KeySpace) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{3} }
...
func (*ListKeySpacesRequest) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{4} }
...
type ListKeySpacesResponse struct {
	...
	KeySpaces []*KeySpace     `protobuf:"bytes,2,rep,name=key_spaces,json=keySpaces" json:"key_spaces,omitempty"`
}
...
func (*ListKeySpacesResponse) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{5} }
...
func (*GetMinServiceSafePointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorGcpb, []int{6}
}
...
func (*GetMinServiceSafePointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorGcpb, []int{7}
}
...
func (*UpdateGCSafePointRequest) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{8} }
...
func (*UpdateGCSafePointResponse) Descriptor() ([]byte, []int) { return fileDescriptorGcpb, []int{9} }
...
func (*UpdateServiceSafePointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorGcpb, []int{10}
}
...
func (*UpdateServiceSafePointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorGcpb, []int{11}
}
...
func (c *gCClient) ListKeySpaces(ctx context.Context, in *ListKeySpacesRequest, opts ...grpc.CallOption) (*ListKeySpacesResponse, error) {
	...
	err := grpc.Invoke(ctx, "/gcpb.GC/ListKeySpaces", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gCClient) GetMinServiceSafePoint(ctx context.Context, in *GetMinServiceSafePointRequest, opts ...grpc.CallOption) (*GetMinServiceSafePointResponse, error) {
	...
	err := grpc.Invoke(ctx, "/gcpb.GC/GetMinServiceSafePoint", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gCClient) UpdateGCSafePoint(ctx context.Context, in *UpdateGCSafePointRequest, opts ...grpc.CallOption) (*UpdateGCSafePointResponse, error) {
	...
	err := grpc.Invoke(ctx, "/gcpb.GC/UpdateGCSafePoint", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gCClient) UpdateServiceSafePoint(ctx context.Context, in *UpdateServiceSafePointRequest, opts ...grpc.CallOption) (*UpdateServiceSafePointResponse, error) {
	...
	err := grpc.Invoke(ctx, "/gcpb.GC/UpdateServiceSafePoint", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *ResponseHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintGcpb(dAtA, i, uint64(m.Error.Size()))
...
func (m *ListKeySpacesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Header != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintGcpb(dAtA, i, uint64(m.Header.Size()))
...
func (m *ListKeySpacesResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.KeySpaces) > 0 {
		for _, msg := range m.KeySpaces {
			dAtA[i] = 0x12
			i++
			i = encodeVarintGcpb(dAtA, i, uint64(msg.Size()))
...
func init() { proto.RegisterFile("gcpb.proto", fileDescriptorGcpb) }

var fileDescriptorGcpb = []byte{
