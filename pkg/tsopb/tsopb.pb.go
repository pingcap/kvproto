...
type FindGroupByKeyspaceIDRequest struct {
	...
	ModVision  uint64         `protobuf:"varint,3,opt,name=mod_vision,json=modVision,proto3" json:"mod_vision,omitempty"`
}
...
func (m *FindGroupByKeyspaceIDRequest) GetModVision() uint64 {
	if m != nil {
		return m.ModVision
	}
	return 0
...
func (m *FindGroupByKeyspaceIDResponse) GetModVision() uint64 {
	if m != nil {
		return m.ModVision
	}
	return 0
...
var fileDescriptor_ad96434e4f0d3c2b = []byte{
	...
	,
}
...
func (m *FindGroupByKeyspaceIDRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ModVision != 0 {
		i = encodeVarintTsopb(dAtA, i, uint64(m.ModVision))
		i--
		dAtA[i] = 0x18
	}
	if m.KeyspaceId != 0 {
...
func (m *FindGroupByKeyspaceIDRequest) Size() (n int) {
	...
	if m.ModVision != 0 {
		n += 1 + sovTsopb(uint64(m.ModVision))
	}
	return n
}
...
func (m *FindGroupByKeyspaceIDRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ModVision", wireType)
			}
			m.ModVision = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ModVision |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
