...
type FindGroupByKeyspaceIDRequest struct {
	...
	ModVersion uint64         `protobuf:"varint,3,opt,name=mod_version,json=modVersion,proto3" json:"mod_version,omitempty"`
}
...
func (m *FindGroupByKeyspaceIDRequest) GetModVersion() uint64 {
	if m != nil {
		return m.ModVersion
	}
	return 0
...
func (m *FindGroupByKeyspaceIDResponse) GetModVersion() uint64 {
	if m != nil {
		return m.ModVersion
	}
	return 0
...
var fileDescriptor_ad96434e4f0d3c2b = []byte{
	...
	,
}
...
func (m *FindGroupByKeyspaceIDRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ModVersion != 0 {
		i = encodeVarintTsopb(dAtA, i, uint64(m.ModVersion))
		i--
		dAtA[i] = 0x18
	}
	if m.KeyspaceId != 0 {
...
func (m *FindGroupByKeyspaceIDRequest) Size() (n int) {
	...
	if m.ModVersion != 0 {
		n += 1 + sovTsopb(uint64(m.ModVersion))
	}
	return n
}
...
func (m *FindGroupByKeyspaceIDRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ModVersion", wireType)
			}
			m.ModVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ModVersion |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
