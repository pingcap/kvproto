...
type MergeState struct {
	...
	ConfVersion uint64                `protobuf:"varint,4,opt,name=conf_version,json=confVersion,proto3" json:"conf_version,omitempty"`
}
...
func (m *MergeState) GetDirection() metapb.MergeDirection {
	if m != nil {
		return m.Direction
	}
...
func (m *MergeState) GetConfVersion() uint64 {
	if m != nil {
...
func (m *MergeState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Direction != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.Direction))
	}
	if m.Commit != 0 {
		dAtA[i] = 0x18
		i++
	...
	if m.ConfVersion != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.ConfVersion))
	}
	return i, nil
}
...
func (m *RegionLocalState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MergeState != nil {
		...
		n11, err := m.MergeState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *MergeState) Size() (n int) {
	...
	if m.Direction != 0 {
		n += 1 + sovRaftServerpb(uint64(m.Direction))
	}
	if m.Commit != 0 {
		n += 1 + sovRaftServerpb(uint64(m.Commit))
	}
	if m.ConfVersion != 0 {
		n += 1 + sovRaftServerpb(uint64(m.ConfVersion))
	}
	return n
}
...
var fileDescriptorRaftServerpb = []byte{
	...
	,
}
