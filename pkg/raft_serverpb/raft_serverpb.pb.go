...
func (PeerState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{0}
}
...
func (*RaftTruncatedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{1}
}
...
func (*SnapshotCFFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{2}
}
...
func (*SnapshotMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{3}
}
...
func (*SnapshotChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{4}
}
...
func (*Done) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{5}
}
...
func (*KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{6}
}
...
func (*RaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{7}
}
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{8}
}
...
type RaftLocalState struct {
	...
	ConfStates           []*RaftLocalState_ConfState `protobuf:"bytes,3,rep,name=conf_states,json=confStates" json:"conf_states,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (*RaftLocalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{9}
}
...
func (m *RaftLocalState) GetConfStates() []*RaftLocalState_ConfState {
	if m != nil {
		return m.ConfStates
	}
	return nil
...
type RaftLocalState_ConfState struct {
	ConfState            *eraftpb.ConfState `protobuf:"bytes,1,opt,name=conf_state,json=confState" json:"conf_state,omitempty"`
	Index                uint64             `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty"`
	InMembershipChange   bool               `protobuf:"varint,3,opt,name=in_membership_change,json=inMembershipChange,proto3" json:"in_membership_change,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *RaftLocalState_ConfState) Reset()         { *m = RaftLocalState_ConfState{} }
func (m *RaftLocalState_ConfState) String() string { return proto.CompactTextString(m) }
func (*RaftLocalState_ConfState) ProtoMessage()    {}
func (*RaftLocalState_ConfState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{9, 0}
}
func (m *RaftLocalState_ConfState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RaftLocalState_ConfState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RaftLocalState_ConfState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *RaftLocalState_ConfState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RaftLocalState_ConfState.Merge(dst, src)
}
func (m *RaftLocalState_ConfState) XXX_Size() int {
	return m.Size()
}
func (m *RaftLocalState_ConfState) XXX_DiscardUnknown() {
	xxx_messageInfo_RaftLocalState_ConfState.DiscardUnknown(m)
}

var xxx_messageInfo_RaftLocalState_ConfState proto.InternalMessageInfo

func (m *RaftLocalState_ConfState) GetConfState() *eraftpb.ConfState {
	if m != nil {
		return m.ConfState
	}
	return nil
...
func (m *RaftLocalState_ConfState) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (m *RaftLocalState_ConfState) GetInMembershipChange() bool {
	if m != nil {
		return m.InMembershipChange
	}
	return false
}
...
func (*RaftApplyState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{10}
}
...
func (*MergeState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{11}
}
...
func (*RegionLocalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_a2fe26671c2d1fe3, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*RaftLocalState_ConfState)(nil), "raft_serverpb.RaftLocalState.ConfState")
...
func (m *RaftLocalState) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ConfStates) > 0 {
		for _, msg := range m.ConfStates {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintRaftServerpb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *RaftLocalState_ConfState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RaftLocalState_ConfState) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.ConfState != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.ConfState.Size()))
		n10, err := m.ConfState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *RaftLocalState_ConfState) Size() (n int) {
	var l int
	_ = l
	if m.ConfState != nil {
		l = m.ConfState.Size()
...
func (m *RaftLocalState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConfStates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConfStates = append(m.ConfStates, &RaftLocalState_ConfState{})
			if err := m.ConfStates[len(m.ConfStates)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RaftLocalState_ConfState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InMembershipChange", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() { proto.RegisterFile("raft_serverpb.proto", fileDescriptor_raft_serverpb_a2fe26671c2d1fe3) }

var fileDescriptor_raft_serverpb_a2fe26671c2d1fe3 = []byte{
	...
	,
}
