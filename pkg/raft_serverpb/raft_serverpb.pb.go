...
type RaftSnapshotData struct {
	...
	GcPeers              []*metapb.Peer `protobuf:"bytes,6,rep,name=gc_peers,json=gcPeers,proto3" json:"gc_peers,omitempty"`
	MergedPeers          []*MergedPeer  `protobuf:"bytes,7,rep,name=merged_peers,json=mergedPeers,proto3" json:"merged_peers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *RaftSnapshotData) GetGcPeers() []*metapb.Peer {
	if m != nil {
		return m.GcPeers
	}
	return nil
...
func (m *RaftSnapshotData) GetMergedPeers() []*MergedPeer {
	if m != nil {
		return m.MergedPeers
	}
	return nil
}
...
type MergedPeer struct {
	...
	SourcePeers    []*metapb.Peer      `protobuf:"bytes,2,rep,name=source_peers,json=sourcePeers,proto3" json:"source_peers,omitempty"`
	SourceEpoch    *metapb.RegionEpoch `protobuf:"bytes,3,opt,name=source_epoch,json=sourceEpoch,proto3" json:"source_epoch,omitempty"`
	...
	TargetPeers    []*metapb.Peer      `protobuf:"bytes,5,rep,name=target_peers,json=targetPeers,proto3" json:"target_peers,omitempty"`
	TargetEpoch    *metapb.RegionEpoch `protobuf:"bytes,6,opt,name=target_epoch,json=targetEpoch,proto3" json:"target_epoch,omitempty"`
	// Commit merge index.
...
func (m *MergedPeer) Reset()         { *m = MergedPeer{} }
func (m *MergedPeer) String() string { return proto.CompactTextString(m) }
func (*MergedPeer) ProtoMessage()    {}
func (*MergedPeer) Descriptor() ([]byte, []int) {
	return fileDescriptor_130ebc2f2c37a342, []int{13}
}
func (m *MergedPeer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergedPeer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MergedPeer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MergedPeer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergedPeer.Merge(m, src)
}
func (m *MergedPeer) XXX_Size() int {
	return m.Size()
}
func (m *MergedPeer) XXX_DiscardUnknown() {
	xxx_messageInfo_MergedPeer.DiscardUnknown(m)
}

var xxx_messageInfo_MergedPeer proto.InternalMessageInfo

func (m *MergedPeer) GetSourceRegionId() uint64 {
	if m != nil {
...
func (m *MergedPeer) GetSourcePeers() []*metapb.Peer {
	if m != nil {
...
func (m *MergedPeer) GetSourceEpoch() *metapb.RegionEpoch {
	if m != nil {
...
func (m *MergedPeer) GetTargetRegionId() uint64 {
	if m != nil {
...
func (m *MergedPeer) GetTargetPeers() []*metapb.Peer {
	if m != nil {
...
func (m *MergedPeer) GetTargetEpoch() *metapb.RegionEpoch {
	if m != nil {
...
func (m *MergedPeer) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
type RegionLocalState struct {
	...
	GcPeers []*metapb.Peer `protobuf:"bytes,5,rep,name=gc_peers,json=gcPeers,proto3" json:"gc_peers,omitempty"`
	...
	MergedPeers          []*MergedPeer `protobuf:"bytes,6,rep,name=merged_peers,json=mergedPeers,proto3" json:"merged_peers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *RegionLocalState) GetGcPeers() []*metapb.Peer {
	if m != nil {
		return m.GcPeers
	}
	return nil
...
func (m *RegionLocalState) GetMergedPeers() []*MergedPeer {
	if m != nil {
		return m.MergedPeers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MergedPeer)(nil), "raft_serverpb.MergedPeer")
...
var fileDescriptor_130ebc2f2c37a342 = []byte{
	...
	,
}
...
func (m *RaftSnapshotData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MergedPeers) > 0 {
		for iNdEx := len(m.MergedPeers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.MergedPeers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.GcPeers) > 0 {
		for iNdEx := len(m.GcPeers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.GcPeers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MergedPeer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MergedPeer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MergedPeer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RaftSnapshotData) Size() (n int) {
	...
	if len(m.GcPeers) > 0 {
		for _, e := range m.GcPeers {
			l = e.Size()
			n += 1 + l + sovRaftServerpb(uint64(l))
		}
	}
	if len(m.MergedPeers) > 0 {
		for _, e := range m.MergedPeers {
			l = e.Size()
			n += 1 + l + sovRaftServerpb(uint64(l))
		}
	}
...
func (m *RaftSnapshotData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GcPeers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.GcPeers = append(m.GcPeers, &metapb.Peer{})
			if err := m.GcPeers[len(m.GcPeers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MergedPeers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MergedPeers = append(m.MergedPeers, &MergedPeer{})
			if err := m.MergedPeers[len(m.MergedPeers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MergedPeer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergedPeer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergedPeer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
