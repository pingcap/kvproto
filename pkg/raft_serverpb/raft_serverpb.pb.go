...
type TabletSnapshotRequest_Done struct {
	Done *Done `protobuf:"bytes,4,opt,name=done,proto3,oneof" json:"done,omitempty"`
}
...
func (*TabletSnapshotRequest_Done) isTabletSnapshotRequest_Payload()    {}
...
func (m *TabletSnapshotRequest) GetDone() *Done {
	if x, ok := m.GetPayload().(*TabletSnapshotRequest_Done); ok {
		return x.Done
	}
	return nil
}
...
func (*TabletSnapshotRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*TabletSnapshotRequest_Done)(nil),
	}
}
...
var fileDescriptor_130ebc2f2c37a342 = []byte{
	...
	,
}
...
func (m *TabletSnapshotRequest_Done) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TabletSnapshotRequest_Done) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Done != nil {
		{
...
func (m *TabletSnapshotRequest_Done) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TabletSnapshotRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Payload = &TabletSnapshotRequest_Done{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaftServerpb(dAtA[iNdEx:])
