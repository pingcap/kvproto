...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_130ebc2f2c37a342, []int{29}
}
...
func init() {
	...
	proto.RegisterType((*BatchRaftMessage)(nil), "raft_serverpb.BatchRaftMessage")
}
...
var fileDescriptor_130ebc2f2c37a342 = []byte{
	...
	,
}
...
type RaftServerClient interface {
	// Handle raft messages between TiKV nodes
	Raft(ctx context.Context, opts ...grpc.CallOption) (RaftServer_RaftClient, error)
	// Handle batch raft messages for efficiency
	BatchRaft(ctx context.Context, opts ...grpc.CallOption) (RaftServer_BatchRaftClient, error)
	// Handle snapshot data transfer
	Snapshot(ctx context.Context, opts ...grpc.CallOption) (RaftServer_SnapshotClient, error)
	// Handle tablet snapshot data transfer
	TabletSnapshot(ctx context.Context, opts ...grpc.CallOption) (RaftServer_TabletSnapshotClient, error)
}
...
func (c *raftServerClient) Raft(ctx context.Context, opts ...grpc.CallOption) (RaftServer_RaftClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RaftServer_serviceDesc.Streams[0], "/raft_serverpb.RaftServer/Raft", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftServerRaftClient{stream}
	return x, nil
}

type RaftServer_RaftClient interface {
	Send(*RaftMessage) error
	CloseAndRecv() (*Done, error)
	grpc.ClientStream
}

type raftServerRaftClient struct {
	grpc.ClientStream
}

func (x *raftServerRaftClient) Send(m *RaftMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftServerRaftClient) CloseAndRecv() (*Done, error) {
...
func (c *raftServerClient) BatchRaft(ctx context.Context, opts ...grpc.CallOption) (RaftServer_BatchRaftClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RaftServer_serviceDesc.Streams[1], "/raft_serverpb.RaftServer/BatchRaft", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftServerBatchRaftClient{stream}
	return x, nil
}

type RaftServer_BatchRaftClient interface {
	Send(*BatchRaftMessage) error
	CloseAndRecv() (*Done, error)
	grpc.ClientStream
}

type raftServerBatchRaftClient struct {
	grpc.ClientStream
}

func (x *raftServerBatchRaftClient) Send(m *BatchRaftMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftServerBatchRaftClient) CloseAndRecv() (*Done, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Done)
...
func (c *raftServerClient) Snapshot(ctx context.Context, opts ...grpc.CallOption) (RaftServer_SnapshotClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RaftServer_serviceDesc.Streams[2], "/raft_serverpb.RaftServer/Snapshot", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftServerSnapshotClient{stream}
	return x, nil
}

type RaftServer_SnapshotClient interface {
	Send(*SnapshotChunk) error
	CloseAndRecv() (*Done, error)
	grpc.ClientStream
}

type raftServerSnapshotClient struct {
	grpc.ClientStream
}

func (x *raftServerSnapshotClient) Send(m *SnapshotChunk) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftServerSnapshotClient) CloseAndRecv() (*Done, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Done)
...
func (c *raftServerClient) TabletSnapshot(ctx context.Context, opts ...grpc.CallOption) (RaftServer_TabletSnapshotClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RaftServer_serviceDesc.Streams[3], "/raft_serverpb.RaftServer/TabletSnapshot", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftServerTabletSnapshotClient{stream}
	return x, nil
}

type RaftServer_TabletSnapshotClient interface {
	Send(*TabletSnapshotRequest) error
	Recv() (*TabletSnapshotResponse, error)
	grpc.ClientStream
}

type raftServerTabletSnapshotClient struct {
	grpc.ClientStream
}

func (x *raftServerTabletSnapshotClient) Send(m *TabletSnapshotRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftServerTabletSnapshotClient) Recv() (*TabletSnapshotResponse, error) {
	m := new(TabletSnapshotResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type RaftServerServer interface {
	// Handle raft messages between TiKV nodes
	Raft(RaftServer_RaftServer) error
	// Handle batch raft messages for efficiency
	BatchRaft(RaftServer_BatchRaftServer) error
	// Handle snapshot data transfer
	Snapshot(RaftServer_SnapshotServer) error
	// Handle tablet snapshot data transfer
	TabletSnapshot(RaftServer_TabletSnapshotServer) error
}
...
func (*UnimplementedRaftServerServer) Raft(srv RaftServer_RaftServer) error {
	return status.Errorf(codes.Unimplemented, "method Raft not implemented")
}
func (*UnimplementedRaftServerServer) BatchRaft(srv RaftServer_BatchRaftServer) error {
	return status.Errorf(codes.Unimplemented, "method BatchRaft not implemented")
}
func (*UnimplementedRaftServerServer) Snapshot(srv RaftServer_SnapshotServer) error {
	return status.Errorf(codes.Unimplemented, "method Snapshot not implemented")
}
func (*UnimplementedRaftServerServer) TabletSnapshot(srv RaftServer_TabletSnapshotServer) error {
...
func _RaftServer_Raft_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServerServer).Raft(&raftServerRaftServer{stream})
}

type RaftServer_RaftServer interface {
	SendAndClose(*Done) error
	Recv() (*RaftMessage, error)
	grpc.ServerStream
}

type raftServerRaftServer struct {
	grpc.ServerStream
}

func (x *raftServerRaftServer) SendAndClose(m *Done) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftServerRaftServer) Recv() (*RaftMessage, error) {
	m := new(RaftMessage)
...
func _RaftServer_BatchRaft_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServerServer).BatchRaft(&raftServerBatchRaftServer{stream})
}

type RaftServer_BatchRaftServer interface {
	SendAndClose(*Done) error
	Recv() (*BatchRaftMessage, error)
	grpc.ServerStream
}

type raftServerBatchRaftServer struct {
	grpc.ServerStream
}

func (x *raftServerBatchRaftServer) SendAndClose(m *Done) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftServerBatchRaftServer) Recv() (*BatchRaftMessage, error) {
...
func _RaftServer_Snapshot_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServerServer).Snapshot(&raftServerSnapshotServer{stream})
}

type RaftServer_SnapshotServer interface {
	SendAndClose(*Done) error
	Recv() (*SnapshotChunk, error)
	grpc.ServerStream
}

type raftServerSnapshotServer struct {
	grpc.ServerStream
}

func (x *raftServerSnapshotServer) SendAndClose(m *Done) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftServerSnapshotServer) Recv() (*SnapshotChunk, error) {
	m := new(SnapshotChunk)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _RaftServer_TabletSnapshot_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServerServer).TabletSnapshot(&raftServerTabletSnapshotServer{stream})
}

type RaftServer_TabletSnapshotServer interface {
	Send(*TabletSnapshotResponse) error
	Recv() (*TabletSnapshotRequest, error)
	grpc.ServerStream
}

type raftServerTabletSnapshotServer struct {
	grpc.ServerStream
}

func (x *raftServerTabletSnapshotServer) Send(m *TabletSnapshotResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftServerTabletSnapshotServer) Recv() (*TabletSnapshotRequest, error) {
	m := new(TabletSnapshotRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _RaftServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "raft_serverpb.RaftServer",
	HandlerType: (*RaftServerServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Raft",
			Handler:       _RaftServer_Raft_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "BatchRaft",
			Handler:       _RaftServer_BatchRaft_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "Snapshot",
			Handler:       _RaftServer_Snapshot_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "TabletSnapshot",
			Handler:       _RaftServer_TabletSnapshot_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
func (m *BatchRaftMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastObservedTime != 0 {
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.LastObservedTime))
		i--
		dAtA[i] = 0x68
	}
	if len(m.Msgs) > 0 {
...
func (m *BatchRaftMessage) Size() (n int) {
	...
	if m.LastObservedTime != 0 {
		n += 1 + sovRaftServerpb(uint64(m.LastObservedTime))
	}
	return n
}
