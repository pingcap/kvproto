...
type TaskMeta struct {
	...
	SqlDigest              string             `protobuf:"bytes,20,opt,name=sql_digest,json=sqlDigest,proto3" json:"sql_digest,omitempty"`
	PlanDigest             string             `protobuf:"bytes,21,opt,name=plan_digest,json=planDigest,proto3" json:"plan_digest,omitempty"`
...
func (m *TaskMeta) GetSqlDigest() string {
	if m != nil {
		return m.SqlDigest
	}
	return ""
...
func (m *TaskMeta) GetPlanDigest() string {
	if m != nil {
		return m.PlanDigest
	}
	return ""
...
type DispatchTaskRequest struct {
	...
	TableShardInfos []*coprocessor.TableShardInfos `protobuf:"bytes,7,rep,name=table_shard_infos,json=tableShardInfos,proto3" json:"table_shard_infos,omitempty"`
}
...
func (m *DispatchTaskRequest) GetTableShardInfos() []*coprocessor.TableShardInfos {
	if m != nil {
...
var fileDescriptor_819623c7fa76fc55 = []byte{
	...
	,
}
...
func (m *TaskMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PlanDigest) > 0 {
		...
		i = encodeVarintMpp(dAtA, i, uint64(len(m.PlanDigest)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
	...
	if len(m.SqlDigest) > 0 {
		...
		i = encodeVarintMpp(dAtA, i, uint64(len(m.SqlDigest)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
...
func (m *DispatchTaskRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.TableShardInfos = append(m.TableShardInfos, &coprocessor.TableShardInfos{})
