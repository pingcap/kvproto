...
type ExchangeSenderMeta struct {
	Compress             CompressionMode `protobuf:"varint,1,opt,name=compress,proto3,enum=mpp.CompressionMode" json:"compress,omitempty"`
...
func (m *ExchangeSenderMeta) GetCompress() CompressionMode {
	if m != nil {
		return m.Compress
	}
...
type MPPDataPacket struct {
	...
	Compress             *DataPacketCompressionMeta `protobuf:"bytes,6,opt,name=compress,proto3" json:"compress,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *MPPDataPacket) GetCompress() *DataPacketCompressionMeta {
	if m != nil {
		return m.Compress
	}
	return nil
...
var fileDescriptor_819623c7fa76fc55 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Compress |= CompressionMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MPPDataPacket) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.Compress == nil {
				m.Compress = &DataPacketCompressionMeta{}
			}
