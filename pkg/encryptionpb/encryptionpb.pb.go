...
func (EncryptionMethod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_413c20452e4a26ec, []int{0}
}
...
func (*FileDictionary) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_413c20452e4a26ec, []int{1}
}
...
func (*EncryptedContent) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_413c20452e4a26ec, []int{2}
}
...
func (*DataKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_413c20452e4a26ec, []int{3}
}
...
type KeyDictionary struct {
	...
	CurrentKeyId         uint64              `protobuf:"varint,3,opt,name=current_key_id,json=currentKeyId,proto3" json:"current_key_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*KeyDictionary) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryptionpb_413c20452e4a26ec, []int{4}
}
...
func init() { proto.RegisterFile("encryptionpb.proto", fileDescriptor_encryptionpb_413c20452e4a26ec) }

var fileDescriptor_encryptionpb_413c20452e4a26ec = []byte{
	...
	,
}
