...
/*
Package replication_modepb is a generated protocol buffer package.
...
func (ReplicationMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorReplicationModepb, []int{0}
}
...
func (DRAutoSyncState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorReplicationModepb, []int{1}
}
...
func (RegionReplicationState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorReplicationModepb, []int{2}
}
...
func (*DRAutoSync) Descriptor() ([]byte, []int) { return fileDescriptorReplicationModepb, []int{1} }
...
func (*StoreDRAutoSyncStatus) Descriptor() ([]byte, []int) {
	return fileDescriptorReplicationModepb, []int{3}
}
...
func init() { proto.RegisterFile("replication_modepb.proto", fileDescriptorReplicationModepb) }

var fileDescriptorReplicationModepb = []byte{
