...
func (*DeadlockRequest) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{3} }
...
func (*DeadlockResponse) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{4} }
