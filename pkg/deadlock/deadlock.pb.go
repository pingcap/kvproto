...
func (DeadlockRequestType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_85eba94e18b6a920, []int{0}
}
...
func (*WaitForEntriesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_85eba94e18b6a920, []int{1}
}
...
type WaitForEntry struct {
	...
	SqlDigest string `protobuf:"bytes,5,opt,name=sql_digest,json=sqlDigest,proto3" json:"sql_digest,omitempty"`
...
func (*WaitForEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_85eba94e18b6a920, []int{2}
}
...
func (*DeadlockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_85eba94e18b6a920, []int{3}
}
...
func (*DeadlockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_85eba94e18b6a920, []int{4}
}
...
func init() { proto.RegisterFile("deadlock.proto", fileDescriptor_deadlock_85eba94e18b6a920) }

var fileDescriptor_deadlock_85eba94e18b6a920 = []byte{
	// 458 bytes of a gzipped FileDescriptorProto
	,
}
