...
type StreamBackupTaskSecurityConfig struct {
	// Types that are valid to be assigned to DataEncryptionConfig:
	//	*StreamBackupTaskSecurityConfig_Plaintext
	//	*StreamBackupTaskSecurityConfig_DirectEncryption
	//	*StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption
	//	*StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption
	DataEncryptionConfig isStreamBackupTaskSecurityConfig_DataEncryptionConfig `protobuf_oneof:"dataEncryptionConfig"`
	XXX_NoUnkeyedLiteral struct{}                                              `json:"-"`
	XXX_unrecognized     []byte                                                `json:"-"`
	XXX_sizecache        int32                                                 `json:"-"`
}
...
type isStreamBackupTaskSecurityConfig_DataEncryptionConfig interface {
	isStreamBackupTaskSecurityConfig_DataEncryptionConfig()
	MarshalTo([]byte) (int, error)
	Size() int
}

type StreamBackupTaskSecurityConfig_Plaintext struct {
	Plaintext *Plaintext `protobuf:"bytes,1,opt,name=plaintext,proto3,oneof" json:"plaintext,omitempty"`
}
type StreamBackupTaskSecurityConfig_DirectEncryption struct {
	DirectEncryption *DirectEncryption `protobuf:"bytes,2,opt,name=direct_encryption,json=directEncryption,proto3,oneof" json:"direct_encryption,omitempty"`
}
type StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption struct {
	LocalMasterKeyEncryption *LocalMasterKeyEncryption `protobuf:"bytes,3,opt,name=local_master_key_encryption,json=localMasterKeyEncryption,proto3,oneof" json:"local_master_key_encryption,omitempty"`
}
type StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption struct {
	KmsMasterKeyEncryption *KMSMasterKeyEncryption `protobuf:"bytes,4,opt,name=kms_master_key_encryption,json=kmsMasterKeyEncryption,proto3,oneof" json:"kms_master_key_encryption,omitempty"`
}

func (*StreamBackupTaskSecurityConfig_Plaintext) isStreamBackupTaskSecurityConfig_DataEncryptionConfig() {
}
func (*StreamBackupTaskSecurityConfig_DirectEncryption) isStreamBackupTaskSecurityConfig_DataEncryptionConfig() {
}
func (*StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption) isStreamBackupTaskSecurityConfig_DataEncryptionConfig() {
}
func (*StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption) isStreamBackupTaskSecurityConfig_DataEncryptionConfig() {
}

func (m *StreamBackupTaskSecurityConfig) GetDataEncryptionConfig() isStreamBackupTaskSecurityConfig_DataEncryptionConfig {
	if m != nil {
		return m.DataEncryptionConfig
	}
	return nil
}

func (m *StreamBackupTaskSecurityConfig) GetPlaintext() *Plaintext {
	if x, ok := m.GetDataEncryptionConfig().(*StreamBackupTaskSecurityConfig_Plaintext); ok {
		return x.Plaintext
	}
	return nil
}

func (m *StreamBackupTaskSecurityConfig) GetDirectEncryption() *DirectEncryption {
	if x, ok := m.GetDataEncryptionConfig().(*StreamBackupTaskSecurityConfig_DirectEncryption); ok {
		return x.DirectEncryption
	}
	return nil
}

func (m *StreamBackupTaskSecurityConfig) GetLocalMasterKeyEncryption() *LocalMasterKeyEncryption {
	if x, ok := m.GetDataEncryptionConfig().(*StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption); ok {
		return x.LocalMasterKeyEncryption
	}
	return nil
}

func (m *StreamBackupTaskSecurityConfig) GetKmsMasterKeyEncryption() *KMSMasterKeyEncryption {
	if x, ok := m.GetDataEncryptionConfig().(*StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption); ok {
		return x.KmsMasterKeyEncryption
	}
	return nil
}
...
func (*StreamBackupTaskSecurityConfig) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*StreamBackupTaskSecurityConfig_Plaintext)(nil),
		(*StreamBackupTaskSecurityConfig_DirectEncryption)(nil),
		(*StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption)(nil),
		(*StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption)(nil),
	}
}

// Upload the stream backup files to external storage as plaintext (no encryption), not recommended in production.
...
// Data key directly provided by the user from the command line interface, not recommended in production.
type DirectEncryption struct {
	DataKey              *CipherInfo `protobuf:"bytes,1,opt,name=data_key,json=dataKey,proto3" json:"data_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}

func (m *DirectEncryption) Reset()         { *m = DirectEncryption{} }
func (m *DirectEncryption) String() string { return proto.CompactTextString(m) }
func (*DirectEncryption) ProtoMessage()    {}
func (*DirectEncryption) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{19}
}
func (m *DirectEncryption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DirectEncryption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DirectEncryption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DirectEncryption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DirectEncryption.Merge(m, src)
}
func (m *DirectEncryption) XXX_Size() int {
	return m.Size()
}
func (m *DirectEncryption) XXX_DiscardUnknown() {
	xxx_messageInfo_DirectEncryption.DiscardUnknown(m)
}

var xxx_messageInfo_DirectEncryption proto.InternalMessageInfo

func (m *DirectEncryption) GetDataKey() *CipherInfo {
	if m != nil {
		return m.DataKey
	}
	return nil
...
// Master key is read from local disk. Data keys are generated dynamically and encrypted using the loaded master key.
// It's much safer than PlainText and DirectEncryption since master key is never exposed and transported. Good for
// on premise environment where KMS is not available.
type LocalMasterKeyEncryption struct {
	MasterKeyFilePath    *encryptionpb.MasterKeyFile   `protobuf:"bytes,1,opt,name=master_key_file_path,json=masterKeyFilePath,proto3" json:"master_key_file_path,omitempty"`
	Method               encryptionpb.EncryptionMethod `protobuf:"varint,2,opt,name=method,proto3,enum=encryptionpb.EncryptionMethod" json:"method,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *LocalMasterKeyEncryption) Reset()         { *m = LocalMasterKeyEncryption{} }
func (m *LocalMasterKeyEncryption) String() string { return proto.CompactTextString(m) }
func (*LocalMasterKeyEncryption) ProtoMessage()    {}
func (*LocalMasterKeyEncryption) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{20}
}
func (m *LocalMasterKeyEncryption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LocalMasterKeyEncryption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LocalMasterKeyEncryption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LocalMasterKeyEncryption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocalMasterKeyEncryption.Merge(m, src)
}
func (m *LocalMasterKeyEncryption) XXX_Size() int {
	return m.Size()
}
func (m *LocalMasterKeyEncryption) XXX_DiscardUnknown() {
	xxx_messageInfo_LocalMasterKeyEncryption.DiscardUnknown(m)
}

var xxx_messageInfo_LocalMasterKeyEncryption proto.InternalMessageInfo

func (m *LocalMasterKeyEncryption) GetMasterKeyFilePath() *encryptionpb.MasterKeyFile {
	if m != nil {
		return m.MasterKeyFilePath
	}
	return nil
}

func (m *LocalMasterKeyEncryption) GetMethod() encryptionpb.EncryptionMethod {
	if m != nil {
		return m.Method
	}
...
// Master key is managed by the KMS. Data keys are generated dynamically and encrypted using the KMS master key.
// Recommended for cases when KMS is available.
type KMSMasterKeyEncryption struct {
	KmsMasterKeyConfig   *encryptionpb.MasterKeyKms    `protobuf:"bytes,1,opt,name=kms_master_key_config,json=kmsMasterKeyConfig,proto3" json:"kms_master_key_config,omitempty"`
	Method               encryptionpb.EncryptionMethod `protobuf:"varint,2,opt,name=method,proto3,enum=encryptionpb.EncryptionMethod" json:"method,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
...
func (m *KMSMasterKeyEncryption) Reset()         { *m = KMSMasterKeyEncryption{} }
func (m *KMSMasterKeyEncryption) String() string { return proto.CompactTextString(m) }
func (*KMSMasterKeyEncryption) ProtoMessage()    {}
func (*KMSMasterKeyEncryption) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{21}
}
func (m *KMSMasterKeyEncryption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KMSMasterKeyEncryption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KMSMasterKeyEncryption.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KMSMasterKeyEncryption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KMSMasterKeyEncryption.Merge(m, src)
}
func (m *KMSMasterKeyEncryption) XXX_Size() int {
	return m.Size()
}
func (m *KMSMasterKeyEncryption) XXX_DiscardUnknown() {
	xxx_messageInfo_KMSMasterKeyEncryption.DiscardUnknown(m)
}

var xxx_messageInfo_KMSMasterKeyEncryption proto.InternalMessageInfo

func (m *KMSMasterKeyEncryption) GetKmsMasterKeyConfig() *encryptionpb.MasterKeyKms {
	if m != nil {
		return m.KmsMasterKeyConfig
	}
	return nil
}

func (m *KMSMasterKeyEncryption) GetMethod() encryptionpb.EncryptionMethod {
	if m != nil {
		return m.Method
	}
	return encryptionpb.EncryptionMethod_UNKNOWN
...
func init() {
	...
	proto.RegisterType((*Plaintext)(nil), "backup.Plaintext")
	proto.RegisterType((*DirectEncryption)(nil), "backup.DirectEncryption")
	proto.RegisterType((*LocalMasterKeyEncryption)(nil), "backup.LocalMasterKeyEncryption")
	proto.RegisterType((*KMSMasterKeyEncryption)(nil), "backup.KMSMasterKeyEncryption")
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *StreamBackupTaskSecurityConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DataEncryptionConfig != nil {
		{
			size := m.DataEncryptionConfig.Size()
			i -= size
			if _, err := m.DataEncryptionConfig.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *StreamBackupTaskSecurityConfig_Plaintext) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamBackupTaskSecurityConfig_Plaintext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Plaintext != nil {
		{
...
func (m *StreamBackupTaskSecurityConfig_DirectEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamBackupTaskSecurityConfig_DirectEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DirectEncryption != nil {
		{
			size, err := m.DirectEncryption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.LocalMasterKeyEncryption != nil {
		{
			size, err := m.LocalMasterKeyEncryption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.KmsMasterKeyEncryption != nil {
		{
			size, err := m.KmsMasterKeyEncryption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Plaintext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DirectEncryption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DirectEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DirectEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.DataKey != nil {
		{
			size, err := m.DataKey.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *LocalMasterKeyEncryption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LocalMasterKeyEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalMasterKeyEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Method != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.Method))
		i--
		dAtA[i] = 0x10
	}
	if m.MasterKeyFilePath != nil {
		{
			size, err := m.MasterKeyFilePath.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *KMSMasterKeyEncryption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KMSMasterKeyEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KMSMasterKeyEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.KmsMasterKeyConfig != nil {
		{
			size, err := m.KmsMasterKeyConfig.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StreamBackupTaskSecurityConfig_Plaintext) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StreamBackupTaskSecurityConfig_DirectEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DirectEncryption != nil {
		l = m.DirectEncryption.Size()
		n += 1 + l + sovBrpb(uint64(l))
	}
	return n
}
func (m *StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.LocalMasterKeyEncryption != nil {
		l = m.LocalMasterKeyEncryption.Size()
		n += 1 + l + sovBrpb(uint64(l))
	}
	return n
}
func (m *StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.KmsMasterKeyEncryption != nil {
		l = m.KmsMasterKeyEncryption.Size()
		n += 1 + l + sovBrpb(uint64(l))
	}
	return n
}
...
func (m *DirectEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalMasterKeyEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MasterKeyFilePath != nil {
		l = m.MasterKeyFilePath.Size()
		n += 1 + l + sovBrpb(uint64(l))
	}
	if m.Method != 0 {
		n += 1 + sovBrpb(uint64(m.Method))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *KMSMasterKeyEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StreamBackupTaskSecurityConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DataEncryptionConfig = &StreamBackupTaskSecurityConfig_Plaintext{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DirectEncryption", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DataEncryptionConfig = &StreamBackupTaskSecurityConfig_DirectEncryption{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalMasterKeyEncryption", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &LocalMasterKeyEncryption{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.DataEncryptionConfig = &StreamBackupTaskSecurityConfig_LocalMasterKeyEncryption{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KmsMasterKeyEncryption", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &KMSMasterKeyEncryption{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.DataEncryptionConfig = &StreamBackupTaskSecurityConfig_KmsMasterKeyEncryption{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBrpb(dAtA[iNdEx:])
...
func (m *DirectEncryption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DirectEncryption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DirectEncryption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.DataKey == nil {
				m.DataKey = &CipherInfo{}
			}
			if err := m.DataKey.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LocalMasterKeyEncryption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LocalMasterKeyEncryption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LocalMasterKeyEncryption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MasterKeyFilePath", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MasterKeyFilePath == nil {
				m.MasterKeyFilePath = &encryptionpb.MasterKeyFile{}
			}
			if err := m.MasterKeyFilePath.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Method |= encryptionpb.EncryptionMethod(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *KMSMasterKeyEncryption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KMSMasterKeyEncryption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KMSMasterKeyEncryption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KmsMasterKeyConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.KmsMasterKeyConfig == nil {
				m.KmsMasterKeyConfig = &encryptionpb.MasterKeyKms{}
			}
			if err := m.KmsMasterKeyConfig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
