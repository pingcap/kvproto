...
type BackupMeta struct {
	...
	// Canonical restore rename-rule fingerprint associated with a persisted
	// PiTR ID map. Empty means the ID map was created without rename rules or by
	// a BR version that predates restore rename support.
	PitrIdMapRouteFingerprint string `protobuf:"bytes,27,opt,name=pitr_id_map_route_fingerprint,json=pitrIdMapRouteFingerprint,proto3" json:"pitr_id_map_route_fingerprint,omitempty"`
...
func (m *BackupMeta) GetPitrIdMapRouteFingerprint() string {
	if m != nil {
		return m.PitrIdMapRouteFingerprint
	}
	return ""
}
...
type PitrForeignKeyReference struct {
	Schema string `protobuf:"bytes,1,opt,name=schema,proto3" json:"schema,omitempty"`
	Table  string `protobuf:"bytes,2,opt,name=table,proto3" json:"table,omitempty"`
}

func (m *PitrForeignKeyReference) Reset()         { *m = PitrForeignKeyReference{} }
func (m *PitrForeignKeyReference) String() string { return proto.CompactTextString(m) }
func (*PitrForeignKeyReference) ProtoMessage()    {}
func (*PitrForeignKeyReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{13}
}
func (m *PitrForeignKeyReference) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PitrForeignKeyReference) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PitrForeignKeyReference.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PitrForeignKeyReference) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PitrForeignKeyReference.Merge(m, src)
}
func (m *PitrForeignKeyReference) XXX_Size() int {
	return m.Size()
}
func (m *PitrForeignKeyReference) XXX_DiscardUnknown() {
	xxx_messageInfo_PitrForeignKeyReference.DiscardUnknown(m)
}

var xxx_messageInfo_PitrForeignKeyReference proto.InternalMessageInfo

func (m *PitrForeignKeyReference) GetSchema() string {
	if m != nil {
		return m.Schema
	}
	return ""
...
func (m *PitrForeignKeyReference) GetTable() string {
	if m != nil {
		return m.Table
	}
	return ""
...
type PitrTableMap struct {
	...
	// The downstream database identity used when a table is restored to a
	// different database than its parent PitrDBMap. Zero/empty values inherit
	// the downstream database identity from the parent map.
	DownstreamDbId       int64                      `protobuf:"varint,5,opt,name=downstream_db_id,json=downstreamDbId,proto3" json:"downstream_db_id,omitempty"`
	DownstreamDbName     string                     `protobuf:"bytes,6,opt,name=downstream_db_name,json=downstreamDbName,proto3" json:"downstream_db_name,omitempty"`
	HasForeignKeys       bool                       `protobuf:"varint,7,opt,name=has_foreign_keys,json=hasForeignKeys,proto3" json:"has_foreign_keys,omitempty"`
	IsView               bool                       `protobuf:"varint,8,opt,name=is_view,json=isView,proto3" json:"is_view,omitempty"`
	ForeignKeyReferences []*PitrForeignKeyReference `protobuf:"bytes,9,rep,name=foreign_key_references,json=foreignKeyReferences,proto3" json:"foreign_key_references,omitempty"`
}
...
func (m *PitrTableMap) GetDownstreamDbId() int64 {
	if m != nil {
		return m.DownstreamDbId
	}
	return 0
}

func (m *PitrTableMap) GetDownstreamDbName() string {
	if m != nil {
		return m.DownstreamDbName
	}
	return ""
}

func (m *PitrTableMap) GetHasForeignKeys() bool {
	if m != nil {
		return m.HasForeignKeys
	}
	return false
}

func (m *PitrTableMap) GetIsView() bool {
	if m != nil {
		return m.IsView
	}
	return false
...
func (m *PitrTableMap) GetForeignKeyReferences() []*PitrForeignKeyReference {
	if m != nil {
		return m.ForeignKeyReferences
	}
	return nil
}
...
type LogFileCompaction struct {
	...
	GeneratedCmetaFilesTotalSize uint64 `protobuf:"varint,10,opt,name=generated_cmeta_files_total_size,json=generatedCmetaFilesTotalSize,proto3" json:"generated_cmeta_files_total_size,omitempty"`
	// Total size of generated compact-log-backup SST files.
	GeneratedSstFilesTotalSize uint64 `protobuf:"varint,11,opt,name=generated_sst_files_total_size,json=generatedSstFilesTotalSize,proto3" json:"generated_sst_files_total_size,omitempty"`
}
...
func (m *LogFileCompaction) GetGeneratedCmetaFilesTotalSize() uint64 {
	if m != nil {
		return m.GeneratedCmetaFilesTotalSize
	}
	return 0
}

func (m *LogFileCompaction) GetGeneratedSstFilesTotalSize() uint64 {
	if m != nil {
		return m.GeneratedSstFilesTotalSize
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*PitrForeignKeyReference)(nil), "backup.PitrForeignKeyReference")
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *BackupMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PitrIdMapRouteFingerprint) > 0 {
		i -= len(m.PitrIdMapRouteFingerprint)
		copy(dAtA[i:], m.PitrIdMapRouteFingerprint)
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.PitrIdMapRouteFingerprint)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xda
...
func (m *PitrForeignKeyReference) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PitrForeignKeyReference) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PitrForeignKeyReference) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Schema) > 0 {
		...
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.Schema)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PitrTableMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ForeignKeyReferences) > 0 {
		for iNdEx := len(m.ForeignKeyReferences) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ForeignKeyReferences[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.DownstreamDbName) > 0 {
		i -= len(m.DownstreamDbName)
		copy(dAtA[i:], m.DownstreamDbName)
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.DownstreamDbName)))
		i--
		dAtA[i] = 0x32
	}
	if m.DownstreamDbId != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.DownstreamDbId))
		i--
		dAtA[i] = 0x28
	}
	if m.FilteredOut {
...
func (m *LogFileCompaction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.GeneratedSstFilesTotalSize != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.GeneratedSstFilesTotalSize))
		i--
		dAtA[i] = 0x58
	}
	if m.GeneratedCmetaFilesTotalSize != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.GeneratedCmetaFilesTotalSize))
		i--
		dAtA[i] = 0x50
	}
	if m.InputMaxTs != 0 {
...
func (m *BackupMeta) Size() (n int) {
	...
	l = len(m.PitrIdMapRouteFingerprint)
	if l > 0 {
		n += 2 + l + sovBrpb(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *PitrForeignKeyReference) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PitrTableMap) Size() (n int) {
	...
	if m.DownstreamDbId != 0 {
		n += 1 + sovBrpb(uint64(m.DownstreamDbId))
	}
	l = len(m.DownstreamDbName)
	if l > 0 {
		n += 1 + l + sovBrpb(uint64(l))
	}
	if m.HasForeignKeys {
	...
	if len(m.ForeignKeyReferences) > 0 {
		for _, e := range m.ForeignKeyReferences {
			l = e.Size()
			n += 1 + l + sovBrpb(uint64(l))
		}
	}
...
func (m *LogFileCompaction) Size() (n int) {
	...
	if m.GeneratedCmetaFilesTotalSize != 0 {
		n += 1 + sovBrpb(uint64(m.GeneratedCmetaFilesTotalSize))
	}
	if m.GeneratedSstFilesTotalSize != 0 {
		n += 1 + sovBrpb(uint64(m.GeneratedSstFilesTotalSize))
	}
	return n
}
...
func (m *BackupMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PitrIdMapRouteFingerprint", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PitrIdMapRouteFingerprint = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBrpb(dAtA[iNdEx:])
...
func (m *PitrForeignKeyReference) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PitrForeignKeyReference: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PitrForeignKeyReference: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PitrTableMap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DownstreamDbId", wireType)
			}
			m.DownstreamDbId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DownstreamDbId |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DownstreamDbName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DownstreamDbName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasForeignKeys", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForeignKeyReferences", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ForeignKeyReferences = append(m.ForeignKeyReferences, &PitrForeignKeyReference{})
			if err := m.ForeignKeyReferences[len(m.ForeignKeyReferences)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LogFileCompaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GeneratedCmetaFilesTotalSize", wireType)
			}
			m.GeneratedCmetaFilesTotalSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBrpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GeneratedCmetaFilesTotalSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GeneratedSstFilesTotalSize", wireType)
			}
			m.GeneratedSstFilesTotalSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBrpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GeneratedSstFilesTotalSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
