...
type LogFileSubcompactions struct {
	Compactions          []*LogFileCompaction `protobuf:"bytes,1,rep,name=compactions,proto3" json:"compactions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *LogFileSubcompactions) GetCompactions() []*LogFileCompaction {
	if m != nil {
...
type LogFileCompaction struct {
	...
	// relative path to the subcompaction metas.
	...
	// relative path to the subcompaction generated files.
...
func (m *LogFileCompaction) GetArtifactes() string {
	if m != nil {
		return m.Artifactes
	}
	return ""
...
func (m *LogFileCompaction) GetArtifactesHash() uint64 {
	if m != nil {
...
type ModifyFile struct {
	...
	ReplaceContentWith   []byte   `protobuf:"bytes,2,opt,name=replace_content_with,json=replaceContentWith,proto3" json:"replace_content_with,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ModifyFile) Reset()         { *m = ModifyFile{} }
func (m *ModifyFile) String() string { return proto.CompactTextString(m) }
func (*ModifyFile) ProtoMessage()    {}
func (*ModifyFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{51}
}
func (m *ModifyFile) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ModifyFile) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ModifyFile.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ModifyFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModifyFile.Merge(m, src)
}
func (m *ModifyFile) XXX_Size() int {
	return m.Size()
}
func (m *ModifyFile) XXX_DiscardUnknown() {
	xxx_messageInfo_ModifyFile.DiscardUnknown(m)
}

var xxx_messageInfo_ModifyFile proto.InternalMessageInfo

func (m *ModifyFile) GetFile() string {
	if m != nil {
		return m.File
	}
	return ""
...
func (m *ModifyFile) GetReplaceContentWith() []byte {
	if m != nil {
		return m.ReplaceContentWith
	}
	return nil
}
...
type Migration struct {
	...
	DeleteLogicalFiles   []*DeleteSpansOfFile `protobuf:"bytes,2,rep,name=delete_logical_files,json=deleteLogicalFiles,proto3" json:"delete_logical_files,omitempty"`
	TruncatedTo          uint64               `protobuf:"varint,3,opt,name=truncated_to,json=truncatedTo,proto3" json:"truncated_to,omitempty"`
	Compactions          []*LogFileCompaction `protobuf:"bytes,4,rep,name=compactions,proto3" json:"compactions,omitempty"`
	Modifications        []*ModifyFile        `protobuf:"bytes,5,rep,name=modifications,proto3" json:"modifications,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *Migration) GetDeleteLogicalFiles() []*DeleteSpansOfFile {
	if m != nil {
...
func (m *Migration) GetModifications() []*ModifyFile {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ModifyFile)(nil), "backup.ModifyFile")
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *ModifyFile) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ModifyFile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ModifyFile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ReplaceContentWith) > 0 {
		i -= len(m.ReplaceContentWith)
		copy(dAtA[i:], m.ReplaceContentWith)
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.ReplaceContentWith)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.File) > 0 {
		i -= len(m.File)
		copy(dAtA[i:], m.File)
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.File)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ModifyFile) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ModifyFile: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ModifyFile: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplaceContentWith", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReplaceContentWith = append(m.ReplaceContentWith[:0], dAtA[iNdEx:postIndex]...)
			if m.ReplaceContentWith == nil {
				m.ReplaceContentWith = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Migration) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Modifications = append(m.Modifications, &ModifyFile{})
