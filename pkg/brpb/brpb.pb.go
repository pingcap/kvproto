...
type StatsFileIndex struct {
	...
	// The physical ids which the stats json data belong to.
	// TODO: we can further decompose statistical data into column dimensions.
	PhysicalIds          []int64  `protobuf:"varint,6,rep,packed,name=physical_ids,json=physicalIds,proto3" json:"physical_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *StatsFileIndex) GetPhysicalIds() []int64 {
	if m != nil {
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *StatsFileIndex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PhysicalIds) > 0 {
		dAtA6 := make([]byte, len(m.PhysicalIds)*10)
		var j5 int
		for _, num1 := range m.PhysicalIds {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintBrpb(dAtA, i, uint64(j5))
		i--
		dAtA[i] = 0x32
	}
	if len(m.CipherIv) > 0 {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType == 0 {
				...
				m.PhysicalIds = append(m.PhysicalIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.PhysicalIds) == 0 {
					m.PhysicalIds = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field PhysicalIds", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipBrpb(dAtA[iNdEx:])
