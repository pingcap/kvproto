...
type BackupReplicaRead int32

const (
	BackupReplicaRead_LEADER              BackupReplicaRead = 0
	BackupReplicaRead_FOLLOWER            BackupReplicaRead = 1
	BackupReplicaRead_LEADER_AND_FOLLOWER BackupReplicaRead = 2
	BackupReplicaRead_LEARNER             BackupReplicaRead = 3
)

var BackupReplicaRead_name = map[int32]string{
	0: "LEADER",
	1: "FOLLOWER",
	2: "LEADER_AND_FOLLOWER",
	3: "LEARNER",
}

var BackupReplicaRead_value = map[string]int32{
	"LEADER":              0,
	"FOLLOWER":            1,
	"LEADER_AND_FOLLOWER": 2,
	"LEARNER":             3,
}

func (x BackupReplicaRead) String() string {
	return proto.EnumName(BackupReplicaRead_name, int32(x))
}

func (BackupReplicaRead) EnumDescriptor() ([]byte, []int) {
...
type BackupRequest struct {
	...
	// replica_read indicates whether to use replica read and which type of replica is used for
	// backup. Unlike the replica reaad option in the normal read request context which is a
	// boolean, replica read option in the backup request context is an enum. This is because
	// the backup request may be a push down request, the server has to know what the client wants.
	ReplicaRead          BackupReplicaRead `protobuf:"varint,17,opt,name=replica_read,json=replicaRead,proto3,enum=backup.BackupReplicaRead" json:"replica_read,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *BackupRequest) GetReplicaRead() BackupReplicaRead {
	if m != nil {
		return m.ReplicaRead
	}
	return BackupReplicaRead_LEADER
}
...
func init() {
	...
	proto.RegisterEnum("backup.BackupReplicaRead", BackupReplicaRead_name, BackupReplicaRead_value)
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *BackupRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ReplicaRead != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.ReplicaRead))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
...
func (m *BackupRequest) Size() (n int) {
	...
	if m.ReplicaRead != 0 {
		n += 2 + sovBrpb(uint64(m.ReplicaRead))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 17:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplicaRead |= BackupReplicaRead(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
