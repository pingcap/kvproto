...
// SegmentedPiTRState is stored in mysql.tidb_pitr_id_map for segmented restore.
type SegmentedPiTRState struct {
	// maintain the id mapping from upstream cluster to downstream cluster.
	// the field number matches its position in `backupmeta`.
	DbMaps []*PitrDBMap `protobuf:"bytes,22,rep,name=db_maps,json=dbMaps,proto3" json:"db_maps,omitempty"`
	// pitr segmented restore state fields.
	SegmentedPitrStateVer uint64 `protobuf:"varint,1000,opt,name=segmented_pitr_state_ver,json=segmentedPitrStateVer,proto3" json:"segmented_pitr_state_ver,omitempty"`
	SegmentedPitrState    []byte `protobuf:"bytes,1001,opt,name=segmented_pitr_state,json=segmentedPitrState,proto3" json:"segmented_pitr_state,omitempty"`
}

func (m *SegmentedPiTRState) Reset()         { *m = SegmentedPiTRState{} }
func (m *SegmentedPiTRState) String() string { return proto.CompactTextString(m) }
func (*SegmentedPiTRState) ProtoMessage()    {}
func (*SegmentedPiTRState) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{15}
}
func (m *SegmentedPiTRState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SegmentedPiTRState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SegmentedPiTRState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SegmentedPiTRState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SegmentedPiTRState.Merge(m, src)
}
func (m *SegmentedPiTRState) XXX_Size() int {
	return m.Size()
}
func (m *SegmentedPiTRState) XXX_DiscardUnknown() {
	xxx_messageInfo_SegmentedPiTRState.DiscardUnknown(m)
}

var xxx_messageInfo_SegmentedPiTRState proto.InternalMessageInfo

func (m *SegmentedPiTRState) GetDbMaps() []*PitrDBMap {
	if m != nil {
		return m.DbMaps
	}
	return nil
...
func (m *SegmentedPiTRState) GetSegmentedPitrStateVer() uint64 {
	if m != nil {
		return m.SegmentedPitrStateVer
	}
	return 0
}

func (m *SegmentedPiTRState) GetSegmentedPitrState() []byte {
	if m != nil {
		return m.SegmentedPitrState
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*SegmentedPiTRState)(nil), "backup.SegmentedPiTRState")
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *SegmentedPiTRState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SegmentedPiTRState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SegmentedPiTRState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SegmentedPitrState) > 0 {
		i -= len(m.SegmentedPitrState)
		copy(dAtA[i:], m.SegmentedPitrState)
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.SegmentedPitrState)))
		i--
		dAtA[i] = 0x3e
		i--
		dAtA[i] = 0xca
	}
	if m.SegmentedPitrStateVer != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.SegmentedPitrStateVer))
		i--
		dAtA[i] = 0x3e
		i--
		dAtA[i] = 0xc0
...
func (m *SegmentedPiTRState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.SegmentedPitrStateVer != 0 {
		n += 2 + sovBrpb(uint64(m.SegmentedPitrStateVer))
	}
	l = len(m.SegmentedPitrState)
	if l > 0 {
		n += 2 + l + sovBrpb(uint64(l))
	}
	return n
...
func (m *SegmentedPiTRState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SegmentedPiTRState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SegmentedPiTRState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 22:
			if wireType != 2 {
		...
		case 1000:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SegmentedPitrStateVer", wireType)
			}
			m.SegmentedPitrStateVer = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBrpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SegmentedPitrStateVer |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 1001:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SegmentedPitrState", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SegmentedPitrState = append(m.SegmentedPitrState[:0], dAtA[iNdEx:postIndex]...)
			if m.SegmentedPitrState == nil {
				m.SegmentedPitrState = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
