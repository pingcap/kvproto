...
func (m *PitrIngestIndex) Reset()         { *m = PitrIngestIndex{} }
func (m *PitrIngestIndex) String() string { return proto.CompactTextString(m) }
func (*PitrIngestIndex) ProtoMessage()    {}
func (*PitrIngestIndex) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{15}
}
func (m *PitrIngestIndex) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PitrIngestIndex) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PitrIngestIndex.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PitrIngestIndex) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PitrIngestIndex.Merge(m, src)
}
func (m *PitrIngestIndex) XXX_Size() int {
	return m.Size()
}
func (m *PitrIngestIndex) XXX_DiscardUnknown() {
	xxx_messageInfo_PitrIngestIndex.DiscardUnknown(m)
}

var xxx_messageInfo_PitrIngestIndex proto.InternalMessageInfo

func (m *PitrIngestIndex) GetIndexId() int64 {
	if m != nil {
		return m.IndexId
	}
	return 0
...
func (m *PitrIngestIndex) GetIsPrimary() bool {
	if m != nil {
		return m.IsPrimary
	}
	return false
...
type PitrIngestItem struct {
	TableId int64              `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3" json:"table_id,omitempty"`
	Indexes []*PitrIngestIndex `protobuf:"bytes,2,rep,name=indexes,proto3" json:"indexes,omitempty"`
}

func (m *PitrIngestItem) Reset()         { *m = PitrIngestItem{} }
func (m *PitrIngestItem) String() string { return proto.CompactTextString(m) }
func (*PitrIngestItem) ProtoMessage()    {}
func (*PitrIngestItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{16}
}
func (m *PitrIngestItem) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PitrIngestItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PitrIngestItem.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PitrIngestItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PitrIngestItem.Merge(m, src)
}
func (m *PitrIngestItem) XXX_Size() int {
	return m.Size()
}
func (m *PitrIngestItem) XXX_DiscardUnknown() {
	xxx_messageInfo_PitrIngestItem.DiscardUnknown(m)
}

var xxx_messageInfo_PitrIngestItem proto.InternalMessageInfo

func (m *PitrIngestItem) GetTableId() int64 {
	if m != nil {
		return m.TableId
	}
	return 0
...
func (m *PitrIngestItem) GetIndexes() []*PitrIngestIndex {
	if m != nil {
		return m.Indexes
	}
	return nil
...
type PitrTiFlashReplicaInfo struct {
	...
	AvailablePartitionIds []int64  `protobuf:"varint,4,rep,packed,name=available_partition_ids,json=availablePartitionIds,proto3" json:"available_partition_ids,omitempty"`
}

func (m *PitrTiFlashReplicaInfo) Reset()         { *m = PitrTiFlashReplicaInfo{} }
func (m *PitrTiFlashReplicaInfo) String() string { return proto.CompactTextString(m) }
func (*PitrTiFlashReplicaInfo) ProtoMessage()    {}
func (*PitrTiFlashReplicaInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{17}
}
func (m *PitrTiFlashReplicaInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PitrTiFlashReplicaInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PitrTiFlashReplicaInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PitrTiFlashReplicaInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PitrTiFlashReplicaInfo.Merge(m, src)
}
func (m *PitrTiFlashReplicaInfo) XXX_Size() int {
	return m.Size()
}
func (m *PitrTiFlashReplicaInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_PitrTiFlashReplicaInfo.DiscardUnknown(m)
}

var xxx_messageInfo_PitrTiFlashReplicaInfo proto.InternalMessageInfo

func (m *PitrTiFlashReplicaInfo) GetCount() uint64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *PitrTiFlashReplicaInfo) GetLocationLabels() []string {
	if m != nil {
...
func (m *PitrTiFlashReplicaInfo) GetAvailable() bool {
	if m != nil {
		return m.Available
	}
	return false
...
func (m *PitrTiFlashReplicaInfo) GetAvailablePartitionIds() []int64 {
	if m != nil {
		return m.AvailablePartitionIds
	}
	return nil
}

type PitrTiFlashItem struct {
	TableId int64                   `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3" json:"table_id,omitempty"`
	Replica *PitrTiFlashReplicaInfo `protobuf:"bytes,2,opt,name=replica,proto3" json:"replica,omitempty"`
}

func (m *PitrTiFlashItem) Reset()         { *m = PitrTiFlashItem{} }
func (m *PitrTiFlashItem) String() string { return proto.CompactTextString(m) }
func (*PitrTiFlashItem) ProtoMessage()    {}
func (*PitrTiFlashItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{18}
}
func (m *PitrTiFlashItem) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PitrTiFlashItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PitrTiFlashItem.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PitrTiFlashItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PitrTiFlashItem.Merge(m, src)
}
func (m *PitrTiFlashItem) XXX_Size() int {
	return m.Size()
}
func (m *PitrTiFlashItem) XXX_DiscardUnknown() {
	xxx_messageInfo_PitrTiFlashItem.DiscardUnknown(m)
}

var xxx_messageInfo_PitrTiFlashItem proto.InternalMessageInfo

func (m *PitrTiFlashItem) GetTableId() int64 {
	if m != nil {
		return m.TableId
	}
	return 0
...
func (m *PitrTiFlashItem) GetReplica() *PitrTiFlashReplicaInfo {
	if m != nil {
		return m.Replica
	}
	return nil
...
// PitrIdMapPayload is stored in mysql.tidb_pitr_id_map for segmented restore.
type PitrIdMapPayload struct {
	// maintain the id mapping from upstream cluster to downstream cluster.
	// the field number matches its position in `backupmeta`.
	DbMaps []*PitrDBMap `protobuf:"bytes,22,rep,name=db_maps,json=dbMaps,proto3" json:"db_maps,omitempty"`
	// Increase field number to avoid conflicting with saved backup meta.
	// ingest recorder items for next segment.
	IngestItems []*PitrIngestItem `protobuf:"bytes,1001,rep,name=ingest_items,json=ingestItems,proto3" json:"ingest_items,omitempty"`
	// tiflash recorder items for next segment.
	TiflashItems []*PitrTiFlashItem `protobuf:"bytes,1002,rep,name=tiflash_items,json=tiflashItems,proto3" json:"tiflash_items,omitempty"`
}

func (m *PitrIdMapPayload) Reset()         { *m = PitrIdMapPayload{} }
func (m *PitrIdMapPayload) String() string { return proto.CompactTextString(m) }
func (*PitrIdMapPayload) ProtoMessage()    {}
func (*PitrIdMapPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{19}
}
func (m *PitrIdMapPayload) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PitrIdMapPayload) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PitrIdMapPayload.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PitrIdMapPayload) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PitrIdMapPayload.Merge(m, src)
}
func (m *PitrIdMapPayload) XXX_Size() int {
	return m.Size()
}
func (m *PitrIdMapPayload) XXX_DiscardUnknown() {
	xxx_messageInfo_PitrIdMapPayload.DiscardUnknown(m)
}

var xxx_messageInfo_PitrIdMapPayload proto.InternalMessageInfo

func (m *PitrIdMapPayload) GetDbMaps() []*PitrDBMap {
	if m != nil {
		return m.DbMaps
	}
	return nil
...
func (m *PitrIdMapPayload) GetIngestItems() []*PitrIngestItem {
	if m != nil {
		return m.IngestItems
	}
	return nil
}

func (m *PitrIdMapPayload) GetTiflashItems() []*PitrTiFlashItem {
	if m != nil {
		return m.TiflashItems
	}
	return nil
}
...
func (*IngestedSSTs) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{63}
}
...
func (*DeleteSpansOfFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{64}
}
...
func (*Migration) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{65}
}
...
func init() {
	...
	proto.RegisterType((*PitrIngestIndex)(nil), "backup.PitrIngestIndex")
	proto.RegisterType((*PitrIngestItem)(nil), "backup.PitrIngestItem")
	proto.RegisterType((*PitrTiFlashReplicaInfo)(nil), "backup.PitrTiFlashReplicaInfo")
	proto.RegisterType((*PitrTiFlashItem)(nil), "backup.PitrTiFlashItem")
	proto.RegisterType((*PitrIdMapPayload)(nil), "backup.PitrIdMapPayload")
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	// 5223 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *PitrIngestIndex) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PitrIngestIndex) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PitrIngestIndex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.IndexId != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.IndexId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PitrIngestItem) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PitrIngestItem) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PitrIngestItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PitrTiFlashReplicaInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PitrTiFlashReplicaInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PitrTiFlashReplicaInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.AvailablePartitionIds) > 0 {
		dAtA10 := make([]byte, len(m.AvailablePartitionIds)*10)
		var j9 int
		for _, num1 := range m.AvailablePartitionIds {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintBrpb(dAtA, i, uint64(j9))
		i--
		dAtA[i] = 0x22
	}
	if m.Available {
	...
	if len(m.LocationLabels) > 0 {
		for iNdEx := len(m.LocationLabels) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintBrpb(dAtA, i, uint64(len(m.LocationLabels[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if m.Count != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.Count))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PitrTiFlashItem) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PitrTiFlashItem) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PitrTiFlashItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PitrIdMapPayload) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PitrIdMapPayload) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PitrIdMapPayload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TiflashItems) > 0 {
		for iNdEx := len(m.TiflashItems) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TiflashItems[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.IngestItems) > 0 {
		for iNdEx := len(m.IngestItems) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.IngestItems[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *PitrIngestIndex) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PitrIngestItem) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PitrTiFlashReplicaInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.AvailablePartitionIds) > 0 {
		l = 0
		for _, e := range m.AvailablePartitionIds {
			l += sovBrpb(uint64(e))
		}
		n += 1 + sovBrpb(uint64(l)) + l
	}
	return n
}

func (m *PitrTiFlashItem) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PitrIdMapPayload) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.IngestItems) > 0 {
		for _, e := range m.IngestItems {
			l = e.Size()
			n += 2 + l + sovBrpb(uint64(l))
		}
	}
	if len(m.TiflashItems) > 0 {
		for _, e := range m.TiflashItems {
			l = e.Size()
			n += 2 + l + sovBrpb(uint64(l))
		}
	}
...
func (m *PitrIngestIndex) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PitrIngestIndex: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PitrIngestIndex: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PitrIngestItem) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PitrIngestItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PitrIngestItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			m.Indexes = append(m.Indexes, &PitrIngestIndex{})
...
func (m *PitrTiFlashReplicaInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PitrTiFlashReplicaInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PitrTiFlashReplicaInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType == 0 {
				...
				m.AvailablePartitionIds = append(m.AvailablePartitionIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.AvailablePartitionIds) == 0 {
					m.AvailablePartitionIds = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field AvailablePartitionIds", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipBrpb(dAtA[iNdEx:])
...
func (m *PitrTiFlashItem) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PitrTiFlashItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PitrTiFlashItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			if m.Replica == nil {
				m.Replica = &PitrTiFlashReplicaInfo{}
			}
...
func (m *PitrIdMapPayload) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PitrIdMapPayload: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PitrIdMapPayload: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 22:
			if wireType != 2 {
		...
		case 1001:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IngestItems", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IngestItems = append(m.IngestItems, &PitrIngestItem{})
			if err := m.IngestItems[len(m.IngestItems)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1002:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TiflashItems", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TiflashItems = append(m.TiflashItems, &PitrTiFlashItem{})
			if err := m.TiflashItems[len(m.TiflashItems)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
