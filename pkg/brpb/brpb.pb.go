...
const (
	PrepareSnapshotBackupRequestType_HeartBeat             PrepareSnapshotBackupRequestType = 0
	PrepareSnapshotBackupRequestType_PrepareForAllRegions  PrepareSnapshotBackupRequestType = 1
	PrepareSnapshotBackupRequestType_PrepareForSomeRegions PrepareSnapshotBackupRequestType = 2
	PrepareSnapshotBackupRequestType_ResetAllAndClose      PrepareSnapshotBackupRequestType = 3
)

var PrepareSnapshotBackupRequestType_name = map[int32]string{
	0: "HeartBeat",
	1: "PrepareForAllRegions",
	2: "PrepareForSomeRegions",
	3: "ResetAllAndClose",
}

var PrepareSnapshotBackupRequestType_value = map[string]int32{
	"HeartBeat":             0,
	"PrepareForAllRegions":  1,
	"PrepareForSomeRegions": 2,
	"ResetAllAndClose":      3,
}
...
const (
	PrepareSnapshotBackupEventType_RejectNewRequestDone PrepareSnapshotBackupEventType = 0
	PrepareSnapshotBackupEventType_WaitApplyDone        PrepareSnapshotBackupEventType = 1
	PrepareSnapshotBackupEventType_EncounteredError     PrepareSnapshotBackupEventType = 2
	PrepareSnapshotBackupEventType_FinalState           PrepareSnapshotBackupEventType = 3
)

var PrepareSnapshotBackupEventType_name = map[int32]string{
	0: "RejectNewRequestDone",
	1: "WaitApplyDone",
	2: "EncounteredError",
	3: "FinalState",
}
...
func (m *PrepareSnapshotBackupRequest) GetTy() PrepareSnapshotBackupRequestType {
	...
	return PrepareSnapshotBackupRequestType_HeartBeat
}
...
func (m *PrepareSnapshotBackupRequest) GetRequestId() uint64 {
	if m != nil {
		return m.RequestId
	}
	return 0
...
type PrepareSnapshotBackupResponse struct {
	...
	LastLeaseIsVaild     bool                           `protobuf:"varint,5,opt,name=last_lease_is_vaild,json=lastLeaseIsVaild,proto3" json:"last_lease_is_vaild,omitempty"`
...
func (m *PrepareSnapshotBackupResponse) GetTy() PrepareSnapshotBackupEventType {
	...
	return PrepareSnapshotBackupEventType_RejectNewRequestDone
}
...
func (m *PrepareSnapshotBackupResponse) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (m *PrepareSnapshotBackupResponse) GetLastLeaseIsVaild() bool {
	if m != nil {
		return m.LastLeaseIsVaild
	}
	return false
}

func (m *PrepareSnapshotBackupResponse) GetRequestId() uint64 {
	if m != nil {
		return m.RequestId
	}
	return 0
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *PrepareSnapshotBackupRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RequestId != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.RequestId))
		i--
		dAtA[i] = 0x20
	}
...
func (m *PrepareSnapshotBackupResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Index != 0 {
		i = encodeVarintBrpb(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x20
	}
	if m.Error != nil {
...
func (m *PrepareSnapshotBackupRequest) Size() (n int) {
	...
	if m.RequestId != 0 {
		n += 1 + sovBrpb(uint64(m.RequestId))
	}
	if m.XXX_unrecognized != nil {
...
func (m *PrepareSnapshotBackupResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastLeaseIsVaild", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
