...
/*
Package resource_usage_agent is a generated protocol buffer package.
...
func (*ResourceMeteringRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorResourceUsageAgent, []int{0}
}
...
func (*EmptyResponse) Descriptor() ([]byte, []int) { return fileDescriptorResourceUsageAgent, []int{1} }
...
func (*ResourceUsageRecord) Descriptor() ([]byte, []int) {
	return fileDescriptorResourceUsageAgent, []int{2}
}
...
func (*GroupTagRecord) Descriptor() ([]byte, []int) {
	return fileDescriptorResourceUsageAgent, []int{3}
}
...
func (*GroupTagRecordItem) Descriptor() ([]byte, []int) {
	return fileDescriptorResourceUsageAgent, []int{4}
}
...
func (c *resourceUsageAgentClient) Report(ctx context.Context, opts ...grpc.CallOption) (ResourceUsageAgent_ReportClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ResourceUsageAgent_serviceDesc.Streams[0], c.cc, "/resource_usage_agent.ResourceUsageAgent/Report", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *resourceMeteringPubSubClient) Subscribe(ctx context.Context, in *ResourceMeteringRequest, opts ...grpc.CallOption) (ResourceMeteringPubSub_SubscribeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ResourceMeteringPubSub_serviceDesc.Streams[0], c.cc, "/resource_usage_agent.ResourceMeteringPubSub/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("resource_usage_agent.proto", fileDescriptorResourceUsageAgent) }

var fileDescriptorResourceUsageAgent = []byte{
