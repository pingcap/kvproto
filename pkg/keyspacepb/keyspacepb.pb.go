...
type GetAllKeyspacesRequest struct {
	...
	Filter               *KeyspaceMetaFilter `protobuf:"bytes,4,opt,name=filter,proto3" json:"filter,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *GetAllKeyspacesRequest) GetFilter() *KeyspaceMetaFilter {
	if m != nil {
		return m.Filter
	}
	return nil
...
type KeyspaceMetaFilter struct {
	MinCreatedAt         int64             `protobuf:"varint,1,opt,name=min_created_at,json=minCreatedAt,proto3" json:"min_created_at,omitempty"`
	MaxCreatedAt         int64             `protobuf:"varint,2,opt,name=max_created_at,json=maxCreatedAt,proto3" json:"max_created_at,omitempty"`
	MinStateChangedAt    int64             `protobuf:"varint,3,opt,name=min_state_changed_at,json=minStateChangedAt,proto3" json:"min_state_changed_at,omitempty"`
	MaxStateChangedAt    int64             `protobuf:"varint,4,opt,name=max_state_changed_at,json=maxStateChangedAt,proto3" json:"max_state_changed_at,omitempty"`
	InState              []KeyspaceState   `protobuf:"varint,5,rep,packed,name=in_state,json=inState,proto3,enum=keyspacepb.KeyspaceState" json:"in_state,omitempty"`
	HasConfig            map[string]string `protobuf:"bytes,6,rep,name=has_config,json=hasConfig,proto3" json:"has_config,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *KeyspaceMetaFilter) Reset()         { *m = KeyspaceMetaFilter{} }
func (m *KeyspaceMetaFilter) String() string { return proto.CompactTextString(m) }
func (*KeyspaceMetaFilter) ProtoMessage()    {}
func (*KeyspaceMetaFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c5d91f3e5071166, []int{8}
}
func (m *KeyspaceMetaFilter) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KeyspaceMetaFilter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KeyspaceMetaFilter.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KeyspaceMetaFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KeyspaceMetaFilter.Merge(m, src)
}
func (m *KeyspaceMetaFilter) XXX_Size() int {
	return m.Size()
}
func (m *KeyspaceMetaFilter) XXX_DiscardUnknown() {
	xxx_messageInfo_KeyspaceMetaFilter.DiscardUnknown(m)
}

var xxx_messageInfo_KeyspaceMetaFilter proto.InternalMessageInfo

func (m *KeyspaceMetaFilter) GetMinCreatedAt() int64 {
	if m != nil {
...
func (m *KeyspaceMetaFilter) GetMaxCreatedAt() int64 {
	if m != nil {
...
func (m *KeyspaceMetaFilter) GetMinStateChangedAt() int64 {
	if m != nil {
		return m.MinStateChangedAt
	}
	return 0
}

func (m *KeyspaceMetaFilter) GetMaxStateChangedAt() int64 {
	if m != nil {
		return m.MaxStateChangedAt
	}
	return 0
}

func (m *KeyspaceMetaFilter) GetInState() []KeyspaceState {
	if m != nil {
		return m.InState
	}
	return nil
...
func (m *KeyspaceMetaFilter) GetHasConfig() map[string]string {
	if m != nil {
		return m.HasConfig
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*KeyspaceMetaFilter)(nil), "keyspacepb.KeyspaceMetaFilter")
	proto.RegisterMapType((map[string]string)(nil), "keyspacepb.KeyspaceMetaFilter.HasConfigEntry")
...
var fileDescriptor_5c5d91f3e5071166 = []byte{
	...
	,
}
...
func (m *KeyspaceMetaFilter) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KeyspaceMetaFilter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KeyspaceMetaFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.HasConfig) > 0 {
		for k := range m.HasConfig {
			v := m.HasConfig[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
	...
	if len(m.InState) > 0 {
		dAtA12 := make([]byte, len(m.InState)*10)
		var j11 int
		for _, num := range m.InState {
			for num >= 1<<7 {
		...
		i = encodeVarintKeyspacepb(dAtA, i, uint64(j11))
		i--
		dAtA[i] = 0x2a
	}
	if m.MaxStateChangedAt != 0 {
		i = encodeVarintKeyspacepb(dAtA, i, uint64(m.MaxStateChangedAt))
		i--
		dAtA[i] = 0x20
	}
	if m.MinStateChangedAt != 0 {
		i = encodeVarintKeyspacepb(dAtA, i, uint64(m.MinStateChangedAt))
		i--
		dAtA[i] = 0x18
	}
	if m.MaxCreatedAt != 0 {
		i = encodeVarintKeyspacepb(dAtA, i, uint64(m.MaxCreatedAt))
		i--
		dAtA[i] = 0x10
	}
	if m.MinCreatedAt != 0 {
		i = encodeVarintKeyspacepb(dAtA, i, uint64(m.MinCreatedAt))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *KeyspaceMetaFilter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MinCreatedAt != 0 {
		n += 1 + sovKeyspacepb(uint64(m.MinCreatedAt))
	}
	if m.MaxCreatedAt != 0 {
		n += 1 + sovKeyspacepb(uint64(m.MaxCreatedAt))
	}
	if m.MinStateChangedAt != 0 {
		n += 1 + sovKeyspacepb(uint64(m.MinStateChangedAt))
	}
	if m.MaxStateChangedAt != 0 {
		n += 1 + sovKeyspacepb(uint64(m.MaxStateChangedAt))
	}
	if len(m.InState) > 0 {
		l = 0
		for _, e := range m.InState {
			l += sovKeyspacepb(uint64(e))
		}
		n += 1 + sovKeyspacepb(uint64(l)) + l
	}
	if len(m.HasConfig) > 0 {
		for k, v := range m.HasConfig {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovKeyspacepb(uint64(len(k))) + 1 + len(v) + sovKeyspacepb(uint64(len(v)))
			n += mapEntrySize + 1 + sovKeyspacepb(uint64(mapEntrySize))
...
func (m *KeyspaceMetaFilter) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyspaceMetaFilter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyspaceMetaFilter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinCreatedAt |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxCreatedAt |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinStateChangedAt", wireType)
			}
			m.MinStateChangedAt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowKeyspacepb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinStateChangedAt |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxStateChangedAt", wireType)
			}
			m.MaxStateChangedAt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowKeyspacepb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxStateChangedAt |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= KeyspaceState(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.InState = append(m.InState, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.InState) == 0 {
					m.InState = make([]KeyspaceState, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v KeyspaceState
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field InState", wireType)
			}
		case 6:
			if wireType != 2 {
			...
			if m.HasConfig == nil {
				m.HasConfig = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
