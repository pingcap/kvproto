...
type KeyspaceMetaFilter struct {
	...
	States               []KeyspaceState   `protobuf:"varint,5,rep,packed,name=states,proto3,enum=keyspacepb.KeyspaceState" json:"states,omitempty"`
...
func (m *KeyspaceMetaFilter) GetStates() []KeyspaceState {
	if m != nil {
		return m.States
	}
	return nil
...
func (m *KeyspaceMetaFilter) GetConfig() map[string]string {
	if m != nil {
		return m.Config
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "keyspacepb.KeyspaceMetaFilter.ConfigEntry")
...
var fileDescriptor_5c5d91f3e5071166 = []byte{
	...
	,
}
...
func (m *KeyspaceMetaFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.States) > 0 {
		dAtA12 := make([]byte, len(m.States)*10)
		var j11 int
		...
		case 5:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.States) == 0 {
					m.States = make([]KeyspaceState, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v KeyspaceState
					for shift := uint(0); ; shift += 7 {
