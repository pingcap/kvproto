...
/*
Package keyspacepb is a generated protocol buffer package.
...
It has these top-level messages:
	...
	WatchKeyspacesRequest
	WatchKeyspacesResponse
	UpdateKeyspaceStateRequest
	UpdateKeyspaceStateResponse
	GetAllKeyspacesRequest
	GetAllKeyspacesResponse
*/
package keyspacepb
...
func (KeyspaceState) EnumDescriptor() ([]byte, []int) { return fileDescriptorKeyspacepb, []int{0} }
...
func (*KeyspaceMeta) Descriptor() ([]byte, []int) { return fileDescriptorKeyspacepb, []int{0} }
...
func (*LoadKeyspaceRequest) Descriptor() ([]byte, []int) { return fileDescriptorKeyspacepb, []int{1} }
...
func (*LoadKeyspaceResponse) Descriptor() ([]byte, []int) { return fileDescriptorKeyspacepb, []int{2} }
...
func (*WatchKeyspacesRequest) Descriptor() ([]byte, []int) { return fileDescriptorKeyspacepb, []int{3} }
...
func (*WatchKeyspacesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorKeyspacepb, []int{4}
}
...
func (*UpdateKeyspaceStateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorKeyspacepb, []int{5}
}
...
func (*UpdateKeyspaceStateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorKeyspacepb, []int{6}
}
...
func (*GetAllKeyspacesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorKeyspacepb, []int{7}
}
...
func (*GetAllKeyspacesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorKeyspacepb, []int{8}
}
...
func (c *keyspaceClient) LoadKeyspace(ctx context.Context, in *LoadKeyspaceRequest, opts ...grpc.CallOption) (*LoadKeyspaceResponse, error) {
	...
	err := grpc.Invoke(ctx, "/keyspacepb.Keyspace/LoadKeyspace", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keyspaceClient) WatchKeyspaces(ctx context.Context, in *WatchKeyspacesRequest, opts ...grpc.CallOption) (Keyspace_WatchKeyspacesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Keyspace_serviceDesc.Streams[0], c.cc, "/keyspacepb.Keyspace/WatchKeyspaces", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *keyspaceClient) UpdateKeyspaceState(ctx context.Context, in *UpdateKeyspaceStateRequest, opts ...grpc.CallOption) (*UpdateKeyspaceStateResponse, error) {
	...
	err := grpc.Invoke(ctx, "/keyspacepb.Keyspace/UpdateKeyspaceState", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keyspaceClient) GetAllKeyspaces(ctx context.Context, in *GetAllKeyspacesRequest, opts ...grpc.CallOption) (*GetAllKeyspacesResponse, error) {
	...
	err := grpc.Invoke(ctx, "/keyspacepb.Keyspace/GetAllKeyspaces", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("keyspacepb.proto", fileDescriptorKeyspacepb) }

var fileDescriptorKeyspacepb = []byte{
