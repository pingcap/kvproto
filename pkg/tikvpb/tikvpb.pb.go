...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{0}
}
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{0, 0}
}
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{1}
}
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{1, 0}
}
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{2}
}
...
func (*BatchCommandsEmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{3}
}
...
func (*BatchCommandsEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_1200572e56e2592d, []int{4}
}
...
type TikvClient interface {
	...
	// TiDB in secondary data centers can call this RPC to get a tso and regions' committed index.
	// Usage:
	// 1. When TiDB needs a timestamp, it calls the RPC, and get a request sender;
	// 2. When TiDB needs read index for all target regions, it sends one or more
	//    `TsoAndReadIndexRequest`s by the sender;
	// 3. Finally TiDB gets a tso and all regions' read index from `TsoAndReadIndexResponse`.
	TsoAndReadIndex(ctx context.Context, opts ...grpc.CallOption) (Tikv_TsoAndReadIndexClient, error)
}
...
func (c *tikvClient) TsoAndReadIndex(ctx context.Context, opts ...grpc.CallOption) (Tikv_TsoAndReadIndexClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Tikv_serviceDesc.Streams[6], "/tikvpb.Tikv/TsoAndReadIndex", opts...)
	if err != nil {
		return nil, err
	}
	x := &tikvTsoAndReadIndexClient{stream}
	return x, nil
}

type Tikv_TsoAndReadIndexClient interface {
	Send(*kvrpcpb.TsoAndReadIndexRequest) error
	CloseAndRecv() (*kvrpcpb.TsoAndReadIndexResponse, error)
	grpc.ClientStream
}

type tikvTsoAndReadIndexClient struct {
	grpc.ClientStream
}

func (x *tikvTsoAndReadIndexClient) Send(m *kvrpcpb.TsoAndReadIndexRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tikvTsoAndReadIndexClient) CloseAndRecv() (*kvrpcpb.TsoAndReadIndexResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(kvrpcpb.TsoAndReadIndexResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type TikvServer interface {
	...
	//    `TsoAndReadIndexRequest`s by the sender;
	// 3. Finally TiDB gets a tso and all regions' read index from `TsoAndReadIndexResponse`.
	TsoAndReadIndex(Tikv_TsoAndReadIndexServer) error
}
...
func _Tikv_TsoAndReadIndex_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TikvServer).TsoAndReadIndex(&tikvTsoAndReadIndexServer{stream})
}

type Tikv_TsoAndReadIndexServer interface {
	SendAndClose(*kvrpcpb.TsoAndReadIndexResponse) error
	Recv() (*kvrpcpb.TsoAndReadIndexRequest, error)
	grpc.ServerStream
}

type tikvTsoAndReadIndexServer struct {
	grpc.ServerStream
}

func (x *tikvTsoAndReadIndexServer) SendAndClose(m *kvrpcpb.TsoAndReadIndexResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tikvTsoAndReadIndexServer) Recv() (*kvrpcpb.TsoAndReadIndexRequest, error) {
	m := new(kvrpcpb.TsoAndReadIndexRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "TsoAndReadIndex",
			Handler:       _Tikv_TsoAndReadIndex_Handler,
			ClientStreams: true,
		},
	},
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_1200572e56e2592d) }

var fileDescriptor_tikvpb_1200572e56e2592d = []byte{
	// 1856 bytes of a gzipped FileDescriptorProto
	,
}
