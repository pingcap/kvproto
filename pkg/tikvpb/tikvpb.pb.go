...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{0}
}
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{0, 0}
}
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{1}
}
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{1, 0}
}
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{2}
}
...
func (*BatchCommandsEmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{3}
}
...
func (*BatchCommandsEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_8afaaa7b5f353e0d, []int{4}
}
...
// Client API for DCProxy service

type DCProxyClient interface {
	GetCommittedIndexAndTs(ctx context.Context, in *kvrpcpb.GetCommittedIndexAndTsRequest, opts ...grpc.CallOption) (*kvrpcpb.GetCommittedIndexAndTsResponse, error)
	TransactionWrite(ctx context.Context, in *kvrpcpb.TransactionWriteRequest, opts ...grpc.CallOption) (*kvrpcpb.TransactionWriteResponse, error)
}

type dCProxyClient struct {
	cc *grpc.ClientConn
}

func NewDCProxyClient(cc *grpc.ClientConn) DCProxyClient {
	return &dCProxyClient{cc}
}

func (c *dCProxyClient) GetCommittedIndexAndTs(ctx context.Context, in *kvrpcpb.GetCommittedIndexAndTsRequest, opts ...grpc.CallOption) (*kvrpcpb.GetCommittedIndexAndTsResponse, error) {
	out := new(kvrpcpb.GetCommittedIndexAndTsResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.DCProxy/GetCommittedIndexAndTs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dCProxyClient) TransactionWrite(ctx context.Context, in *kvrpcpb.TransactionWriteRequest, opts ...grpc.CallOption) (*kvrpcpb.TransactionWriteResponse, error) {
	out := new(kvrpcpb.TransactionWriteResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.DCProxy/TransactionWrite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for DCProxy service

type DCProxyServer interface {
	GetCommittedIndexAndTs(context.Context, *kvrpcpb.GetCommittedIndexAndTsRequest) (*kvrpcpb.GetCommittedIndexAndTsResponse, error)
	TransactionWrite(context.Context, *kvrpcpb.TransactionWriteRequest) (*kvrpcpb.TransactionWriteResponse, error)
}

func RegisterDCProxyServer(s *grpc.Server, srv DCProxyServer) {
	s.RegisterService(&_DCProxy_serviceDesc, srv)
}

func _DCProxy_GetCommittedIndexAndTs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.GetCommittedIndexAndTsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DCProxyServer).GetCommittedIndexAndTs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.DCProxy/GetCommittedIndexAndTs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DCProxyServer).GetCommittedIndexAndTs(ctx, req.(*kvrpcpb.GetCommittedIndexAndTsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DCProxy_TransactionWrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.TransactionWriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DCProxyServer).TransactionWrite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.DCProxy/TransactionWrite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DCProxyServer).TransactionWrite(ctx, req.(*kvrpcpb.TransactionWriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _DCProxy_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tikvpb.DCProxy",
	HandlerType: (*DCProxyServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetCommittedIndexAndTs",
			Handler:    _DCProxy_GetCommittedIndexAndTs_Handler,
		},
		{
			MethodName: "TransactionWrite",
			Handler:    _DCProxy_TransactionWrite_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "tikvpb.proto",
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_8afaaa7b5f353e0d) }

var fileDescriptor_tikvpb_8afaaa7b5f353e0d = []byte{
	// 1812 bytes of a gzipped FileDescriptorProto
	,
}
