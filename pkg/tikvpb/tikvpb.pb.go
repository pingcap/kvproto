...
type BatchCommandsRequest_Request_ScanTxnEntries struct {
	ScanTxnEntries *kvrpcpb.ScanTxnEntriesRequest `protobuf:"bytes,37,opt,name=ScanTxnEntries,proto3,oneof" json:"ScanTxnEntries,omitempty"`
}
...
type BatchCommandsResponse_Response_ScanTxnEntries struct {
	ScanTxnEntries *kvrpcpb.ScanTxnEntriesResponse `protobuf:"bytes,37,opt,name=ScanTxnEntries,proto3,oneof" json:"ScanTxnEntries,omitempty"`
}
...
func (c *tikvClient) KvScanTxnEntries(ctx context.Context, in *kvrpcpb.ScanTxnEntriesRequest, opts ...grpc.CallOption) (*kvrpcpb.ScanTxnEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/KvScanTxnEntries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedTikvServer) KvScanTxnEntries(ctx context.Context, req *kvrpcpb.ScanTxnEntriesRequest) (*kvrpcpb.ScanTxnEntriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method KvScanTxnEntries not implemented")
}
...
func (m *BatchCommandsRequest_Request_ScanTxnEntries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ScanTxnEntries != nil {
		{
			size, err := m.ScanTxnEntries.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BatchCommandsResponse_Response_ScanTxnEntries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ScanTxnEntries != nil {
		{
			size, err := m.ScanTxnEntries.MarshalToSizedBuffer(dAtA[:i])
