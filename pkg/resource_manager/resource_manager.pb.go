...
type TokenBucketsResponse struct {
	Error                *Error                `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	ResourceGroupTag     []byte                `protobuf:"bytes,2,opt,name=resource_group_tag,json=resourceGroupTag,proto3" json:"resource_group_tag,omitempty"`
	GrantedTokens        []*GrantedTokenBucket `protobuf:"bytes,3,rep,name=granted_tokens,json=grantedTokens,proto3" json:"granted_tokens,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *TokenBucketsResponse) GetResourceGroupTag() []byte {
	if m != nil {
		return m.ResourceGroupTag
	}
	return nil
...
var fileDescriptor_7048dd9233ee965d = []byte{
	...
	,
}
