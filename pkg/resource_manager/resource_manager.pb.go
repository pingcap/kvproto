...
// RunawayActionV2 is the new version of RunawayAction, which is designed to
// provide better extensibility with different types of actions.
type RunawayActionV2 struct {
	Type                 RunawayAction `protobuf:"varint,1,opt,name=type,proto3,enum=resource_manager.RunawayAction" json:"type,omitempty"`
	SwitchGroupName      string        `protobuf:"bytes,2,opt,name=switch_group_name,json=switchGroupName,proto3" json:"switch_group_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}

func (m *RunawayActionV2) Reset()         { *m = RunawayActionV2{} }
func (m *RunawayActionV2) String() string { return proto.CompactTextString(m) }
func (*RunawayActionV2) ProtoMessage()    {}
func (*RunawayActionV2) Descriptor() ([]byte, []int) {
	return fileDescriptor_7048dd9233ee965d, []int{24}
}
func (m *RunawayActionV2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RunawayActionV2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RunawayActionV2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RunawayActionV2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RunawayActionV2.Merge(m, src)
}
func (m *RunawayActionV2) XXX_Size() int {
	return m.Size()
}
func (m *RunawayActionV2) XXX_DiscardUnknown() {
	xxx_messageInfo_RunawayActionV2.DiscardUnknown(m)
}

var xxx_messageInfo_RunawayActionV2 proto.InternalMessageInfo

func (m *RunawayActionV2) GetType() RunawayAction {
	if m != nil {
		return m.Type
	}
...
func (m *RunawayActionV2) GetSwitchGroupName() string {
	if m != nil {
...
// DEPRECATED: please use `RunawayActionV2` instead to obtain better extensibility.
...
type RunawaySettings struct {
	...
	// DEPRECATED: please use `action_v2` instead to obtain better extensibility.
	...
	ActionV2             *RunawayActionV2 `protobuf:"bytes,4,opt,name=action_v2,json=actionV2,proto3" json:"action_v2,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *RunawaySettings) GetActionV2() *RunawayActionV2 {
	if m != nil {
		return m.ActionV2
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RunawayActionV2)(nil), "resource_manager.RunawayActionV2")
...
var fileDescriptor_7048dd9233ee965d = []byte{
	...
	,
}
...
func (m *RunawayActionV2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RunawayActionV2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RunawayActionV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RunawaySettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ActionV2 != nil {
		{
			size, err := m.ActionV2.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RunawayActionV2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RunawayActionV2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RunawayActionV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RunawayActionV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= RunawayAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RunawaySettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActionV2", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ActionV2 == nil {
				m.ActionV2 = &RunawayActionV2{}
			}
			if err := m.ActionV2.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
