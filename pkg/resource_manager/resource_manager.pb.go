...
type TokenBucketResponse struct {
	...
	// PU mode
	GrantedPUTokens      float64  `protobuf:"fixed64,4,opt,name=granted_p_u_tokens,json=grantedPUTokens,proto3" json:"granted_p_u_tokens,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TokenBucketResponse) GetGrantedPUTokens() float64 {
	if m != nil {
...
var fileDescriptor_7048dd9233ee965d = []byte{
	...
	,
}
...
func (m *TokenBucketResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GrantedPUTokens != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.GrantedPUTokens))))
		i--
		dAtA[i] = 0x21
	}
...
func (m *TokenBucketResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.GrantedPUTokens = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipResourceManager(dAtA[iNdEx:])
			if err != nil {
