...
type RegionHeartbeatRequest struct {
	...
	CpuUsage uint64 `protobuf:"varint,16,opt,name=cpu_usage,json=cpuUsage,proto3" json:"cpu_usage,omitempty"` // Deprecated: Do not use.
	// cpu_stats reports CPU usage breakdown for the leader region by kind
	// (e.g. unified read).
	CpuStats *pdpb.CPUStats `protobuf:"bytes,17,opt,name=cpu_stats,json=cpuStats,proto3" json:"cpu_stats,omitempty"`
}
...
func (m *RegionHeartbeatRequest) GetCpuStats() *pdpb.CPUStats {
	if m != nil {
		return m.CpuStats
	}
	return nil
...
type AskBatchSplitRequest struct {
	...
	Reason     pdpb.SplitReason `protobuf:"varint,4,opt,name=reason,proto3,enum=pdpb.SplitReason" json:"reason,omitempty"`
}
...
func (m *AskBatchSplitRequest) GetReason() pdpb.SplitReason {
	if m != nil {
		return m.Reason
	}
...
var fileDescriptor_b4bfd49510230d67 = []byte{
	...
	,
}
...
func (m *ScatterRegionsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RegionsId) > 0 {
		dAtA23 := make([]byte, len(m.RegionsId)*10)
		var j22 int
		...
		i = encodeVarintSchedulingpb(dAtA, i, uint64(j22))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Group) > 0 {
...
func (m *ScatterRegionsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FailedRegionsId) > 0 {
		dAtA26 := make([]byte, len(m.FailedRegionsId)*10)
		var j25 int
...
func (m *SplitRegionsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.RegionsId) > 0 {
		dAtA30 := make([]byte, len(m.RegionsId)*10)
		var j29 int
		for _, num := range m.RegionsId {
			for num >= 1<<7 {
		...
		i = encodeVarintSchedulingpb(dAtA, i, uint64(j29))
		i--
		dAtA[i] = 0x1a
	}
	if m.FinishedPercentage != 0 {
...
func (m *AskBatchSplitRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Reason != 0 {
		i = encodeVarintSchedulingpb(dAtA, i, uint64(m.Reason))
		i--
		dAtA[i] = 0x20
	}
	if m.SplitCount != 0 {
...
func (m *RegionHeartbeatRequest) Size() (n int) {
	...
	if m.CpuStats != nil {
		l = m.CpuStats.Size()
		n += 2 + l + sovSchedulingpb(uint64(l))
	}
	return n
}
...
func (m *AskBatchSplitRequest) Size() (n int) {
	...
	if m.Reason != 0 {
		n += 1 + sovSchedulingpb(uint64(m.Reason))
	}
	return n
}
...
func (m *RegionHeartbeatRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			...
			if m.BucketMeta == nil {
				m.BucketMeta = &metapb.BucketMeta{}
			}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reason |= pdpb.SplitReason(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
