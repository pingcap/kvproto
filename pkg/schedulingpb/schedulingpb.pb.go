...
type RegionHeartbeatRequest struct {
	...
	BucketVersion uint64 `protobuf:"varint,15,opt,name=bucket_version,json=bucketVersion,proto3" json:"bucket_version,omitempty"`
	// keys of buckets, include start/end key of region
	BucketKeys [][]byte `protobuf:"bytes,16,rep,name=bucket_keys,json=bucketKeys,proto3" json:"bucket_keys,omitempty"`
}
...
func (m *RegionHeartbeatRequest) GetBucketVersion() uint64 {
	if m != nil {
...
func (m *RegionHeartbeatRequest) GetBucketKeys() [][]byte {
	if m != nil {
		return m.BucketKeys
	}
	return nil
...
var fileDescriptor_b4bfd49510230d67 = []byte{
	...
	,
}
...
func (m *RegionHeartbeatRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BucketKeys) > 0 {
		for iNdEx := len(m.BucketKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.BucketKeys[iNdEx])
			copy(dAtA[i:], m.BucketKeys[iNdEx])
			i = encodeVarintSchedulingpb(dAtA, i, uint64(len(m.BucketKeys[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
	...
	if m.BucketVersion != 0 {
		i = encodeVarintSchedulingpb(dAtA, i, uint64(m.BucketVersion))
		i--
		dAtA[i] = 0x78
	}
	if m.Interval != nil {
...
func (m *RegionHeartbeatRequest) Size() (n int) {
	...
	if m.BucketVersion != 0 {
		n += 1 + sovSchedulingpb(uint64(m.BucketVersion))
	}
	if len(m.BucketKeys) > 0 {
...
func (m *RegionHeartbeatRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BucketVersion", wireType)
			}
			m.BucketVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BucketVersion |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 16:
			...
			m.BucketKeys = append(m.BucketKeys, make([]byte, postIndex-iNdEx))
			copy(m.BucketKeys[len(m.BucketKeys)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSchedulingpb(dAtA[iNdEx:])
