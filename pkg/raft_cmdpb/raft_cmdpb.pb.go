...
type SplitRequest struct {
	...
	// If true, new region's size should be zero,
	// it should be true iff the region split by user key such as split table or create partion table etc.
	// Otherwise, new region's size will be half of the origin region,
	// it should be false iff the region's load reach the threshold such as size check、keys、load etc.
	// Will be ignored in batch split.
	SkipSizeCheck        bool     `protobuf:"varint,5,opt,name=skip_size_check,json=skipSizeCheck,proto3" json:"skip_size_check,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SplitRequest) GetSkipSizeCheck() bool {
	if m != nil {
		return m.SkipSizeCheck
	}
	return false
}
...
type BatchSplitRequest struct {
	...
	// Otherwise, new region's size will be half of the origin region,
	// it should be false iff the region's load reach the threshold such as size check、keys、load etc.
	SkipSizeCheck        bool     `protobuf:"varint,3,opt,name=skip_size_check,json=skipSizeCheck,proto3" json:"skip_size_check,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BatchSplitRequest) GetSkipSizeCheck() bool {
	if m != nil {
		return m.SkipSizeCheck
	}
	return false
...
var fileDescriptor_661741b5e7485333 = []byte{
	...
	,
}
...
func (m *SplitRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipSizeCheck", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
