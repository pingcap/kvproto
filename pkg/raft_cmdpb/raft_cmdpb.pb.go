...
const (
	...
	AdminCmdType_PreMerge         AdminCmdType = 7
	AdminCmdType_Merge            AdminCmdType = 8
	AdminCmdType_RollbackPreMerge AdminCmdType = 9
)
...
type PreMergeRequest struct {
	MinIndex    uint64                `protobuf:"varint,1,opt,name=min_index,json=minIndex,proto3" json:"min_index,omitempty"`
	Direction   metapb.MergeDirection `protobuf:"varint,2,opt,name=direction,proto3,enum=metapb.MergeDirection" json:"direction,omitempty"`
	ConfVersion uint64                `protobuf:"varint,3,opt,name=conf_version,json=confVersion,proto3" json:"conf_version,omitempty"`
}

func (m *PreMergeRequest) Reset()                    { *m = PreMergeRequest{} }
func (m *PreMergeRequest) String() string            { return proto.CompactTextString(m) }
func (*PreMergeRequest) ProtoMessage()               {}
func (*PreMergeRequest) Descriptor() ([]byte, []int) { return fileDescriptorRaftCmdpb, []int{24} }

func (m *PreMergeRequest) GetMinIndex() uint64 {
	if m != nil {
		return m.MinIndex
	}
	return 0
...
func (m *PreMergeRequest) GetDirection() metapb.MergeDirection {
	if m != nil {
		return m.Direction
	}
...
func (m *PreMergeRequest) GetConfVersion() uint64 {
	if m != nil {
...
type PreMergeResponse struct {
}

func (m *PreMergeResponse) Reset()                    { *m = PreMergeResponse{} }
func (m *PreMergeResponse) String() string            { return proto.CompactTextString(m) }
func (*PreMergeResponse) ProtoMessage()               {}
func (*PreMergeResponse) Descriptor() ([]byte, []int) { return fileDescriptorRaftCmdpb, []int{25} }

type MergeRequest struct {
	SourceRegion *metapb.Region   `protobuf:"bytes,1,opt,name=source_region,json=sourceRegion" json:"source_region,omitempty"`
...
func (*MergeRequest) Descriptor() ([]byte, []int) { return fileDescriptorRaftCmdpb, []int{26} }

func (m *MergeRequest) GetSourceRegion() *metapb.Region {
	if m != nil {
...
func (m *MergeRequest) GetCommit() uint64 {
	if m != nil {
		return m.Commit
	}
	return 0
...
func (m *MergeRequest) GetEntries() []*eraftpb.Entry {
	if m != nil {
		return m.Entries
	}
	return nil
...
func (*MergeResponse) Descriptor() ([]byte, []int) { return fileDescriptorRaftCmdpb, []int{27} }

type RollbackPreMergeRequest struct {
	Commit uint64 `protobuf:"varint,1,opt,name=commit,proto3" json:"commit,omitempty"`
}

func (m *RollbackPreMergeRequest) Reset()         { *m = RollbackPreMergeRequest{} }
func (m *RollbackPreMergeRequest) String() string { return proto.CompactTextString(m) }
func (*RollbackPreMergeRequest) ProtoMessage()    {}
func (*RollbackPreMergeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorRaftCmdpb, []int{28}
}

func (m *RollbackPreMergeRequest) GetCommit() uint64 {
	if m != nil {
		return m.Commit
	}
	return 0
...
type RollbackPreMergeResponse struct {
}

func (m *RollbackPreMergeResponse) Reset()         { *m = RollbackPreMergeResponse{} }
func (m *RollbackPreMergeResponse) String() string { return proto.CompactTextString(m) }
func (*RollbackPreMergeResponse) ProtoMessage()    {}
func (*RollbackPreMergeResponse) Descriptor() ([]byte, []int) {
...
type AdminRequest struct {
	...
	PreMerge         *PreMergeRequest         `protobuf:"bytes,7,opt,name=pre_merge,json=preMerge" json:"pre_merge,omitempty"`
	Merge            *MergeRequest            `protobuf:"bytes,8,opt,name=merge" json:"merge,omitempty"`
	RollbackPreMerge *RollbackPreMergeRequest `protobuf:"bytes,9,opt,name=rollback_pre_merge,json=rollbackPreMerge" json:"rollback_pre_merge,omitempty"`
}
...
func (m *AdminRequest) GetPreMerge() *PreMergeRequest {
	if m != nil {
		return m.PreMerge
	}
	return nil
...
func (m *AdminRequest) GetRollbackPreMerge() *RollbackPreMergeRequest {
	if m != nil {
		return m.RollbackPreMerge
	}
	return nil
}
...
type AdminResponse struct {
	...
	PreMerge         *PreMergeResponse         `protobuf:"bytes,7,opt,name=pre_merge,json=preMerge" json:"pre_merge,omitempty"`
	Merge            *MergeResponse            `protobuf:"bytes,8,opt,name=merge" json:"merge,omitempty"`
	RollbackPreMerge *RollbackPreMergeResponse `protobuf:"bytes,9,opt,name=rollback_pre_merge,json=rollbackPreMerge" json:"rollback_pre_merge,omitempty"`
}
...
func (m *AdminResponse) GetPreMerge() *PreMergeResponse {
	if m != nil {
		return m.PreMerge
	}
	return nil
...
func (m *AdminResponse) GetRollbackPreMerge() *RollbackPreMergeResponse {
	if m != nil {
		return m.RollbackPreMerge
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PreMergeRequest)(nil), "raft_cmdpb.PreMergeRequest")
	proto.RegisterType((*PreMergeResponse)(nil), "raft_cmdpb.PreMergeResponse")
	proto.RegisterType((*MergeRequest)(nil), "raft_cmdpb.MergeRequest")
	proto.RegisterType((*MergeResponse)(nil), "raft_cmdpb.MergeResponse")
	proto.RegisterType((*RollbackPreMergeRequest)(nil), "raft_cmdpb.RollbackPreMergeRequest")
	proto.RegisterType((*RollbackPreMergeResponse)(nil), "raft_cmdpb.RollbackPreMergeResponse")
...
func (m *PreMergeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PreMergeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Direction != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.Direction))
	}
	if m.ConfVersion != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.ConfVersion))
	}
	return i, nil
}

func (m *PreMergeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PreMergeResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MergeRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SourceRegion != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.SourceRegion.Size()))
		n21, err := m.SourceRegion.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *RollbackPreMergeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RollbackPreMergeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RollbackPreMergeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RollbackPreMergeResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AdminRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PreMerge != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.PreMerge.Size()))
		n27, err := m.PreMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.RollbackPreMerge != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.RollbackPreMerge.Size()))
		n29, err := m.RollbackPreMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *AdminResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PreMerge != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.PreMerge.Size()))
		n35, err := m.PreMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.Merge != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.Merge.Size()))
		n36, err := m.Merge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
	...
	if m.RollbackPreMerge != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.RollbackPreMerge.Size()))
		n37, err := m.RollbackPreMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *StatusResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RegionLeader != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.RegionLeader.Size()))
		n43, err := m.RegionLeader.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.RegionDetail != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.RegionDetail.Size()))
		n44, err := m.RegionDetail.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *RaftCmdRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdminRequest != nil {
		...
		n49, err := m.AdminRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
	...
	if m.StatusRequest != nil {
		...
		n50, err := m.StatusRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *RaftCmdResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdminResponse != nil {
		...
		n52, err := m.AdminResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
	...
	if m.StatusResponse != nil {
		...
		n53, err := m.StatusResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
...
func (m *PreMergeRequest) Size() (n int) {
	var l int
	_ = l
	if m.MinIndex != 0 {
	...
	if m.Direction != 0 {
		n += 1 + sovRaftCmdpb(uint64(m.Direction))
	}
	if m.ConfVersion != 0 {
		n += 1 + sovRaftCmdpb(uint64(m.ConfVersion))
	}
	return n
}

func (m *PreMergeResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *RollbackPreMergeRequest) Size() (n int) {
	var l int
	_ = l
	if m.Commit != 0 {
		n += 1 + sovRaftCmdpb(uint64(m.Commit))
...
func (m *RollbackPreMergeResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *PreMergeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreMergeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreMergeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PreMergeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreMergeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreMergeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *RollbackPreMergeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RollbackPreMergeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RollbackPreMergeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *RollbackPreMergeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RollbackPreMergeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RollbackPreMergeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *AdminRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreMerge", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PreMerge == nil {
				m.PreMerge = &PreMergeRequest{}
			}
			if err := m.PreMerge.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RollbackPreMerge", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RollbackPreMerge == nil {
				m.RollbackPreMerge = &RollbackPreMergeRequest{}
			}
			if err := m.RollbackPreMerge.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AdminResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.RollbackPreMerge == nil {
				m.RollbackPreMerge = &RollbackPreMergeResponse{}
			}
			if err := m.RollbackPreMerge.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
