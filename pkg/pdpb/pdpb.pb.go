...
type IsRecoveringMarkedRequest struct {
	Header               *RequestHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
...
func (m *IsRecoveringMarkedRequest) Reset()         { *m = IsRecoveringMarkedRequest{} }
func (m *IsRecoveringMarkedRequest) String() string { return proto.CompactTextString(m) }
func (*IsRecoveringMarkedRequest) ProtoMessage()    {}
func (*IsRecoveringMarkedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_78b27e6f04f44c6e, []int{23}
}
func (m *IsRecoveringMarkedRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IsRecoveringMarkedRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IsRecoveringMarkedRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IsRecoveringMarkedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsRecoveringMarkedRequest.Merge(m, src)
}
func (m *IsRecoveringMarkedRequest) XXX_Size() int {
	return m.Size()
}
func (m *IsRecoveringMarkedRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_IsRecoveringMarkedRequest.DiscardUnknown(m)
}

var xxx_messageInfo_IsRecoveringMarkedRequest proto.InternalMessageInfo

func (m *IsRecoveringMarkedRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type IsRecoveringMarkedResponse struct {
	Header               *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
...
func (m *IsRecoveringMarkedResponse) Reset()         { *m = IsRecoveringMarkedResponse{} }
func (m *IsRecoveringMarkedResponse) String() string { return proto.CompactTextString(m) }
func (*IsRecoveringMarkedResponse) ProtoMessage()    {}
func (*IsRecoveringMarkedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_78b27e6f04f44c6e, []int{24}
}
func (m *IsRecoveringMarkedResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IsRecoveringMarkedResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IsRecoveringMarkedResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IsRecoveringMarkedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsRecoveringMarkedResponse.Merge(m, src)
}
func (m *IsRecoveringMarkedResponse) XXX_Size() int {
	return m.Size()
}
func (m *IsRecoveringMarkedResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_IsRecoveringMarkedResponse.DiscardUnknown(m)
}

var xxx_messageInfo_IsRecoveringMarkedResponse proto.InternalMessageInfo

func (m *IsRecoveringMarkedResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *IsRecoveringMarkedResponse) GetMarked() bool {
	if m != nil {
		return m.Marked
	}
	return false
...
func init() {
	...
	proto.RegisterType((*IsRecoveringMarkedRequest)(nil), "pdpb.IsRecoveringMarkedRequest")
	proto.RegisterType((*IsRecoveringMarkedResponse)(nil), "pdpb.IsRecoveringMarkedResponse")
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
type PDClient interface {
	...
	IsRecoveringMarked(ctx context.Context, in *IsRecoveringMarkedRequest, opts ...grpc.CallOption) (*IsRecoveringMarkedResponse, error)
...
func (c *pDClient) IsRecoveringMarked(ctx context.Context, in *IsRecoveringMarkedRequest, opts ...grpc.CallOption) (*IsRecoveringMarkedResponse, error) {
	out := new(IsRecoveringMarkedResponse)
	err := c.cc.Invoke(ctx, "/pdpb.PD/IsRecoveringMarked", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PDServer interface {
	...
	IsRecoveringMarked(context.Context, *IsRecoveringMarkedRequest) (*IsRecoveringMarkedResponse, error)
...
func (*UnimplementedPDServer) IsRecoveringMarked(ctx context.Context, req *IsRecoveringMarkedRequest) (*IsRecoveringMarkedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsRecoveringMarked not implemented")
}
...
func _PD_IsRecoveringMarked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsRecoveringMarkedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PDServer).IsRecoveringMarked(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdpb.PD/IsRecoveringMarked",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PDServer).IsRecoveringMarked(ctx, req.(*IsRecoveringMarkedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PD_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IsRecoveringMarked",
			Handler:    _PD_IsRecoveringMarked_Handler,
		},
		{
			MethodName: "GetStore",
...
func (m *IsRecoveringMarkedRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IsRecoveringMarkedRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IsRecoveringMarkedRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IsRecoveringMarkedResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IsRecoveringMarkedResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IsRecoveringMarkedResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IsRecoveringMarkedRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IsRecoveringMarkedResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IsRecoveringMarkedRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IsRecoveringMarkedRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IsRecoveringMarkedRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *IsRecoveringMarkedResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IsRecoveringMarkedResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IsRecoveringMarkedResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
