...
type SplitMethod int32

const (
	SplitMethod_Half          SplitMethod = 0
	SplitMethod_LogicalMiddle SplitMethod = 1
)

var SplitMethod_name = map[int32]string{
	0: "Half",
	1: "LogicalMiddle",
}
var SplitMethod_value = map[string]int32{
	"Half":          0,
	"LogicalMiddle": 1,
}

func (x SplitMethod) String() string {
	return proto.EnumName(SplitMethod_name, int32(x))
}
func (SplitMethod) EnumDescriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{1} }
...
type AskSplitRequest struct {
	Header      *RequestHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	Region      *metapb.Region `protobuf:"bytes,2,opt,name=region" json:"region,omitempty"`
	SplitMethod SplitMethod    `protobuf:"varint,3,opt,name=split_method,json=splitMethod,proto3,enum=pdpb.SplitMethod" json:"split_method,omitempty"`
}
...
func (m *AskSplitRequest) GetSplitMethod() SplitMethod {
	if m != nil {
		return m.SplitMethod
	}
	return SplitMethod_Half
}
...
func init() {
	...
	proto.RegisterEnum("pdpb.SplitMethod", SplitMethod_name, SplitMethod_value)
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SplitMethod |= (SplitMethod(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorPdpb = []byte{
	...
	,
}
