...
type UpdateGCSafePointRequest struct {
	...
	// The UpdateGCSafePoint API will be in the set of both legacy API and new API, but its behavior will be the same so we don't need to
	// avoid the collision on the method name. When it's used as a member of the new API set, the keyspace_id field can be used to specify
	// a keyspace.
...
func (m *UpdateGCSafePointRequest) GetTarget() uint64 {
	if m != nil {
		return m.Target
	}
	return 0
...
func (m *UpdateGCSafePointRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
type UpdateGCSafePointResponse struct {
	Header         *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	NewGcSafePoint uint64          `protobuf:"varint,2,opt,name=new_gc_safe_point,json=newGcSafePoint,proto3" json:"new_gc_safe_point,omitempty"`
}
...
func (m *UpdateGCSafePointResponse) GetNewGcSafePoint() uint64 {
	if m != nil {
...
func (m *UpdateTxnSafePointRequest) Reset()         { *m = UpdateTxnSafePointRequest{} }
func (m *UpdateTxnSafePointRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateTxnSafePointRequest) ProtoMessage()    {}
func (*UpdateTxnSafePointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_78b27e6f04f44c6e, []int{99}
}
func (m *UpdateTxnSafePointRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateTxnSafePointRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateTxnSafePointRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateTxnSafePointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateTxnSafePointRequest.Merge(m, src)
}
func (m *UpdateTxnSafePointRequest) XXX_Size() int {
	return m.Size()
}
func (m *UpdateTxnSafePointRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateTxnSafePointRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateTxnSafePointRequest proto.InternalMessageInfo

func (m *UpdateTxnSafePointRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *UpdateTxnSafePointRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
func (m *UpdateTxnSafePointRequest) GetTarget() uint64 {
	if m != nil {
		return m.Target
	}
	return 0
...
type UpdateTxnSafePointResponse struct {
	Header          *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	NewTxnSafePoint uint64          `protobuf:"varint,2,opt,name=new_txn_safe_point,json=newTxnSafePoint,proto3" json:"new_txn_safe_point,omitempty"`
}

func (m *UpdateTxnSafePointResponse) Reset()         { *m = UpdateTxnSafePointResponse{} }
func (m *UpdateTxnSafePointResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateTxnSafePointResponse) ProtoMessage()    {}
func (*UpdateTxnSafePointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_78b27e6f04f44c6e, []int{100}
}
func (m *UpdateTxnSafePointResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateTxnSafePointResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateTxnSafePointResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateTxnSafePointResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateTxnSafePointResponse.Merge(m, src)
}
func (m *UpdateTxnSafePointResponse) XXX_Size() int {
	return m.Size()
}
func (m *UpdateTxnSafePointResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateTxnSafePointResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateTxnSafePointResponse proto.InternalMessageInfo

func (m *UpdateTxnSafePointResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *UpdateTxnSafePointResponse) GetNewTxnSafePoint() uint64 {
	if m != nil {
...
func (m *SetGCBarrierRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
func (m *DeleteGCBarrierRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
func (m *GetGCStateRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
type GetGCStateResponse struct {
	Header       *ResponseHeader  `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	TxnSafePoint uint64           `protobuf:"varint,2,opt,name=txn_safe_point,json=txnSafePoint,proto3" json:"txn_safe_point,omitempty"`
	GcSafePoint  uint64           `protobuf:"varint,3,opt,name=gc_safe_point,json=gcSafePoint,proto3" json:"gc_safe_point,omitempty"`
	GcBarriers   []*GCBarrierInfo `protobuf:"bytes,4,rep,name=gc_barriers,json=gcBarriers,proto3" json:"gc_barriers,omitempty"`
}
...
func (m *GetGCStateResponse) GetTxnSafePoint() uint64 {
	if m != nil {
...
func (m *GetGCStateResponse) GetGcSafePoint() uint64 {
	if m != nil {
		return m.GcSafePoint
	}
	return 0
...
func (m *GetGCStateResponse) GetGcBarriers() []*GCBarrierInfo {
	if m != nil {
		return m.GcBarriers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UpdateTxnSafePointRequest)(nil), "pdpb.UpdateTxnSafePointRequest")
	proto.RegisterType((*UpdateTxnSafePointResponse)(nil), "pdpb.UpdateTxnSafePointResponse")
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
type PDClient interface {
	...
	UpdateTxnSafePoint(ctx context.Context, in *UpdateTxnSafePointRequest, opts ...grpc.CallOption) (*UpdateTxnSafePointResponse, error)
...
func (c *pDClient) UpdateTxnSafePoint(ctx context.Context, in *UpdateTxnSafePointRequest, opts ...grpc.CallOption) (*UpdateTxnSafePointResponse, error) {
	out := new(UpdateTxnSafePointResponse)
	err := c.cc.Invoke(ctx, "/pdpb.PD/UpdateTxnSafePoint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PDServer interface {
	...
	UpdateTxnSafePoint(context.Context, *UpdateTxnSafePointRequest) (*UpdateTxnSafePointResponse, error)
...
func (*UnimplementedPDServer) UpdateTxnSafePoint(ctx context.Context, req *UpdateTxnSafePointRequest) (*UpdateTxnSafePointResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTxnSafePoint not implemented")
}
...
func _PD_UpdateTxnSafePoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTxnSafePointRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PDServer).UpdateTxnSafePoint(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdpb.PD/UpdateTxnSafePoint",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PDServer).UpdateTxnSafePoint(ctx, req.(*UpdateTxnSafePointRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PD_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTxnSafePoint",
			Handler:    _PD_UpdateTxnSafePoint_Handler,
		},
		{
...
func (m *UpdateTxnSafePointRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateTxnSafePointRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateTxnSafePointRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateTxnSafePointResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateTxnSafePointResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateTxnSafePointResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateTxnSafePointRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateTxnSafePointResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateTxnSafePointRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateTxnSafePointRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateTxnSafePointRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateTxnSafePointResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateTxnSafePointResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateTxnSafePointResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
