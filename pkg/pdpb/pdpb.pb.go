...
type GlobalConfigItem struct {
	...
	// this field 'value' is replaced by the field 'value_payload'.
	...
	// Since item needs to support different struct types,
	// it should be set bytes instead of string
	ValuePayload         []byte   `protobuf:"bytes,5,opt,name=value_payload,json=valuePayload,proto3" json:"value_payload,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GlobalConfigItem) GetValuePayload() []byte {
	if m != nil {
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
func (m *GlobalConfigItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValuePayload) > 0 {
		i -= len(m.ValuePayload)
		copy(dAtA[i:], m.ValuePayload)
		i = encodeVarintPdpb(dAtA, i, uint64(len(m.ValuePayload)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Kind != 0 {
...
func (m *GlobalConfigItem) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValuePayload", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValuePayload = append(m.ValuePayload[:0], dAtA[iNdEx:postIndex]...)
			if m.ValuePayload == nil {
				m.ValuePayload = []byte{}
			}
			iNdEx = postIndex
		default:
