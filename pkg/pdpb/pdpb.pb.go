...
type StoreStats struct {
	...
	// Snapshot stat in the store
	SnapshotStat         *SnapshotStat `protobuf:"bytes,25,opt,name=snapshot_stat,json=snapshotStat,proto3" json:"snapshot_stat,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *StoreStats) GetSnapshotStat() *SnapshotStat {
	if m != nil {
		return m.SnapshotStat
	}
	return nil
}
...
type SnapshotStat struct {
	...
	GenerateMs uint64 `protobuf:"varint,1,opt,name=generate_ms,json=generateMs,proto3" json:"generate_ms,omitempty"`
	// Send snapshot duration
	SendMs uint64 `protobuf:"varint,2,opt,name=send_ms,json=sendMs,proto3" json:"send_ms,omitempty"`
	// Total duration include wait time
	// |-- waiting --|-- generate --｜-- send --|
	// |-----------total duration---------------|
	TotalMs uint64 `protobuf:"varint,3,opt,name=total_ms,json=totalMs,proto3" json:"total_ms,omitempty"`
	// send size in report interval, the unit is MB
	SendSize             uint64   `protobuf:"varint,4,opt,name=send_size,json=sendSize,proto3" json:"send_size,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SnapshotStat) GetGenerateMs() uint64 {
	if m != nil {
		return m.GenerateMs
	}
	return 0
...
func (m *SnapshotStat) GetSendMs() uint64 {
	if m != nil {
		return m.SendMs
	}
	return 0
...
func (m *SnapshotStat) GetTotalMs() uint64 {
	if m != nil {
		return m.TotalMs
	}
	return 0
...
func (m *SnapshotStat) GetSendSize() uint64 {
	if m != nil {
		return m.SendSize
	}
	return 0
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
func (m *StoreStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SnapshotStat != nil {
		{
			size, err := m.SnapshotStat.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SnapshotStat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SendSize != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.SendSize))
		i--
		dAtA[i] = 0x20
	}
	if m.TotalMs != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.TotalMs))
		i--
		dAtA[i] = 0x18
	}
	if m.SendMs != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.SendMs))
		i--
		dAtA[i] = 0x10
	}
	if m.GenerateMs != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.GenerateMs))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SplitRegionsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RegionsId) > 0 {
		dAtA128 := make([]byte, len(m.RegionsId)*10)
		var j127 int
		for _, num := range m.RegionsId {
			for num >= 1<<7 {
...
func (m *SnapshotStat) Size() (n int) {
	...
	_ = l
	if m.GenerateMs != 0 {
		n += 1 + sovPdpb(uint64(m.GenerateMs))
	}
	if m.SendMs != 0 {
		n += 1 + sovPdpb(uint64(m.SendMs))
	}
	if m.TotalMs != 0 {
		n += 1 + sovPdpb(uint64(m.TotalMs))
	}
	if m.SendSize != 0 {
		n += 1 + sovPdpb(uint64(m.SendSize))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *StoreStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SnapshotStat", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SnapshotStat == nil {
				m.SnapshotStat = &SnapshotStat{}
			}
			if err := m.SnapshotStat.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SnapshotStat) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GenerateMs", wireType)
			}
			m.GenerateMs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GenerateMs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SendMs", wireType)
			}
			m.SendMs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SendSize", wireType)
			}
			m.SendSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SendSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
