...
const (
	ItemKind_PUT    ItemKind = 0
	ItemKind_DELETE ItemKind = 1
)

var ItemKind_name = map[int32]string{
	0: "PUT",
	1: "DELETE",
}

var ItemKind_value = map[string]int32{
	"PUT":    0,
	"DELETE": 1,
}

func (x ItemKind) String() string {
	return proto.EnumName(ItemKind_name, int32(x))
}
...
type StoreGlobalConfigRequest struct {
	ConfigPath           string              `protobuf:"bytes,1,opt,name=config_path,json=configPath,proto3" json:"config_path,omitempty"`
	Changes              []*GlobalConfigItem `protobuf:"bytes,2,rep,name=changes,proto3" json:"changes,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
type GlobalConfigItem struct {
	Kind                 ItemKind `protobuf:"varint,1,opt,name=kind,proto3,enum=pdpb.ItemKind" json:"kind,omitempty"`
...
func (m *GlobalConfigItem) GetKind() ItemKind {
	if m != nil {
		return m.Kind
	}
	return ItemKind_PUT
...
type RegionStats struct {
	Region               *metapb.Region  `protobuf:"bytes,1,opt,name=region,proto3" json:"region,omitempty"`
	RegionStats          *RegionStat     `protobuf:"bytes,2,opt,name=region_stats,json=regionStats,proto3" json:"region_stats,omitempty"`
	Leader               *metapb.Peer    `protobuf:"bytes,3,opt,name=leader,proto3" json:"leader,omitempty"`
	Buckets              *metapb.Buckets `protobuf:"bytes,4,opt,name=buckets,proto3" json:"buckets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *RegionStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegionStats.Merge(m, src)
}
...
func (m *RegionStats) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
func (m *RegionStats) GetRegionStats() *RegionStat {
	if m != nil {
		return m.RegionStats
	}
	return nil
...
func (m *RegionStats) GetLeader() *metapb.Peer {
	if m != nil {
		return m.Leader
	}
	return nil
...
func (m *RegionStats) GetBuckets() *metapb.Buckets {
	if m != nil {
		return m.Buckets
	}
	return nil
...
func (m *WatchRequest) GetKeyspace() string {
	if m != nil {
		return m.Keyspace
	}
	return ""
...
func (m *WatchRequest) GetResource() string {
	if m != nil {
		return m.Resource
	}
	return ""
...
func (m *ListRequest) GetRevision() uint64 {
	if m != nil {
		return m.Revision
	}
	return 0
...
func (m *ListResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *ListResponse) GetRevision() uint64 {
	if m != nil {
		return m.Revision
	}
	return 0
...
type Event struct {
	EventType            EventType `protobuf:"varint,1,opt,name=event_type,json=eventType,proto3,enum=pdpb.EventType" json:"event_type,omitempty"`
...
type Item_Region struct {
	Region *metapb.Region `protobuf:"bytes,1,opt,name=region,proto3,oneof" json:"region,omitempty"`
}
type Item_RegionStat struct {
	RegionStat *RegionStats `protobuf:"bytes,2,opt,name=region_stat,json=regionStat,proto3,oneof" json:"region_stat,omitempty"`
}

func (*Item_Region) isItem_Item()     {}
func (*Item_RegionStat) isItem_Item() {}
...
func (m *Item) GetRegion() *metapb.Region {
	if x, ok := m.GetItem().(*Item_Region); ok {
		return x.Region
	}
	return nil
}

func (m *Item) GetRegionStat() *RegionStats {
	if x, ok := m.GetItem().(*Item_RegionStat); ok {
		return x.RegionStat
	}
	return nil
}
...
func init() {
	proto.RegisterEnum("pdpb.ItemKind", ItemKind_name, ItemKind_value)
	...
	proto.RegisterType((*RegionStats)(nil), "pdpb.RegionStats")
	proto.RegisterType((*WatchRequest)(nil), "pdpb.WatchRequest")
	proto.RegisterType((*WatchResponse)(nil), "pdpb.WatchResponse")
	proto.RegisterType((*ListRequest)(nil), "pdpb.ListRequest")
	proto.RegisterType((*ListResponse)(nil), "pdpb.ListResponse")
	proto.RegisterType((*Event)(nil), "pdpb.Event")
	proto.RegisterType((*Item)(nil), "pdpb.Item")
}
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
type PDClient interface {
	...
	List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (PD_ListClient, error)
	Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (PD_WatchClient, error)
}
...
func (c *pDClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (PD_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PD_serviceDesc.Streams[5], "/pdpb.PD/List", opts...)
	if err != nil {
		return nil, err
	}
	x := &pDListClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type PD_ListClient interface {
	Recv() (*ListResponse, error)
	grpc.ClientStream
}

type pDListClient struct {
	grpc.ClientStream
}

func (x *pDListClient) Recv() (*ListResponse, error) {
	m := new(ListResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *pDClient) Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (PD_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PD_serviceDesc.Streams[6], "/pdpb.PD/Watch", opts...)
	if err != nil {
		return nil, err
	}
	x := &pDWatchClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type PD_WatchClient interface {
	Recv() (*WatchResponse, error)
	grpc.ClientStream
}

type pDWatchClient struct {
	grpc.ClientStream
}

func (x *pDWatchClient) Recv() (*WatchResponse, error) {
	m := new(WatchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type PDServer interface {
	...
	List(*ListRequest, PD_ListServer) error
	Watch(*WatchRequest, PD_WatchServer) error
}
...
func (*UnimplementedPDServer) List(req *ListRequest, srv PD_ListServer) error {
	return status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (*UnimplementedPDServer) Watch(req *WatchRequest, srv PD_WatchServer) error {
...
func _PD_List_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(PDServer).List(m, &pDListServer{stream})
}

type PD_ListServer interface {
	Send(*ListResponse) error
	grpc.ServerStream
}

type pDListServer struct {
	grpc.ServerStream
}

func (x *pDListServer) Send(m *ListResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _PD_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(WatchRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(PDServer).Watch(m, &pDWatchServer{stream})
}

type PD_WatchServer interface {
...
func (x *pDWatchServer) Send(m *WatchResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _PD_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "List",
			Handler:       _PD_List_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "Watch",
			Handler:       _PD_Watch_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "pdpb.proto",
...
func (m *StoreStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DamagedRegionsId) > 0 {
		dAtA87 := make([]byte, len(m.DamagedRegionsId)*10)
		var j86 int
...
func (m *ForceLeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EnterForceLeaders) > 0 {
		dAtA97 := make([]byte, len(m.EnterForceLeaders)*10)
		var j96 int
	...
	if len(m.FailedStores) > 0 {
		dAtA99 := make([]byte, len(m.FailedStores)*10)
		var j98 int
...
func (m *RecoveryPlan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tombstones) > 0 {
		dAtA102 := make([]byte, len(m.Tombstones)*10)
		var j101 int
...
func (m *AwakenRegions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AbnormalStores) > 0 {
		dAtA104 := make([]byte, len(m.AbnormalStores)*10)
		var j103 int
...
func (m *ScatterRegionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RegionsId) > 0 {
		dAtA110 := make([]byte, len(m.RegionsId)*10)
		var j109 int
...
func (m *RegionStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.RegionStats != nil {
		{
			size, err := m.RegionStats.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WatchRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Resource) > 0 {
		...
		i = encodeVarintPdpb(dAtA, i, uint64(len(m.Resource)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Keyspace) > 0 {
		...
		i = encodeVarintPdpb(dAtA, i, uint64(len(m.Keyspace)))
		i--
		dAtA[i] = 0x12
	}
	if m.Header != nil {
...
func (m *Event) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EventType != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.EventType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Item_Region) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Item_Region) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Region != nil {
		{
			size, err := m.Region.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Item_RegionStat) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Item_RegionStat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RegionStat != nil {
		{
			size, err := m.RegionStat.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Event) Size() (n int) {
	...
	_ = l
	if m.EventType != 0 {
		n += 1 + sovPdpb(uint64(m.EventType))
	}
	if m.Item != nil {
		l = m.Item.Size()
		n += 1 + l + sovPdpb(uint64(l))
...
func (m *Item_RegionStat) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RegionStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.RegionStats == nil {
				m.RegionStats = &RegionStat{}
			}
			if err := m.RegionStats.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *Item) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Item = &Item_Region{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegionStat", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
