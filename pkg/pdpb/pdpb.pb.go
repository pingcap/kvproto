...
type RegionHeartbeatResponse struct {
	...
	// Leader of the region at the moment of the corresponding request be made.
	OriginalLeader *metapb.Peer `protobuf:"bytes,6,opt,name=original_leader,json=originalLeader" json:"original_leader,omitempty"`
}
...
func (m *RegionHeartbeatResponse) GetOriginalLeader() *metapb.Peer {
	if m != nil {
		return m.OriginalLeader
	}
	return nil
}
...
func (m *RegionHeartbeatResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OriginalLeader != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintPdpb(dAtA, i, uint64(m.OriginalLeader.Size()))
		n43, err := m.OriginalLeader.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *RegionHeartbeatResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OriginalLeader", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.OriginalLeader == nil {
				m.OriginalLeader = &metapb.Peer{}
			}
			if err := m.OriginalLeader.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorPdpb = []byte{
	...
	0xd3, 0xc4, 0x4d, 0x5c, 0x04, 0x28, 0x10, 0xa4, 0x88, 0xfc, 0x97, 0x18, 0x49, 0x2c, 0x63, 0xa5,
	0x20, 0xc8, 0x4d, 0x55, 0x4a, 0x5c, 0xcb, 0x6c, 0x28, 0x92, 0xe1, 0x52, 0x31, 0x94, 0xab, 0x5e,
	0xf5, 0xa6, 0x45, 0xdb, 0xab, 0xa2, 0x8f, 0xd2, 0x47, 0xe8, 0x65, 0x1f, 0xa1, 0x48, 0xdf, 0xa2,
	0x57, 0xc5, 0xee, 0x72, 0x29, 0x92, 0x92, 0x53, 0x97, 0x69, 0xef, 0xb8, 0x33, 0xb3, 0xdf, 0x7e,
	...
	0x8e, 0x39, 0x27, 0xcb, 0x19, 0x0b, 0x55, 0x46, 0xa8, 0xd4, 0x10, 0xff, 0x46, 0x83, 0x8a, 0x20,
	0x25, 0x63, 0x86, 0xee, 0x27, 0x58, 0xad, 0x2b, 0x56, 0xd1, 0x98, 0x7e, 0x99, 0x16, 0x7a, 0x00,
	0x65, 0x5f, 0xd1, 0x6a, 0x65, 0x05, 0x4c, 0x10, 0xab, 0x90, 0x2d, 0x99, 0x5b, 0xe0, 0xdf, 0x6b,
	...
	0x35, 0x6c, 0x26, 0x51, 0x52, 0x6d, 0x12, 0x86, 0xea, 0x30, 0x82, 0x22, 0x82, 0x54, 0x22, 0x31,
	...
	0x0a, 0x0f, 0x6e, 0xb5, 0xc8, 0x33, 0x68, 0xce, 0x17, 0x49, 0x95, 0xaa, 0xbf, 0x14, 0xd1, 0x08,
	0x4a, 0x20, 0x0d, 0xcf, 0x6d, 0x00, 0x59, 0x38, 0x83, 0xf7, 0x74, 0x26, 0xc8, 0x56, 0x49, 0x59,
	0x4a, 0x5e, 0xd2, 0x19, 0xfe, 0xa3, 0x06, 0xab, 0x91, 0x05, 0x52, 0xc5, 0x7b, 0x5e, 0xb9, 0x99,
	0x2f, 0x55, 0x2e, 0xfa, 0x0e, 0x0a, 0x96, 0x44, 0x95, 0x15, 0x5e, 0x55, 0x76, 0x17, 0x94, 0xa3,
	0x49, 0x1d, 0xfe, 0x15, 0xac, 0x87, 0x84, 0x0e, 0x67, 0xe9, 0x12, 0x1e, 0xdd, 0x81, 0xc0, 0xc7,
	...
	0xe9, 0xd7, 0x93, 0xff, 0x6f, 0x96, 0x7c, 0x01, 0xad, 0xc5, 0x25, 0x53, 0x65, 0xf3, 0x35, 0x14,
	...
	0xb9, 0x5c, 0x9b, 0xa5, 0xda, 0xec, 0x3f, 0x69, 0x80, 0xa2, 0x10, 0x29, 0x2b, 0xa5, 0x28, 0x1d,
	...
	0xb6, 0xc1, 0x82, 0x08, 0x57, 0xb8, 0xac, 0x27, 0x45, 0xf8, 0x5f, 0x19, 0xd8, 0x94, 0x95, 0xf7,
	0x82, 0xea, 0x9e, 0x3f, 0xa4, 0xba, 0x9f, 0x2a, 0xb9, 0xfe, 0xa7, 0x27, 0x02, 0xda, 0x07, 0x10,
	0xc4, 0xb9, 0x17, 0x72, 0x73, 0xc3, 0x07, 0x4b, 0xe8, 0x3f, 0x29, 0x73, 0x13, 0x3e, 0x64, 0xe8,
	0x11, 0xd4, 0x5c, 0x6a, 0x1b, 0xa6, 0x3d, 0x0e, 0xa6, 0xe4, 0x83, 0x58, 0x47, 0xc1, 0xab, 0x81,
	...
	,
}
