...
/*
Package recover_data is a generated protocol buffer package.
...
It has these top-level messages:
	...
	ReadRegionMetaRequest
	Error
	RegionMeta
	RecoverRegionRequest
	RecoverRegionResponse
	WaitApplyRequest
	WaitApplyResponse
	ResolveKvDataRequest
	ResolveKvDataResponse
*/
...
func (*ReadRegionMetaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorRecoverdatapb, []int{0}
}
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorRecoverdatapb, []int{1} }
...
func (*RegionMeta) Descriptor() ([]byte, []int) { return fileDescriptorRecoverdatapb, []int{2} }
...
func (*RecoverRegionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorRecoverdatapb, []int{3}
}
...
func (*RecoverRegionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorRecoverdatapb, []int{4}
}
...
func (*WaitApplyRequest) Descriptor() ([]byte, []int) { return fileDescriptorRecoverdatapb, []int{5} }
...
func (*WaitApplyResponse) Descriptor() ([]byte, []int) { return fileDescriptorRecoverdatapb, []int{6} }
...
func (*ResolveKvDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorRecoverdatapb, []int{7}
}
...
func (*ResolveKvDataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorRecoverdatapb, []int{8}
}
...
// Client API for RecoverData service
...
func (c *recoverDataClient) ReadRegionMeta(ctx context.Context, in *ReadRegionMetaRequest, opts ...grpc.CallOption) (RecoverData_ReadRegionMetaClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_RecoverData_serviceDesc.Streams[0], c.cc, "/recover_data.RecoverData/ReadRegionMeta", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *recoverDataClient) RecoverRegion(ctx context.Context, opts ...grpc.CallOption) (RecoverData_RecoverRegionClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_RecoverData_serviceDesc.Streams[1], c.cc, "/recover_data.RecoverData/RecoverRegion", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *recoverDataClient) WaitApply(ctx context.Context, in *WaitApplyRequest, opts ...grpc.CallOption) (*WaitApplyResponse, error) {
	...
	err := grpc.Invoke(ctx, "/recover_data.RecoverData/WaitApply", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recoverDataClient) ResolveKvData(ctx context.Context, in *ResolveKvDataRequest, opts ...grpc.CallOption) (RecoverData_ResolveKvDataClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_RecoverData_serviceDesc.Streams[2], c.cc, "/recover_data.RecoverData/ResolveKvData", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for RecoverData service
...
func (m *RecoverRegionResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRecoverdatapb(dAtA, i, uint64(m.Error.Size()))
	...
	for iNdEx < l {
		...
		case 3:
			for {
				...
				next, err := skipRecoverdatapb(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
func init() { proto.RegisterFile("recoverdatapb.proto", fileDescriptorRecoverdatapb) }

var fileDescriptorRecoverdatapb = []byte{
