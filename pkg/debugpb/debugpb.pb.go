...
const (
	Fail_INVALID Fail_Type = 0
	Fail_INJECT  Fail_Type = 1
	Fail_RECOVER Fail_Type = 2
)

var Fail_Type_name = map[int32]string{
	0: "INVALID",
	1: "INJECT",
	2: "RECOVER",
}
var Fail_Type_value = map[string]int32{
	"INVALID": 0,
	"INJECT":  1,
	"RECOVER": 2,
}
...
func (x Fail_Type) String() string {
	return proto.EnumName(Fail_Type_name, int32(x))
}
func (Fail_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptorDebugpb, []int{10, 0} }
...
type Fail struct {
	...
	Type    Fail_Type `protobuf:"varint,2,opt,name=type,proto3,enum=debugpb.Fail_Type" json:"type,omitempty"`
...
func (*Fail) Descriptor() ([]byte, []int) { return fileDescriptorDebugpb, []int{10} }

func (m *Fail) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type FailPointRequest struct {
	Fails []*Fail `protobuf:"bytes,1,rep,name=fails" json:"fails,omitempty"`
}
...
func (m *FailPointRequest) GetFails() []*Fail {
	if m != nil {
		return m.Fails
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Fail)(nil), "debugpb.Fail")
	...
	proto.RegisterEnum("debugpb.Fail_Type", Fail_Type_name, Fail_Type_value)
}
...
func (m *FailPointRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Fails[len(m.Fails)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorDebugpb = []byte{
	...
	,
}
