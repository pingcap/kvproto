...
type GetFailPointsRequest struct {
}

func (m *GetFailPointsRequest) Reset()                    { *m = GetFailPointsRequest{} }
func (m *GetFailPointsRequest) String() string            { return proto.CompactTextString(m) }
func (*GetFailPointsRequest) ProtoMessage()               {}
func (*GetFailPointsRequest) Descriptor() ([]byte, []int) { return fileDescriptorDebugpb, []int{16} }

type GetFailPointsResponse struct {
	Entries []*GetFailPointsResponse_Entry `protobuf:"bytes,1,rep,name=entries" json:"entries,omitempty"`
}

func (m *GetFailPointsResponse) Reset()                    { *m = GetFailPointsResponse{} }
func (m *GetFailPointsResponse) String() string            { return proto.CompactTextString(m) }
func (*GetFailPointsResponse) ProtoMessage()               {}
func (*GetFailPointsResponse) Descriptor() ([]byte, []int) { return fileDescriptorDebugpb, []int{17} }

func (m *GetFailPointsResponse) GetEntries() []*GetFailPointsResponse_Entry {
	if m != nil {
		return m.Entries
	}
	return nil
...
type GetFailPointsResponse_Entry struct {
	Name    string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Actions string `protobuf:"bytes,2,opt,name=actions,proto3" json:"actions,omitempty"`
}

func (m *GetFailPointsResponse_Entry) Reset()         { *m = GetFailPointsResponse_Entry{} }
func (m *GetFailPointsResponse_Entry) String() string { return proto.CompactTextString(m) }
func (*GetFailPointsResponse_Entry) ProtoMessage()    {}
func (*GetFailPointsResponse_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptorDebugpb, []int{17, 0}
}

func (m *GetFailPointsResponse_Entry) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *GetFailPointsResponse_Entry) GetActions() string {
	if m != nil {
		return m.Actions
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetFailPointsRequest)(nil), "debugpb.GetFailPointsRequest")
	proto.RegisterType((*GetFailPointsResponse)(nil), "debugpb.GetFailPointsResponse")
	proto.RegisterType((*GetFailPointsResponse_Entry)(nil), "debugpb.GetFailPointsResponse.Entry")
...
type DebugClient interface {
	...
	// Get all fail points.
	GetFailPoints(ctx context.Context, in *GetFailPointsRequest, opts ...grpc.CallOption) (*GetFailPointsResponse, error)
}
...
func (c *debugClient) GetFailPoints(ctx context.Context, in *GetFailPointsRequest, opts ...grpc.CallOption) (*GetFailPointsResponse, error) {
	out := new(GetFailPointsResponse)
	err := grpc.Invoke(ctx, "/debugpb.Debug/GetFailPoints", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DebugServer interface {
	...
	// Get all fail points.
	GetFailPoints(context.Context, *GetFailPointsRequest) (*GetFailPointsResponse, error)
}
...
func _Debug_GetFailPoints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFailPointsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).GetFailPoints(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/debugpb.Debug/GetFailPoints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).GetFailPoints(ctx, req.(*GetFailPointsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Debug_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFailPoints",
			Handler:    _Debug_GetFailPoints_Handler,
		},
	},
...
func (m *GetFailPointsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetFailPointsRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GetFailPointsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetFailPointsResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GetFailPointsResponse_Entry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetFailPointsResponse_Entry) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GetFailPointsRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *GetFailPointsResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Entries) > 0 {
		for _, e := range m.Entries {
...
func (m *GetFailPointsResponse_Entry) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	if l > 0 {
...
func (m *GetFailPointsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetFailPointsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetFailPointsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GetFailPointsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetFailPointsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetFailPointsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Entries = append(m.Entries, &GetFailPointsResponse_Entry{})
			if err := m.Entries[len(m.Entries)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *GetFailPointsResponse_Entry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorDebugpb = []byte{
	...
	,
}
