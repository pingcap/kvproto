...
func (LogLevel) EnumDescriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{0} }
...
func (ServerInfoType) EnumDescriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{1} }
...
func (SearchLogRequest_Target) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorDiagnosticspb, []int{0, 0}
}
...
func (*SearchLogRequest) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{0} }
...
func (*SearchLogResponse) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{1} }
...
func (*LogMessage) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{2} }
...
func (*ServerInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{3} }
...
func (*ServerInfoPair) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{4} }
...
func (*ServerInfoItem) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{5} }
...
func (*ServerInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptorDiagnosticspb, []int{6} }
...
func (c *diagnosticsClient) SearchLog(ctx context.Context, in *SearchLogRequest, opts ...grpc.CallOption) (Diagnostics_SearchLogClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Diagnostics_serviceDesc.Streams[0], c.cc, "/diagnosticspb.Diagnostics/search_log", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *diagnosticsClient) ServerInfo(ctx context.Context, in *ServerInfoRequest, opts ...grpc.CallOption) (*ServerInfoResponse, error) {
	...
	err := grpc.Invoke(ctx, "/diagnosticspb.Diagnostics/server_info", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("diagnosticspb.proto", fileDescriptorDiagnosticspb) }

var fileDescriptorDiagnosticspb = []byte{
