...
type GCRequest struct {
	...
	// The ratio of MVCC versions / rows to start GC.
...
func (m *GCRequest) GetRatioThreshold() float64 {
	if m != nil {
		return m.RatioThreshold
	}
	return 0
}
...
func (m *GCRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RatioThreshold != 0 {
		dAtA[i] = 0x19
		i++
		i = encodeFixed64Kvrpcpb(dAtA, i, uint64(math.Float64bits(float64(m.RatioThreshold))))
	}
	return i, nil
}
...
func (m *GCRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field RatioThreshold", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			m.RatioThreshold = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipKvrpcpb(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
