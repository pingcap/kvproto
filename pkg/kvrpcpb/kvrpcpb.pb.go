...
type ResolveLockRequest struct {
	...
	CommitVersion  uint64        `protobuf:"varint,3,opt,name=commit_version,json=commitVersion,proto3" json:"commit_version,omitempty"`
	MultiTxnStatus []*Txn2Status `protobuf:"bytes,4,rep,name=multi_txn_status,json=multiTxnStatus" json:"multi_txn_status,omitempty"`
}
...
func (m *ResolveLockRequest) GetMultiTxnStatus() []*Txn2Status {
	if m != nil {
		return m.MultiTxnStatus
	}
	return nil
}
...
func (m *ResolveLockRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MultiTxnStatus) > 0 {
		for _, msg := range m.MultiTxnStatus {
			dAtA[i] = 0x22
			i++
			i = encodeVarintKvrpcpb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *ResolveLockRequest) Size() (n int) {
	...
	if len(m.MultiTxnStatus) > 0 {
		for _, e := range m.MultiTxnStatus {
			l = e.Size()
			n += 1 + l + sovKvrpcpb(uint64(l))
		}
	}
...
func (m *ResolveLockRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MultiTxnStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MultiTxnStatus = append(m.MultiTxnStatus, &Txn2Status{})
			if err := m.MultiTxnStatus[len(m.MultiTxnStatus)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
