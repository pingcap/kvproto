...
func (CommandPri) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{0}
}
...
func (IsolationLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{1}
}
...
func (Op) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{2}
}

type PreconditionLevel int32

const (
	PreconditionLevel_Error PreconditionLevel = 0
	PreconditionLevel_Fatal PreconditionLevel = 1
)

var PreconditionLevel_name = map[int32]string{
	0: "Error",
	1: "Fatal",
}
var PreconditionLevel_value = map[string]int32{
	"Error": 0,
	"Fatal": 1,
}

func (x PreconditionLevel) String() string {
	return proto.EnumName(PreconditionLevel_name, int32(x))
}
func (PreconditionLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{3}
}
...
func (*NotExist) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{2}
}
func (m *NotExist) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NotExist) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NotExist.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *NotExist) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotExist.Merge(dst, src)
}
func (m *NotExist) XXX_Size() int {
	return m.Size()
}
func (m *NotExist) XXX_DiscardUnknown() {
	xxx_messageInfo_NotExist.DiscardUnknown(m)
}

var xxx_messageInfo_NotExist proto.InternalMessageInfo

func (m *NotExist) GetKey() []byte {
	if m != nil {
		return m.Key
	}
	return nil
...
type KeyError struct {
	...
	Precondition         *PreconditionResponse `protobuf:"bytes,5,opt,name=precondition" json:"precondition,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*KeyError) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{4}
}
...
func (m *KeyError) GetPrecondition() *PreconditionResponse {
	if m != nil {
...
func (*WriteConflict) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{5}
}
...
func (*Context) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{6}
}
...
func (*HandleTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{7}
}
...
func (*ScanInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{8}
}
...
func (*ScanDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{9}
}
...
func (*ExecDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{10}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{11}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{12}
}
...
func (*ScanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{13}
}
...
func (*KvPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{14}
}
...
func (*ScanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{15}
}
...
type Precondition struct {
	// The level decides what happen when the precondition fails.
	Level PreconditionLevel `protobuf:"varint,1,opt,name=level,proto3,enum=kvrpcpb.PreconditionLevel" json:"level,omitempty"`
	// Should not exist
	ShouldNotExist bool `protobuf:"varint,2,opt,name=should_not_exist,json=shouldNotExist,proto3" json:"should_not_exist,omitempty"`
	// Value must equal to
	EqualTo []byte `protobuf:"bytes,3,opt,name=equal_to,json=equalTo,proto3" json:"equal_to,omitempty"`
	// Must exist
	MustExist            bool     `protobuf:"varint,4,opt,name=must_exist,json=mustExist,proto3" json:"must_exist,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*Precondition) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{16}
}
...
func (m *Precondition) GetLevel() PreconditionLevel {
	if m != nil {
		return m.Level
	}
	return PreconditionLevel_Error
}
...
func (m *Precondition) GetMustExist() bool {
	if m != nil {
		return m.MustExist
	}
	return false
...
type PreconditionResponse struct {
	Level                PreconditionLevel `protobuf:"varint,1,opt,name=level,proto3,enum=kvrpcpb.PreconditionLevel" json:"level,omitempty"`
	AlreadyExist         *AlreadyExist     `protobuf:"bytes,2,opt,name=already_exist,json=alreadyExist" json:"already_exist,omitempty"`
	NotEqualTo           *NotEqualTo       `protobuf:"bytes,3,opt,name=not_equal_to,json=notEqualTo" json:"not_equal_to,omitempty"`
	NotExist             *NotExist         `protobuf:"bytes,4,opt,name=not_exist,json=notExist" json:"not_exist,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *PreconditionResponse) Reset()         { *m = PreconditionResponse{} }
func (m *PreconditionResponse) String() string { return proto.CompactTextString(m) }
func (*PreconditionResponse) ProtoMessage()    {}
func (*PreconditionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{17}
}
func (m *PreconditionResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PreconditionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PreconditionResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *PreconditionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreconditionResponse.Merge(dst, src)
}
func (m *PreconditionResponse) XXX_Size() int {
	return m.Size()
}
func (m *PreconditionResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_PreconditionResponse.DiscardUnknown(m)
}

var xxx_messageInfo_PreconditionResponse proto.InternalMessageInfo

func (m *PreconditionResponse) GetLevel() PreconditionLevel {
	if m != nil {
		return m.Level
	}
	return PreconditionLevel_Error
...
func (m *PreconditionResponse) GetAlreadyExist() *AlreadyExist {
	if m != nil {
...
func (m *PreconditionResponse) GetNotEqualTo() *NotEqualTo {
	if m != nil {
		return m.NotEqualTo
	}
	return nil
...
func (m *PreconditionResponse) GetNotExist() *NotExist {
	if m != nil {
		return m.NotExist
	}
	return nil
...
func (*Mutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{18}
}
...
func (*PrewriteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{19}
}
...
func (*PrewriteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{20}
}
...
func (*CommitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{21}
}
...
func (*CommitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{22}
}
...
func (*ImportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{23}
}
...
func (*ImportResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{24}
}
...
func (*BatchRollbackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{25}
}
...
func (*BatchRollbackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{26}
}
...
func (*CleanupRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{27}
}
...
func (*CleanupResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{28}
}
...
func (*BatchGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{29}
}
...
func (*BatchGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{30}
}
...
func (*ScanLockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{31}
}
...
func (*ScanLockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{32}
}
...
func (*TxnInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{33}
}
...
func (*ResolveLockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{34}
}
...
func (*ResolveLockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{35}
}
...
func (*GCRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{36}
}
...
func (*GCResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{37}
}
...
func (*RawGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{38}
}
...
func (*RawGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{39}
}
...
func (*RawPutRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{40}
}
...
func (*RawPutResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{41}
}
...
func (*RawBatchPutRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{42}
}
...
func (*RawBatchPutResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{43}
}
...
func (*RawBatchGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{44}
}
...
func (*RawBatchGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{45}
}
...
func (*RawDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{46}
}
...
func (*RawDeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{47}
}
...
func (*RawBatchDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{48}
}
...
func (*RawBatchDeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{49}
}
...
func (*DeleteRangeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{50}
}
...
func (*DeleteRangeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{51}
}
...
func (*RawDeleteRangeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{52}
}
...
func (*RawDeleteRangeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{53}
}
...
func (*RawScanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{54}
}
...
func (*RawScanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{55}
}
...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{56}
}
...
func (*RawBatchScanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{57}
}
...
func (*RawBatchScanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{58}
}
...
func (*MvccWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{59}
}
...
func (*MvccValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{60}
}
...
func (*MvccLock) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{61}
}
...
func (*MvccInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{62}
}
...
func (*MvccGetByKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{63}
}
...
func (*MvccGetByKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{64}
}
...
func (*MvccGetByStartTsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{65}
}
...
func (*MvccGetByStartTsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{66}
}
...
func (*SplitRegionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{67}
}
...
func (*SplitRegionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{68}
}
...
func (*UnsafeDestroyRangeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{69}
}
...
func (*UnsafeDestroyRangeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_kvrpcpb_1468bb451c024c69, []int{70}
}
...
func init() {
	...
	proto.RegisterType((*NotExist)(nil), "kvrpcpb.NotExist")
	...
	proto.RegisterType((*PreconditionResponse)(nil), "kvrpcpb.PreconditionResponse")
	...
	proto.RegisterEnum("kvrpcpb.PreconditionLevel", PreconditionLevel_name, PreconditionLevel_value)
}
...
func (m *Precondition) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Level != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.Level))
	}
	if m.ShouldNotExist {
		dAtA[i] = 0x10
		i++
...
func (m *PreconditionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PreconditionResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.AlreadyExist != nil {
		...
		n17, err := m.AlreadyExist.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	...
	if m.NotEqualTo != nil {
		...
		n18, err := m.NotEqualTo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	if m.NotExist != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.NotExist.Size()))
		n19, err := m.NotExist.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *Mutation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Precondition != nil {
		...
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.Precondition.Size()))
		n20, err := m.Precondition.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *PreconditionResponse) Size() (n int) {
	var l int
	_ = l
	if m.Level != 0 {
		n += 1 + sovKvrpcpb(uint64(m.Level))
...
func (m *KeyError) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Precondition == nil {
				m.Precondition = &PreconditionResponse{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Level |= (PreconditionLevel(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PreconditionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreconditionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreconditionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func init() { proto.RegisterFile("kvrpcpb.proto", fileDescriptor_kvrpcpb_1468bb451c024c69) }

var fileDescriptor_kvrpcpb_1468bb451c024c69 = []byte{
	...
	,
}
