...
type PessimisticLockResponse struct {
	...
	LockedWithConflictTs []uint64 `protobuf:"varint,7,rep,packed,name=locked_with_conflict_ts,json=lockedWithConflictTs,proto3" json:"locked_with_conflict_ts,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_1afe832be69693c7 = []byte{
	...
	,
}
...
func (m *PessimisticLockResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LockedWithConflictTs) > 0 {
		dAtA12 := make([]byte, len(m.LockedWithConflictTs)*10)
		var j11 int
...
func (m *RawBatchPutRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Ttls) > 0 {
		dAtA58 := make([]byte, len(m.Ttls)*10)
		var j57 int
...
func (m *Context) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CommittedLocks) > 0 {
		dAtA92 := make([]byte, len(m.CommittedLocks)*10)
		var j91 int
	...
	if len(m.ResolvedLocks) > 0 {
		dAtA94 := make([]byte, len(m.ResolvedLocks)*10)
		var j93 int
		...
		i = encodeVarintKvrpcpb(dAtA, i, uint64(j93))
		i--
		dAtA[i] = 0x6a
	}
	if m.ReplicaRead {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.LockedWithConflictTs) == 0 {
					m.LockedWithConflictTs = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
