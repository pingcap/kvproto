...
type CmdPrewriteRequest struct {
	...
	LockTtl          uint64 `protobuf:"varint,4,opt,name=lock_ttl" json:"lock_ttl"`
	SkipSeekWrite    bool   `protobuf:"varint,5,opt,name=skip_seek_write" json:"skip_seek_write"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *CmdPrewriteRequest) GetSkipSeekWrite() bool {
	if m != nil {
		return m.SkipSeekWrite
	}
	return false
}
...
func (m *CmdPrewriteRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipSeekWrite", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
