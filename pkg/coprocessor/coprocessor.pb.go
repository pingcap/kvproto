...
type VersionedKeyRange struct {
	...
	ReadTs uint64    `protobuf:"fixed64,2,opt,name=read_ts,json=readTs,proto3" json:"read_ts,omitempty"`
}
...
type Request struct {
	...
	VersionedRanges []*VersionedKeyRange `protobuf:"bytes,16,rep,name=versioned_ranges,json=versionedRanges,proto3" json:"versioned_ranges,omitempty"`
}
...
type StoreBatchTask struct {
	...
	// Versioned point ranges for TiCI lookup.
	// When `versioned_ranges` is non-empty, all `versioned_ranges[i].range` must be point range.
	VersionedRanges []*VersionedKeyRange `protobuf:"bytes,7,rep,name=versioned_ranges,json=versionedRanges,proto3" json:"versioned_ranges,omitempty"`
}
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
...
func (m *VersionedKeyRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ReadTs != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.ReadTs))
		i--
		dAtA[i] = 0x11
	}
	if m.Range != nil {
...
func (m *VersionedKeyRange) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.ReadTs = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		default:
			iNdEx = preIndex
			skippy, err := skipCoprocessor(dAtA[iNdEx:])
