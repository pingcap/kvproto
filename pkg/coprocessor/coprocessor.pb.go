...
// PagingBreakReason tells TiDB why TiKV stopped a paging coprocessor
// response before finishing the scanned range. TiDB uses this to avoid mixing
// row-limited join pages with byte-limited fullscan pages in RU precharge
// prediction.
type PagingBreakReason int32

const (
	PagingBreakReason_PAGING_BREAK_REASON_UNKNOWN    PagingBreakReason = 0
	PagingBreakReason_PAGING_BREAK_REASON_ROW_LIMIT  PagingBreakReason = 1
	PagingBreakReason_PAGING_BREAK_REASON_BYTE_LIMIT PagingBreakReason = 2
	PagingBreakReason_PAGING_BREAK_REASON_RANGE_END  PagingBreakReason = 3
)

var PagingBreakReason_name = map[int32]string{
	0: "PAGING_BREAK_REASON_UNKNOWN",
	1: "PAGING_BREAK_REASON_ROW_LIMIT",
	2: "PAGING_BREAK_REASON_BYTE_LIMIT",
	3: "PAGING_BREAK_REASON_RANGE_END",
}

var PagingBreakReason_value = map[string]int32{
	"PAGING_BREAK_REASON_UNKNOWN":    0,
	"PAGING_BREAK_REASON_ROW_LIMIT":  1,
	"PAGING_BREAK_REASON_BYTE_LIMIT": 2,
	"PAGING_BREAK_REASON_RANGE_END":  3,
}

func (x PagingBreakReason) String() string {
	return proto.EnumName(PagingBreakReason_name, int32(x))
}

func (PagingBreakReason) EnumDescriptor() ([]byte, []int) {
...
type Response struct {
	...
	// Why TiKV returned a paging range. Unknown means legacy TiKV or a response
	// path that did not classify the break reason.
	PagingBreakReason PagingBreakReason `protobuf:"varint,14,opt,name=paging_break_reason,json=pagingBreakReason,proto3,enum=coprocessor.PagingBreakReason" json:"paging_break_reason,omitempty"`
}
...
func (m *Response) GetPagingBreakReason() PagingBreakReason {
	if m != nil {
		return m.PagingBreakReason
	}
	return PagingBreakReason_PAGING_BREAK_REASON_UNKNOWN
}
...
func init() {
	proto.RegisterEnum("coprocessor.PagingBreakReason", PagingBreakReason_name, PagingBreakReason_value)
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PagingBreakReason != 0 {
		i = encodeVarintCoprocessor(dAtA, i, uint64(m.PagingBreakReason))
		i--
		dAtA[i] = 0x70
	}
...
func (m *Response) Size() (n int) {
	...
	if m.PagingBreakReason != 0 {
		n += 1 + sovCoprocessor(uint64(m.PagingBreakReason))
	}
	return n
}
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PagingBreakReason", wireType)
			}
			m.PagingBreakReason = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCoprocessor
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PagingBreakReason |= PagingBreakReason(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
