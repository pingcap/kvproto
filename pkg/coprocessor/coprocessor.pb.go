...
type Request struct {
	...
	// Set when the client can consume a full-sampling Analyze response whose
	// batched tasks' per-region sampling results (see `tasks`) are merged into
	// the single result carried by the response's data.
	...
	AllowAnalyzeBatchTaskDataMerge bool `protobuf:"varint,18,opt,name=allow_analyze_batch_task_data_merge,json=allowAnalyzeBatchTaskDataMerge,proto3" json:"allow_analyze_batch_task_data_merge,omitempty"`
}
...
func (m *Request) GetAllowAnalyzeBatchTaskDataMerge() bool {
	if m != nil {
		return m.AllowAnalyzeBatchTaskDataMerge
	}
	return false
}
...
type StoreBatchTaskResponse struct {
	...
	// `Request.allow_analyze_batch_task_data_merge`). The batch response then carries
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.AllowAnalyzeBatchTaskDataMerge {
		i--
		if m.AllowAnalyzeBatchTaskDataMerge {
			dAtA[i] = 1
		} else {
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowAnalyzeBatchTaskDataMerge", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowAnalyzeBatchTaskDataMerge = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipCoprocessor(dAtA[iNdEx:])
			if err != nil {
