...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{0}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{1}
}
...
type Response struct {
	...
	// Contains the up-to-date buckets of the region if Request.context.buckets_version is stale.
	Buckets              *metapb.Buckets `protobuf:"bytes,12,opt,name=buckets" json:"buckets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{2}
}
...
func (m *Response) GetBuckets() *metapb.Buckets {
	if m != nil {
		return m.Buckets
	}
	return nil
...
func (*RegionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{3}
}
...
func (*TableRegions) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{4}
}
...
func (*BatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{5}
}
...
func (*BatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_07ea9acb255801f5, []int{6}
}
...
func (m *Response) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Buckets != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintCoprocessor(dAtA, i, uint64(m.Buckets.Size()))
		n8, err := m.Buckets.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func init() { proto.RegisterFile("coprocessor.proto", fileDescriptor_coprocessor_07ea9acb255801f5) }

var fileDescriptor_coprocessor_07ea9acb255801f5 = []byte{
	...
	,
}
