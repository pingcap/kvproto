...
func (m *Request) GetRangeVersions() []uint64 {
	if m != nil {
		return m.RangeVersions
	}
	return nil
}
...
func (m *VersionedRequest) Reset()         { *m = VersionedRequest{} }
func (m *VersionedRequest) String() string { return proto.CompactTextString(m) }
func (*VersionedRequest) ProtoMessage()    {}
func (*VersionedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_29878c170c3dd019, []int{3}
}
func (m *VersionedRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VersionedRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VersionedRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VersionedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VersionedRequest.Merge(m, src)
}
func (m *VersionedRequest) XXX_Size() int {
	return m.Size()
}
func (m *VersionedRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VersionedRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VersionedRequest proto.InternalMessageInfo

func (m *VersionedRequest) GetRequest() *Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *VersionedResponse) Reset()         { *m = VersionedResponse{} }
func (m *VersionedResponse) String() string { return proto.CompactTextString(m) }
func (*VersionedResponse) ProtoMessage()    {}
func (*VersionedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_29878c170c3dd019, []int{4}
}
func (m *VersionedResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VersionedResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VersionedResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VersionedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VersionedResponse.Merge(m, src)
}
func (m *VersionedResponse) XXX_Size() int {
	return m.Size()
}
func (m *VersionedResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VersionedResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VersionedResponse proto.InternalMessageInfo

func (m *VersionedResponse) GetResponse() *Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (m *VersionedBatchRequest) String() string { return proto.CompactTextString(m) }
func (*VersionedBatchRequest) ProtoMessage()    {}
func (*VersionedBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_29878c170c3dd019, []int{11}
}
func (m *VersionedBatchRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VersionedBatchRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VersionedBatchRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VersionedBatchRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VersionedBatchRequest.Merge(m, src)
}
func (m *VersionedBatchRequest) XXX_Size() int {
	return m.Size()
}
func (m *VersionedBatchRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VersionedBatchRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VersionedBatchRequest proto.InternalMessageInfo

func (m *VersionedBatchRequest) GetRequest() *BatchRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *VersionedBatchResponse) String() string { return proto.CompactTextString(m) }
func (*VersionedBatchResponse) ProtoMessage()    {}
func (*VersionedBatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_29878c170c3dd019, []int{12}
}
func (m *VersionedBatchResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VersionedBatchResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VersionedBatchResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VersionedBatchResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VersionedBatchResponse.Merge(m, src)
}
func (m *VersionedBatchResponse) XXX_Size() int {
	return m.Size()
}
func (m *VersionedBatchResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VersionedBatchResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VersionedBatchResponse proto.InternalMessageInfo

func (m *VersionedBatchResponse) GetResponse() *BatchResponse {
	if m != nil {
		return m.Response
	}
	return nil
...
func (m *StoreBatchTask) GetRangeVersions() []uint64 {
	if m != nil {
		return m.RangeVersions
	}
	return nil
...
func (*DelegateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_29878c170c3dd019, []int{16}
}
...
func init() {
	...
	proto.RegisterType((*VersionedRequest)(nil), "coprocessor.VersionedRequest")
	proto.RegisterType((*VersionedResponse)(nil), "coprocessor.VersionedResponse")
	...
	proto.RegisterType((*VersionedBatchRequest)(nil), "coprocessor.VersionedBatchRequest")
	proto.RegisterType((*VersionedBatchResponse)(nil), "coprocessor.VersionedBatchResponse")
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RangeVersions) > 0 {
		dAtA2 := make([]byte, len(m.RangeVersions)*10)
		var j1 int
		for _, num := range m.RangeVersions {
			for num >= 1<<7 {
		...
		i = encodeVarintCoprocessor(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0x7a
	}
...
func (m *VersionedRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VersionedRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VersionedRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VersionedResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VersionedResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VersionedResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VersionedBatchRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VersionedBatchRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VersionedBatchRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VersionedBatchResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VersionedBatchResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VersionedBatchResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoreBatchTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.RangeVersions) > 0 {
		dAtA17 := make([]byte, len(m.RangeVersions)*10)
		var j16 int
		for _, num := range m.RangeVersions {
			for num >= 1<<7 {
		...
		i = encodeVarintCoprocessor(dAtA, i, uint64(j16))
		i--
		dAtA[i] = 0x32
	}
	if m.TaskId != 0 {
...
func (m *Request) Size() (n int) {
	...
	if len(m.RangeVersions) > 0 {
		l = 0
		for _, e := range m.RangeVersions {
			l += sovCoprocessor(uint64(e))
		}
		n += 1 + sovCoprocessor(uint64(l)) + l
	}
	return n
}
...
func (m *VersionedRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VersionedResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VersionedBatchRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VersionedBatchResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	for iNdEx < l {
		...
		case 15:
			if wireType == 0 {
				...
				m.RangeVersions = append(m.RangeVersions, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.RangeVersions) == 0 {
					m.RangeVersions = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field RangeVersions", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipCoprocessor(dAtA[iNdEx:])
...
func (m *VersionedRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VersionedRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VersionedRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VersionedResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VersionedResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VersionedResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VersionedBatchRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VersionedBatchRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VersionedBatchRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VersionedBatchResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VersionedBatchResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VersionedBatchResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
