...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_ca3cc1e071f40000, []int{0}
}
...
type Request struct {
	...
	ScanAllLocks         bool     `protobuf:"varint,7,opt,name=scan_all_locks,json=scanAllLocks,proto3" json:"scan_all_locks,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_ca3cc1e071f40000, []int{1}
}
...
type Response struct {
	...
	AllLocks             []*kvrpcpb.LockInfo                                    `protobuf:"bytes,9,rep,name=all_locks,json=allLocks" json:"all_locks,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                               `json:"-"`
	XXX_unrecognized     []byte                                                 `json:"-"`
	XXX_sizecache        int32                                                  `json:"-"`
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_ca3cc1e071f40000, []int{2}
}
...
func init() { proto.RegisterFile("coprocessor.proto", fileDescriptor_coprocessor_ca3cc1e071f40000) }

var fileDescriptor_coprocessor_ca3cc1e071f40000 = []byte{
	// 570 bytes of a gzipped FileDescriptorProto
	,
}
