...
/*
Package logbackup is a generated protocol buffer package.
...
It has these top-level messages:
	...
	GetLastFlushTSOfRegionResponse
	SubscribeFlushEventRequest
	SubscribeFlushEventResponse
	FlushEvent
*/
package logbackup
...
func (*RegionIdentity) Descriptor() ([]byte, []int) { return fileDescriptorLogbackuppb, []int{0} }
...
type RegionCheckpoint struct {
	Err        *errorpb.Error  `protobuf:"bytes,1,opt,name=err" json:"err,omitempty"`
	Region     *RegionIdentity `protobuf:"bytes,2,opt,name=region" json:"region,omitempty"`
...
func (*RegionCheckpoint) Descriptor() ([]byte, []int) { return fileDescriptorLogbackuppb, []int{1} }
...
type GetLastFlushTSOfRegionRequest struct {
	Regions []*RegionIdentity `protobuf:"bytes,1,rep,name=regions" json:"regions,omitempty"`
}
...
func (*GetLastFlushTSOfRegionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorLogbackuppb, []int{2}
}
...
type GetLastFlushTSOfRegionResponse struct {
	Checkpoints []*RegionCheckpoint `protobuf:"bytes,1,rep,name=checkpoints" json:"checkpoints,omitempty"`
}
...
func (*GetLastFlushTSOfRegionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorLogbackuppb, []int{3}
}
...
func (*SubscribeFlushEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorLogbackuppb, []int{4}
}
...
type SubscribeFlushEventResponse struct {
	Events []*FlushEvent `protobuf:"bytes,1,rep,name=events" json:"events,omitempty"`
}
...
func (*SubscribeFlushEventResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorLogbackuppb, []int{5}
}
...
func (*FlushEvent) Descriptor() ([]byte, []int) { return fileDescriptorLogbackuppb, []int{6} }
...
// Client API for LogBackup service
...
func (c *logBackupClient) GetLastFlushTSOfRegion(ctx context.Context, in *GetLastFlushTSOfRegionRequest, opts ...grpc.CallOption) (*GetLastFlushTSOfRegionResponse, error) {
	...
	err := grpc.Invoke(ctx, "/logbackup.LogBackup/GetLastFlushTSOfRegion", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logBackupClient) SubscribeFlushEvent(ctx context.Context, in *SubscribeFlushEventRequest, opts ...grpc.CallOption) (LogBackup_SubscribeFlushEventClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_LogBackup_serviceDesc.Streams[0], c.cc, "/logbackup.LogBackup/SubscribeFlushEvent", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for LogBackup service
...
func (m *RegionCheckpoint) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Err != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintLogbackuppb(dAtA, i, uint64(m.Err.Size()))
	...
	if m.Region != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintLogbackuppb(dAtA, i, uint64(m.Region.Size()))
...
func (m *GetLastFlushTSOfRegionRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Regions) > 0 {
		for _, msg := range m.Regions {
			dAtA[i] = 0xa
			i++
			i = encodeVarintLogbackuppb(dAtA, i, uint64(msg.Size()))
	...
	for iNdEx < l {
		...
		case 3:
			for {
				...
				next, err := skipLogbackuppb(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
func init() { proto.RegisterFile("logbackuppb.proto", fileDescriptorLogbackuppb) }

var fileDescriptorLogbackuppb = []byte{
