...
func (Event_EventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorMetaStoragepb, []int{10, 0}
}
...
func (*KeyValue) Descriptor() ([]byte, []int) { return fileDescriptorMetaStoragepb, []int{9} }
...
func (*Event) Descriptor() ([]byte, []int) { return fileDescriptorMetaStoragepb, []int{10} }
...
func (m *Event) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PrevKv != nil {
		...
		i++
		i = encodeVarintMetaStoragepb(dAtA, i, uint64(m.PrevKv.Size()))
		n10, err := m.PrevKv.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
