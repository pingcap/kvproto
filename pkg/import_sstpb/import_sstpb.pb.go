...
func (Pair_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{20, 0}
}
...
type SSTMetaGroupItem struct {
	...
	TotalKvs   uint64 `protobuf:"varint,6,opt,name=total_kvs,json=totalKvs,proto3" json:"total_kvs,omitempty"`
	...
	CipherIv             []byte   `protobuf:"bytes,8,opt,name=cipher_iv,json=cipherIv,proto3" json:"cipher_iv,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SSTMetaGroupItem) GetUuid() []byte {
	if m != nil {
		return m.Uuid
	}
	return nil
...
type SSTMeta struct {
	...
	SubSsts              []*SSTMetaGroupItem `protobuf:"bytes,13,rep,name=sub_ssts,json=subSsts,proto3" json:"sub_ssts,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *SSTMeta) GetSubSsts() []*SSTMetaGroupItem {
	if m != nil {
		return m.SubSsts
	}
	return nil
...
var fileDescriptor_4d076b7935cfab6b = []byte{
	...
	,
}
...
func (m *SSTMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubSsts) > 0 {
		for iNdEx := len(m.SubSsts) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SubSsts[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SSTMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubSsts", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SubSsts = append(m.SubSsts, &SSTMetaGroupItem{})
			if err := m.SubSsts[len(m.SubSsts)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
