...
type SSTMetaGroupItem struct {
	...
	// total_kvs and total_bytes is equivalent to PD's approximate_keys and approximate_size
	// set these values can save time from tikv upload keys and size to PD through Heartbeat.
	TotalKvs   uint64 `protobuf:"varint,5,opt,name=total_kvs,json=totalKvs,proto3" json:"total_kvs,omitempty"`
	TotalBytes uint64 `protobuf:"varint,6,opt,name=total_bytes,json=totalBytes,proto3" json:"total_bytes,omitempty"`
	// cipher_iv is used to encrypt/decrypt sst
	CipherIv             []byte   `protobuf:"bytes,7,opt,name=cipher_iv,json=cipherIv,proto3" json:"cipher_iv,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SSTMetaGroupItem) Reset()         { *m = SSTMetaGroupItem{} }
func (m *SSTMetaGroupItem) String() string { return proto.CompactTextString(m) }
func (*SSTMetaGroupItem) ProtoMessage()    {}
func (*SSTMetaGroupItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{14}
}
func (m *SSTMetaGroupItem) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SSTMetaGroupItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SSTMetaGroupItem.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SSTMetaGroupItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SSTMetaGroupItem.Merge(m, src)
}
func (m *SSTMetaGroupItem) XXX_Size() int {
	return m.Size()
}
func (m *SSTMetaGroupItem) XXX_DiscardUnknown() {
	xxx_messageInfo_SSTMetaGroupItem.DiscardUnknown(m)
}

var xxx_messageInfo_SSTMetaGroupItem proto.InternalMessageInfo

func (m *SSTMetaGroupItem) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *SSTMetaGroupItem) GetCrc32() uint32 {
	if m != nil {
		return m.Crc32
	}
	return 0
...
func (m *SSTMetaGroupItem) GetLength() uint64 {
	if m != nil {
		return m.Length
	}
	return 0
...
func (m *SSTMetaGroupItem) GetCfName() string {
	if m != nil {
		return m.CfName
	}
	return ""
...
func (m *SSTMetaGroupItem) GetTotalKvs() uint64 {
	if m != nil {
		return m.TotalKvs
	}
	return 0
...
func (m *SSTMetaGroupItem) GetTotalBytes() uint64 {
	if m != nil {
		return m.TotalBytes
	}
	return 0
...
func (m *SSTMetaGroupItem) GetCipherIv() []byte {
	if m != nil {
		return m.CipherIv
	}
	return nil
...
type SSTMetaGroup struct {
	Ssts            []*SSTMetaGroupItem `protobuf:"bytes,1,rep,name=ssts,proto3" json:"ssts,omitempty"`
	...
	EndKeyExclusive bool                `protobuf:"varint,6,opt,name=end_key_exclusive,json=endKeyExclusive,proto3" json:"end_key_exclusive,omitempty"`
	// API version implies the encode of the key and value.
	ApiVersion           kvrpcpb.APIVersion `protobuf:"varint,7,opt,name=api_version,json=apiVersion,proto3,enum=kvrpcpb.APIVersion" json:"api_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *SSTMetaGroup) Reset()         { *m = SSTMetaGroup{} }
func (m *SSTMetaGroup) String() string { return proto.CompactTextString(m) }
func (*SSTMetaGroup) ProtoMessage()    {}
func (*SSTMetaGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{15}
}
func (m *SSTMetaGroup) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SSTMetaGroup) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SSTMetaGroup.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SSTMetaGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SSTMetaGroup.Merge(m, src)
}
func (m *SSTMetaGroup) XXX_Size() int {
	return m.Size()
}
func (m *SSTMetaGroup) XXX_DiscardUnknown() {
	xxx_messageInfo_SSTMetaGroup.DiscardUnknown(m)
}

var xxx_messageInfo_SSTMetaGroup proto.InternalMessageInfo

func (m *SSTMetaGroup) GetSsts() []*SSTMetaGroupItem {
	if m != nil {
		return m.Ssts
	}
	return nil
...
func (m *SSTMetaGroup) GetUuid() []byte {
	if m != nil {
		return m.Uuid
	}
	return nil
...
func (m *SSTMetaGroup) GetRange() *Range {
	if m != nil {
		return m.Range
	}
	return nil
...
func (m *SSTMetaGroup) GetRegionId() uint64 {
	if m != nil {
		return m.RegionId
	}
	return 0
...
func (m *SSTMetaGroup) GetRegionEpoch() *metapb.RegionEpoch {
	if m != nil {
		return m.RegionEpoch
	}
	return nil
...
func (m *SSTMetaGroup) GetEndKeyExclusive() bool {
	if m != nil {
		return m.EndKeyExclusive
	}
	return false
...
func (m *SSTMetaGroup) GetApiVersion() kvrpcpb.APIVersion {
	if m != nil {
		return m.ApiVersion
	}
	return kvrpcpb.APIVersion_V1
...
type DownloadRequest struct {
	// We'll generate all SSTMeta into one SST File for each CF.
	Ssts *SSTMetaGroup `protobuf:"bytes,1,opt,name=ssts,proto3" json:"ssts,omitempty"`
...
func (m *DownloadRequest) GetSsts() *SSTMetaGroup {
	if m != nil {
		return m.Ssts
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SSTMetaGroupItem)(nil), "import_sstpb.SSTMetaGroupItem")
	proto.RegisterType((*SSTMetaGroup)(nil), "import_sstpb.SSTMetaGroup")
...
var fileDescriptor_4d076b7935cfab6b = []byte{
	...
	,
}
...
func (m *SSTMetaGroupItem) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SSTMetaGroupItem) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SSTMetaGroupItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SSTMetaGroup) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SSTMetaGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SSTMetaGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DownloadRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Ssts != nil {
		{
			size, err := m.Ssts.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SSTMetaGroupItem) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SSTMetaGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SSTMetaGroupItem) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SSTMetaGroupItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SSTMetaGroupItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SSTMetaGroup) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SSTMetaGroup: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SSTMetaGroup: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Ssts = append(m.Ssts, &SSTMetaGroupItem{})
			if err := m.Ssts[len(m.Ssts)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *DownloadRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Ssts.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
