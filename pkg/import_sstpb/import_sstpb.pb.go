...
func (Pair_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{23, 0}
}
...
// Restore a complete snapshot into one existing target region. The caller must
// supply all relevant write/default CF files and send the request to its leader.
// TiKV determines the target key range from the region metadata and crops the
// rewritten keys to that range. Repeated requests may repeat the underlying work.
type RestoreRegionRequest struct {
	// Identifies the target region, its epoch and peer, and the target API version.
	Context *kvrpcpb.Context `protobuf:"bytes,1,opt,name=context,proto3" json:"context,omitempty"`
	// Shared source storage and access configuration for all files.
	StorageBackend *brpb.StorageBackend   `protobuf:"bytes,2,opt,name=storage_backend,json=storageBackend,proto3" json:"storage_backend,omitempty"`
	Sources        []*RestoreRegionSource `protobuf:"bytes,3,rep,name=sources,proto3" json:"sources,omitempty"`
	// Source backup encryption configuration. Omit for unencrypted files.
	CipherInfo *brpb.CipherInfo `protobuf:"bytes,4,opt,name=cipher_info,json=cipherInfo,proto3" json:"cipher_info,omitempty"`
}

func (m *RestoreRegionRequest) Reset()         { *m = RestoreRegionRequest{} }
func (m *RestoreRegionRequest) String() string { return proto.CompactTextString(m) }
func (*RestoreRegionRequest) ProtoMessage()    {}
func (*RestoreRegionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{13}
}
func (m *RestoreRegionRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RestoreRegionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RestoreRegionRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RestoreRegionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RestoreRegionRequest.Merge(m, src)
}
func (m *RestoreRegionRequest) XXX_Size() int {
	return m.Size()
}
func (m *RestoreRegionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RestoreRegionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RestoreRegionRequest proto.InternalMessageInfo

func (m *RestoreRegionRequest) GetContext() *kvrpcpb.Context {
	if m != nil {
		return m.Context
	}
	return nil
...
func (m *RestoreRegionRequest) GetStorageBackend() *brpb.StorageBackend {
	if m != nil {
...
func (m *RestoreRegionRequest) GetSources() []*RestoreRegionSource {
	if m != nil {
		return m.Sources
	}
	return nil
...
func (m *RestoreRegionRequest) GetCipherInfo() *brpb.CipherInfo {
	if m != nil {
		return m.CipherInfo
	}
	return nil
...
// One source backup SST, rather than an output file generated during restore.
type RestoreRegionSource struct {
	// File path relative to the source storage backend's prefix.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Source file size in bytes.
	Length uint64 `protobuf:"varint,2,opt,name=length,proto3" json:"length,omitempty"`
	// Source column family: "write" or "default".
	Cf string `protobuf:"bytes,3,opt,name=cf,proto3" json:"cf,omitempty"`
	// Optional key-prefix and timestamp rewrite. For this RPC, prefixes are
	// logical key bytes before memcomparable encoding, as in Keyspace download
	// mode. Timestamp filtering through ignore_after_timestamp or
	// ignore_before_timestamp is not supported.
	RewriteRule *RewriteRule `protobuf:"bytes,4,opt,name=rewrite_rule,json=rewriteRule,proto3" json:"rewrite_rule,omitempty"`
	// Per-file initialization vector. Empty for unencrypted files.
	CipherIv []byte `protobuf:"bytes,5,opt,name=cipher_iv,json=cipherIv,proto3" json:"cipher_iv,omitempty"`
}

func (m *RestoreRegionSource) Reset()         { *m = RestoreRegionSource{} }
func (m *RestoreRegionSource) String() string { return proto.CompactTextString(m) }
func (*RestoreRegionSource) ProtoMessage()    {}
func (*RestoreRegionSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{14}
}
func (m *RestoreRegionSource) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RestoreRegionSource) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RestoreRegionSource.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RestoreRegionSource) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RestoreRegionSource.Merge(m, src)
}
func (m *RestoreRegionSource) XXX_Size() int {
	return m.Size()
}
func (m *RestoreRegionSource) XXX_DiscardUnknown() {
	xxx_messageInfo_RestoreRegionSource.DiscardUnknown(m)
}

var xxx_messageInfo_RestoreRegionSource proto.InternalMessageInfo

func (m *RestoreRegionSource) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *RestoreRegionSource) GetLength() uint64 {
	if m != nil {
		return m.Length
	}
	return 0
...
func (m *RestoreRegionSource) GetCf() string {
	if m != nil {
		return m.Cf
	}
	return ""
...
func (m *RestoreRegionSource) GetRewriteRule() *RewriteRule {
	if m != nil {
...
func (m *RestoreRegionSource) GetCipherIv() []byte {
	if m != nil {
		return m.CipherIv
	}
	return nil
...
func (m *SetDownloadSpeedLimitRequest) GetTaskId() string {
	if m != nil {
		return m.TaskId
	}
	return ""
...
func (m *SetDownloadSpeedLimitRequest) GetTtlSeconds() uint64 {
	if m != nil {
		return m.TtlSeconds
	}
	return 0
...
func (*RemovePartitionRangeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{40}
}
...
func (*RemovePartitionRangeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{41}
}
...
func init() {
	...
	proto.RegisterType((*RestoreRegionRequest)(nil), "import_sstpb.RestoreRegionRequest")
	proto.RegisterType((*RestoreRegionSource)(nil), "import_sstpb.RestoreRegionSource")
...
var fileDescriptor_4d076b7935cfab6b = []byte{
	...
	,
}
...
type ImportSSTClient interface {
	...
	BatchDownloadLatestMVCC(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DownloadResponse, error)
	...
	// Restore backup SSTs into an existing region using the cloud storage engine.
	// Success is returned after the generated files have been applied. A failed
	// or interrupted RPC does not guarantee that the restore has not taken effect.
	RestoreRegion(ctx context.Context, in *RestoreRegionRequest, opts ...grpc.CallOption) (*IngestResponse, error)
...
func (c *importSSTClient) BatchDownloadLatestMVCC(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DownloadResponse, error) {
	out := new(DownloadResponse)
	err := c.cc.Invoke(ctx, "/import_sstpb.ImportSST/BatchDownloadLatestMVCC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *importSSTClient) RestoreRegion(ctx context.Context, in *RestoreRegionRequest, opts ...grpc.CallOption) (*IngestResponse, error) {
	out := new(IngestResponse)
	err := c.cc.Invoke(ctx, "/import_sstpb.ImportSST/RestoreRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImportSSTServer interface {
	...
	// Download SST files in batch from external storage, perform key rewrite,
	// merge them into one SST, and keep only the latest MVCC version after downloading.
	BatchDownloadLatestMVCC(context.Context, *DownloadRequest) (*DownloadResponse, error)
	// Open a write stream to generate sst files
	...
	// Success is returned after the generated files have been applied. A failed
	// or interrupted RPC does not guarantee that the restore has not taken effect.
	RestoreRegion(context.Context, *RestoreRegionRequest) (*IngestResponse, error)
	// Collect duplicate data from TiKV.
...
func (*UnimplementedImportSSTServer) BatchDownloadLatestMVCC(ctx context.Context, req *DownloadRequest) (*DownloadResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchDownloadLatestMVCC not implemented")
}
...
func (*UnimplementedImportSSTServer) RestoreRegion(ctx context.Context, req *RestoreRegionRequest) (*IngestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RestoreRegion not implemented")
}
...
func _ImportSST_BatchDownloadLatestMVCC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DownloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImportSSTServer).BatchDownloadLatestMVCC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/import_sstpb.ImportSST/BatchDownloadLatestMVCC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImportSSTServer).BatchDownloadLatestMVCC(ctx, req.(*DownloadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ImportSST_RestoreRegion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RestoreRegionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImportSSTServer).RestoreRegion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/import_sstpb.ImportSST/RestoreRegion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImportSSTServer).RestoreRegion(ctx, req.(*RestoreRegionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ImportSST_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchDownloadLatestMVCC",
			Handler:    _ImportSST_BatchDownloadLatestMVCC_Handler,
		},
		{
		...
		{
			MethodName: "RestoreRegion",
			Handler:    _ImportSST_RestoreRegion_Handler,
		},
		{
			MethodName: "Apply",
...
func (m *RestoreRegionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RestoreRegionRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RestoreRegionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RestoreRegionSource) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RestoreRegionSource) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RestoreRegionSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SetDownloadSpeedLimitRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TaskId) > 0 {
		...
		i = encodeVarintImportSstpb(dAtA, i, uint64(len(m.TaskId)))
		i--
		dAtA[i] = 0x12
	}
	if m.SpeedLimit != 0 {
...
func (m *RestoreRegionRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RestoreRegionSource) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RestoreRegionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RestoreRegionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RestoreRegionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.Sources = append(m.Sources, &RestoreRegionSource{})
...
func (m *RestoreRegionSource) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RestoreRegionSource: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RestoreRegionSource: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
