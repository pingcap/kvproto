...
func (SwitchMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{0}
}
...
func (*SwitchModeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{1}
}
...
func (*Range) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{2}
}
...
func (*SSTMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{3}
}
...
func (*RewriteRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{4}
}
...
func (*UploadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{5}
}
...
func (*UploadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{6}
}
...
func (*IngestRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{7}
}
...
func (*IngestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{8}
}
...
func (*CompactRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{9}
}
...
func (*CompactResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{10}
}
...
type DownloadRequest struct {
	...
	//	*DownloadRequest_Noop
	//	*DownloadRequest_Local
	//	*DownloadRequest_S3
	StorageBackend       isDownloadRequest_StorageBackend `protobuf_oneof:"storage_backend"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (*DownloadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{11}
}
...
type isDownloadRequest_StorageBackend interface {
	isDownloadRequest_StorageBackend()
	MarshalTo([]byte) (int, error)
	Size() int
}

type DownloadRequest_Noop struct {
	Noop *backup.Noop `protobuf:"bytes,14,opt,name=noop,oneof"`
}
type DownloadRequest_Local struct {
	Local *backup.Local `protobuf:"bytes,15,opt,name=local,oneof"`
}
type DownloadRequest_S3 struct {
	S3 *backup.S3 `protobuf:"bytes,16,opt,name=s3,oneof"`
}

func (*DownloadRequest_Noop) isDownloadRequest_StorageBackend()  {}
func (*DownloadRequest_Local) isDownloadRequest_StorageBackend() {}
func (*DownloadRequest_S3) isDownloadRequest_StorageBackend()    {}

func (m *DownloadRequest) GetStorageBackend() isDownloadRequest_StorageBackend {
	if m != nil {
...
func (m *DownloadRequest) GetNoop() *backup.Noop {
	if x, ok := m.GetStorageBackend().(*DownloadRequest_Noop); ok {
		return x.Noop
	}
	return nil
}

func (m *DownloadRequest) GetLocal() *backup.Local {
	if x, ok := m.GetStorageBackend().(*DownloadRequest_Local); ok {
		return x.Local
	}
	return nil
}

func (m *DownloadRequest) GetS3() *backup.S3 {
	if x, ok := m.GetStorageBackend().(*DownloadRequest_S3); ok {
		return x.S3
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*DownloadRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _DownloadRequest_OneofMarshaler, _DownloadRequest_OneofUnmarshaler, _DownloadRequest_OneofSizer, []interface{}{
		(*DownloadRequest_Noop)(nil),
		(*DownloadRequest_Local)(nil),
		(*DownloadRequest_S3)(nil),
	}
}

func _DownloadRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*DownloadRequest)
	// storage_backend
	switch x := m.StorageBackend.(type) {
	case *DownloadRequest_Noop:
		_ = b.EncodeVarint(14<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Noop); err != nil {
			return err
		}
	case *DownloadRequest_Local:
		_ = b.EncodeVarint(15<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Local); err != nil {
			return err
		}
	case *DownloadRequest_S3:
	...
	case nil:
	default:
		return fmt.Errorf("DownloadRequest.StorageBackend has unexpected type %T", x)
	}
	return nil
}

func _DownloadRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*DownloadRequest)
	switch tag {
	case 14: // storage_backend.noop
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(backup.Noop)
		err := b.DecodeMessage(msg)
		m.StorageBackend = &DownloadRequest_Noop{msg}
		return true, err
	case 15: // storage_backend.local
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(backup.Local)
		err := b.DecodeMessage(msg)
		m.StorageBackend = &DownloadRequest_Local{msg}
		return true, err
	case 16: // storage_backend.s3
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(backup.S3)
		err := b.DecodeMessage(msg)
		m.StorageBackend = &DownloadRequest_S3{msg}
		return true, err
	default:
		return false, nil
	}
...
func _DownloadRequest_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*DownloadRequest)
	// storage_backend
	switch x := m.StorageBackend.(type) {
	case *DownloadRequest_Noop:
...
func (*DownloadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{12}
}
...
func (*SetDownloadSpeedLimitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{13}
}
...
func (*SetDownloadSpeedLimitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_import_sstpb_2151e0b45feaaca8, []int{14}
}
...
func (m *DownloadRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StorageBackend != nil {
		nn11, err := m.StorageBackend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn11
...
func (m *DownloadRequest_Noop) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Noop != nil {
		dAtA[i] = 0x72
		i++
		i = encodeVarintImportSstpb(dAtA, i, uint64(m.Noop.Size()))
...
func (m *DownloadRequest_Local) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Local != nil {
		dAtA[i] = 0x7a
		i++
		i = encodeVarintImportSstpb(dAtA, i, uint64(m.Local.Size()))
...
func (m *DownloadRequest_S3) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.S3 != nil {
		dAtA[i] = 0x82
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintImportSstpb(dAtA, i, uint64(m.S3.Size()))
...
func (m *DownloadRequest_Noop) Size() (n int) {
	var l int
	_ = l
	if m.Noop != nil {
		l = m.Noop.Size()
...
func (m *DownloadRequest_Local) Size() (n int) {
	var l int
	_ = l
	if m.Local != nil {
		l = m.Local.Size()
...
func (m *DownloadRequest_S3) Size() (n int) {
	var l int
	_ = l
	if m.S3 != nil {
		l = m.S3.Size()
...
func (m *DownloadRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.StorageBackend = &DownloadRequest_Noop{v}
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
			...
			m.StorageBackend = &DownloadRequest_Local{v}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
			...
			m.StorageBackend = &DownloadRequest_S3{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipImportSstpb(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("import_sstpb.proto", fileDescriptor_import_sstpb_2151e0b45feaaca8) }

var fileDescriptor_import_sstpb_2151e0b45feaaca8 = []byte{
	...
	,
}
