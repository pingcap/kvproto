...
func (Pair_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{26, 0}
}
...
type Lease struct {
	...
	// This is used by SSTMeta to prevent interference between concurrent imports.
...
func (m *Lease) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
// AcquireLease notify TiKV to allow importing data that are described in the
// request.
// The allowance is effective during the time span [now, now+lease].
type AcquireLease struct {
	Lease *Lease `protobuf:"bytes,1,opt,name=lease,proto3" json:"lease,omitempty"`
	// Time to alive in seconds.
...
func (m *AcquireLease) Reset()         { *m = AcquireLease{} }
func (m *AcquireLease) String() string { return proto.CompactTextString(m) }
func (*AcquireLease) ProtoMessage()    {}
func (*AcquireLease) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{7}
}
func (m *AcquireLease) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AcquireLease) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AcquireLease.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AcquireLease) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcquireLease.Merge(m, src)
}
func (m *AcquireLease) XXX_Size() int {
	return m.Size()
}
func (m *AcquireLease) XXX_DiscardUnknown() {
	xxx_messageInfo_AcquireLease.DiscardUnknown(m)
}

var xxx_messageInfo_AcquireLease proto.InternalMessageInfo

func (m *AcquireLease) GetLease() *Lease {
	if m != nil {
		return m.Lease
	}
	return nil
...
func (m *AcquireLease) GetTtl() uint64 {
	if m != nil {
		return m.Ttl
	}
	return 0
...
// ReleaseLease expires leases immediately.
...
func (m *ReleaseLease) Reset()         { *m = ReleaseLease{} }
func (m *ReleaseLease) String() string { return proto.CompactTextString(m) }
func (*ReleaseLease) ProtoMessage()    {}
func (*ReleaseLease) Descriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{8}
}
func (m *ReleaseLease) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReleaseLease) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReleaseLease.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReleaseLease) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReleaseLease.Merge(m, src)
}
func (m *ReleaseLease) XXX_Size() int {
	return m.Size()
}
func (m *ReleaseLease) XXX_DiscardUnknown() {
	xxx_messageInfo_ReleaseLease.DiscardUnknown(m)
}

var xxx_messageInfo_ReleaseLease proto.InternalMessageInfo

func (m *ReleaseLease) GetLease() *Lease {
	if m != nil {
		return m.Lease
	}
	return nil
...
type LeaseRequest struct {
	Acquire              []*AcquireLease `protobuf:"bytes,1,rep,name=acquire,proto3" json:"acquire,omitempty"`
	Release              []*ReleaseLease `protobuf:"bytes,2,rep,name=release,proto3" json:"release,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *LeaseRequest) GetAcquire() []*AcquireLease {
	if m != nil {
		return m.Acquire
	}
	return nil
...
func (m *LeaseRequest) GetRelease() []*ReleaseLease {
	if m != nil {
		return m.Release
	}
	return nil
...
type LeaseResponse struct {
	// The timestamp when the leases take effect (starting from the unix epoch
	// in seconds)
	Timestamp            uint64   `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Acquired             []*Lease `protobuf:"bytes,2,rep,name=acquired,proto3" json:"acquired,omitempty"`
	Released             []*Lease `protobuf:"bytes,3,rep,name=released,proto3" json:"released,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LeaseResponse) GetTimestamp() uint64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *LeaseResponse) GetAcquired() []*Lease {
	if m != nil {
		return m.Acquired
	}
	return nil
...
func (m *LeaseResponse) GetReleased() []*Lease {
	if m != nil {
		return m.Released
	}
	return nil
...
func (m *UploadResponse) GetError() *errorpb.Error {
	if m != nil {
		return m.Error
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Lease)(nil), "import_sstpb.Lease")
	proto.RegisterType((*AcquireLease)(nil), "import_sstpb.AcquireLease")
	proto.RegisterType((*ReleaseLease)(nil), "import_sstpb.ReleaseLease")
	proto.RegisterType((*LeaseRequest)(nil), "import_sstpb.LeaseRequest")
	proto.RegisterType((*LeaseResponse)(nil), "import_sstpb.LeaseResponse")
...
var fileDescriptor_4d076b7935cfab6b = []byte{
	...
	,
}
...
func (c *importSSTClient) Lease(ctx context.Context, in *LeaseRequest, opts ...grpc.CallOption) (*LeaseResponse, error) {
	out := new(LeaseResponse)
	err := c.cc.Invoke(ctx, "/import_sstpb.ImportSST/Lease", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedImportSSTServer) Lease(ctx context.Context, req *LeaseRequest) (*LeaseResponse, error) {
...
func _ImportSST_Lease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LeaseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImportSSTServer).Lease(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/import_sstpb.ImportSST/Lease",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImportSSTServer).Lease(ctx, req.(*LeaseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ImportSST_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Lease",
			Handler:    _ImportSST_Lease_Handler,
		},
		{
			MethodName: "Ingest",
...
func (m *AcquireLease) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AcquireLease) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AcquireLease) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReleaseLease) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReleaseLease) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReleaseLease) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LeaseRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Acquire) > 0 {
		for iNdEx := len(m.Acquire) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Acquire[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *LeaseResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Acquired) > 0 {
		for iNdEx := len(m.Acquired) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Acquired[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.Timestamp != 0 {
		i = encodeVarintImportSstpb(dAtA, i, uint64(m.Timestamp))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AcquireLease) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReleaseLease) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LeaseResponse) Size() (n int) {
	...
	_ = l
	if m.Timestamp != 0 {
		n += 1 + sovImportSstpb(uint64(m.Timestamp))
	}
	if len(m.Acquired) > 0 {
		for _, e := range m.Acquired {
			l = e.Size()
			n += 1 + l + sovImportSstpb(uint64(l))
		}
	}
...
func (m *AcquireLease) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AcquireLease: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AcquireLease: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ReleaseLease) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReleaseLease: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReleaseLease: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LeaseRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Acquire = append(m.Acquire, &AcquireLease{})
			if err := m.Acquire[len(m.Acquire)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.Release = append(m.Release, &ReleaseLease{})
...
func (m *LeaseResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Acquired[len(m.Acquired)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			m.Released = append(m.Released, &Lease{})
