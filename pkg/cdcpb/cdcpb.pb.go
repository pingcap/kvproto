...
func (Event_LogType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{2, 0}
}
...
func (Event_Row_OpType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{2, 0, 0}
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{0}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{1}
}
...
func (*Error_DuplicateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{1, 0}
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{2}
}
...
func (m *Event_Row) GetPreviousValue() []byte {
	if m != nil {
...
func (*Event_Entries) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{2, 1}
}
...
func (*Event_Admin) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{2, 2}
}
...
func (*ChangeDataEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{3}
}
...
type ChangeDataRequest struct {
	...
	RequestId            uint64            `protobuf:"varint,7,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	ExtraRead            kvrpcpb.ExtraRead `protobuf:"varint,8,opt,name=extra_read,json=extraRead,proto3,enum=kvrpcpb.ExtraRead" json:"extra_read,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*ChangeDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcpb_2a01ea533e1e0cb0, []int{4}
}
...
func (m *ChangeDataRequest) GetExtraRead() kvrpcpb.ExtraRead {
	if m != nil {
		return m.ExtraRead
	}
	return kvrpcpb.ExtraRead_Noop
}
...
func (m *Event_Row) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PreviousValue) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintCdcpb(dAtA, i, uint64(len(m.PreviousValue)))
...
func (m *ChangeDataRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExtraRead != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintCdcpb(dAtA, i, uint64(m.ExtraRead))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ChangeDataRequest) Size() (n int) {
	...
	if m.ExtraRead != 0 {
		n += 1 + sovCdcpb(uint64(m.ExtraRead))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ChangeDataRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraRead", wireType)
			}
			m.ExtraRead = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExtraRead |= (kvrpcpb.ExtraRead(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("cdcpb.proto", fileDescriptor_cdcpb_2a01ea533e1e0cb0) }

var fileDescriptor_cdcpb_2a01ea533e1e0cb0 = []byte{
	// 929 bytes of a gzipped FileDescriptorProto
	,
}
