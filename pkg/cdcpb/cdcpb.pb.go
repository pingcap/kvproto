...
type ScanPriority int32

const (
	ScanPriority_SCAN_PRIORITY_UNKNOWN ScanPriority = 0
	ScanPriority_SCAN_PRIORITY_LOW     ScanPriority = 1
	ScanPriority_SCAN_PRIORITY_HIGH    ScanPriority = 2
)

var ScanPriority_name = map[int32]string{
	0: "SCAN_PRIORITY_UNKNOWN",
	1: "SCAN_PRIORITY_LOW",
	2: "SCAN_PRIORITY_HIGH",
}

var ScanPriority_value = map[string]int32{
	"SCAN_PRIORITY_UNKNOWN": 0,
	"SCAN_PRIORITY_LOW":     1,
	"SCAN_PRIORITY_HIGH":    2,
}

func (x ScanPriority) String() string {
	return proto.EnumName(ScanPriority_name, int32(x))
}

func (ScanPriority) EnumDescriptor() ([]byte, []int) {
...
type ChangeDataRequest struct {
	...
	ScanPriority ScanPriority `protobuf:"varint,14,opt,name=scan_priority,json=scanPriority,proto3,enum=cdcpb.ScanPriority" json:"scan_priority,omitempty"`
	// changefeed_id identifies the TiCDC changefeed for logs and debugging only.
	ChangefeedId string `protobuf:"bytes,15,opt,name=changefeed_id,json=changefeedId,proto3" json:"changefeed_id,omitempty"`
}
...
func (m *ChangeDataRequest) GetScanPriority() ScanPriority {
	if m != nil {
		return m.ScanPriority
	}
	return ScanPriority_SCAN_PRIORITY_UNKNOWN
}

func (m *ChangeDataRequest) GetChangefeedId() string {
	if m != nil {
...
func init() {
	proto.RegisterEnum("cdcpb.ScanPriority", ScanPriority_name, ScanPriority_value)
...
var fileDescriptor_911209a1d38ef245 = []byte{
	...
	,
}
...
func (m *ChangeDataRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChangefeedId) > 0 {
		...
		i = encodeVarintCdcpb(dAtA, i, uint64(len(m.ChangefeedId)))
		i--
		dAtA[i] = 0x7a
	}
	if m.ScanPriority != 0 {
		i = encodeVarintCdcpb(dAtA, i, uint64(m.ScanPriority))
		i--
		dAtA[i] = 0x70
	}
	if m.Request != nil {
...
func (m *ChangeDataRequest) Size() (n int) {
	...
	if m.ScanPriority != 0 {
		n += 1 + sovCdcpb(uint64(m.ScanPriority))
	}
...
func (m *ChangeDataRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScanPriority", wireType)
			}
			m.ScanPriority = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ScanPriority |= ScanPriority(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
