...
// See more details in
// https://github.com/tikv/rfcs/blob/master/text/0069-api-v2.md.
...
// tells people that the cluster ID of the request does not match the TiKV
// cluster ID.
...
// Congested is an error tells the client that the TiKV-CDC is congested.
...
type Event_Row struct {
	...
	// generation is for pipelined DML protocol. See
	// kvrpcpb.FlushRequest.generation.
...
// NOTE: events and resolved_ts won't appear simultaneously in one
// ChangeDataEvent.
...
var fileDescriptor_911209a1d38ef245 = []byte{
	...
	,
}
