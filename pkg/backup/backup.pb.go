...
func (CompressionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{0}
}
...
func (*File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{1}
}
...
func (*Schema) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{2}
}
...
func (*RawRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{3}
}
...
func (*ClusterIDError) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{4}
}
...
// Should we let this be an generic error?
type ExternalStorageError struct {
	Retryable bool `protobuf:"varint,1,opt,name=retryable,proto3" json:"retryable,omitempty"`
	// when retry_after >= 0, the client SHOULD retry this request at least $retry_after milliseconds.
	RetryAfter           uint32   `protobuf:"varint,2,opt,name=retry_after,json=retryAfter,proto3" json:"retry_after,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ExternalStorageError) Reset()         { *m = ExternalStorageError{} }
func (m *ExternalStorageError) String() string { return proto.CompactTextString(m) }
func (*ExternalStorageError) ProtoMessage()    {}
func (*ExternalStorageError) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{5}
}
func (m *ExternalStorageError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ExternalStorageError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ExternalStorageError.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ExternalStorageError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExternalStorageError.Merge(dst, src)
}
func (m *ExternalStorageError) XXX_Size() int {
	return m.Size()
}
func (m *ExternalStorageError) XXX_DiscardUnknown() {
	xxx_messageInfo_ExternalStorageError.DiscardUnknown(m)
}

var xxx_messageInfo_ExternalStorageError proto.InternalMessageInfo

func (m *ExternalStorageError) GetRetryable() bool {
	if m != nil {
		return m.Retryable
	}
	return false
...
func (m *ExternalStorageError) GetRetryAfter() uint32 {
	if m != nil {
		return m.RetryAfter
	}
	return 0
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{6}
}
...
type Error_StorageError struct {
	StorageError *ExternalStorageError `protobuf:"bytes,6,opt,name=storage_error,json=storageError,oneof"`
}

func (*Error_ClusterIdError) isError_Detail() {}
func (*Error_KvError) isError_Detail()        {}
func (*Error_RegionError) isError_Detail()    {}
func (*Error_StorageError) isError_Detail()   {}
...
func (m *Error) GetStorageError() *ExternalStorageError {
	if x, ok := m.GetDetail().(*Error_StorageError); ok {
...
func _Error_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Error_StorageError:
		_ = b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.StorageError); err != nil {
			return err
		}
	case nil:
	default:
...
func _Error_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 5: // detail.region_error
		...
		return true, err
	case 6: // detail.storage_error
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ExternalStorageError)
		err := b.DecodeMessage(msg)
		m.Detail = &Error_StorageError{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*BackupRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{7}
}
...
func (*StorageBackend) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{8}
}
...
func (*Noop) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{9}
}
...
func (*Local) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{10}
}
...
func (*S3) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{11}
}
...
func (*GCS) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{12}
}
...
func (*BackupResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_19869afc0e7b86f5, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*ExternalStorageError)(nil), "backup.ExternalStorageError")
...
func (m *ExternalStorageError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ExternalStorageError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.RetryAfter != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintBackup(dAtA, i, uint64(m.RetryAfter))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Error_StorageError) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.StorageError != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintBackup(dAtA, i, uint64(m.StorageError.Size()))
		n5, err := m.StorageError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *BackupRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StorageBackend != nil {
		...
		n6, err := m.StorageBackend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *ExternalStorageError) Size() (n int) {
	var l int
	_ = l
	if m.Retryable {
		n += 2
	...
	if m.RetryAfter != 0 {
		n += 1 + sovBackup(uint64(m.RetryAfter))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Error_StorageError) Size() (n int) {
	var l int
	_ = l
	if m.StorageError != nil {
		l = m.StorageError.Size()
		n += 1 + l + sovBackup(uint64(l))
	}
	return n
}
...
func (m *ExternalStorageError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExternalStorageError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExternalStorageError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			v := &ExternalStorageError{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Detail = &Error_StorageError{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBackup(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("backup.proto", fileDescriptor_backup_19869afc0e7b86f5) }

var fileDescriptor_backup_19869afc0e7b86f5 = []byte{
	...
	,
}
