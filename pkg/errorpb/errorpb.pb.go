...
func (*NotLeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{0}
}
...
type StoreNotMatch struct {
	ExpectStoreId        uint64   `protobuf:"varint,1,opt,name=expect_store_id,json=expectStoreId,proto3" json:"expect_store_id,omitempty"`
	RequestedStoreId     uint64   `protobuf:"varint,2,opt,name=requested_store_id,json=requestedStoreId,proto3" json:"requested_store_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*StoreNotMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{1}
}
...
func (m *StoreNotMatch) GetExpectStoreId() uint64 {
	if m != nil {
		return m.ExpectStoreId
	}
	return 0
}

func (m *StoreNotMatch) GetRequestedStoreId() uint64 {
	if m != nil {
		return m.RequestedStoreId
	}
	return 0
}
...
func (*RegionNotFound) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{2}
}
...
func (*KeyNotInRegion) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{3}
}
...
func (*StaleEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{4}
}
...
func (*ServerIsBusy) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{5}
}
...
func (*StaleCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{6}
}
...
func (*RaftEntryTooLarge) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{7}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_61746eb456e16f22, []int{8}
}
...
func (m *StoreNotMatch) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ExpectStoreId != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintErrorpb(dAtA, i, uint64(m.ExpectStoreId))
	}
	if m.RequestedStoreId != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintErrorpb(dAtA, i, uint64(m.RequestedStoreId))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *StoreNotMatch) Size() (n int) {
	...
	_ = l
	if m.ExpectStoreId != 0 {
		n += 1 + sovErrorpb(uint64(m.ExpectStoreId))
	}
	if m.RequestedStoreId != 0 {
		n += 1 + sovErrorpb(uint64(m.RequestedStoreId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *StoreNotMatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpectStoreId", wireType)
			}
			m.ExpectStoreId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExpectStoreId |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestedStoreId", wireType)
			}
			m.RequestedStoreId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowErrorpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequestedStoreId |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("errorpb.proto", fileDescriptor_errorpb_61746eb456e16f22) }

var fileDescriptor_errorpb_61746eb456e16f22 = []byte{
	// 634 bytes of a gzipped FileDescriptorProto
	,
}
