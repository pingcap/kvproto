...
type StoreNotMatch struct {
	...
	ExpectStoreId    *uint64 `protobuf:"varint,2,opt,name=expect_store_id,json=expectStoreId" json:"expect_store_id,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *StoreNotMatch) GetStoreId() uint64 {
...
var fileDescriptorErrorpb = []byte{
	...
	,
}
