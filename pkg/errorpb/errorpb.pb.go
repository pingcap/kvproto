...
type RangeNotInRegion struct {
	SatrtKey         []byte  `protobuf:"bytes,1,opt,name=satrt_key,json=satrtKey" json:"satrt_key,omitempty"`
...
func (m *RangeNotInRegion) GetSatrtKey() []byte {
	if m != nil {
		return m.SatrtKey
	}
	return nil
...
func (m *RangeNotInRegion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SatrtKey != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintErrorpb(dAtA, i, uint64(len(m.SatrtKey)))
		i += copy(dAtA[i:], m.SatrtKey)
	}
	if m.EndKey != nil {
		dAtA[i] = 0x12
		i++
...
func (m *RangeNotInRegion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SatrtKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SatrtKey = append(m.SatrtKey[:0], dAtA[iNdEx:postIndex]...)
			if m.SatrtKey == nil {
				m.SatrtKey = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorErrorpb = []byte{
	...
	,
}
