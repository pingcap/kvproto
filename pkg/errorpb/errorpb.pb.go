...
func (*NotLeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{0}
}
...
func (*StoreNotMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{1}
}
...
func (*RegionNotFound) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{2}
}
...
func (*KeyNotInRegion) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{3}
}
...
type EpochNotMatch struct {
	...
	IsStale              bool             `protobuf:"varint,2,opt,name=is_stale,json=isStale,proto3" json:"is_stale,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*EpochNotMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{4}
}
...
func (m *EpochNotMatch) GetIsStale() bool {
	if m != nil {
		return m.IsStale
	}
	return false
...
func (*ServerIsBusy) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{5}
}
...
func (*StaleCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{6}
}
...
func (*RaftEntryTooLarge) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{7}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_errorpb_5a38997d7f220e47, []int{8}
}
...
func init() { proto.RegisterFile("errorpb.proto", fileDescriptor_errorpb_5a38997d7f220e47) }

var fileDescriptor_errorpb_5a38997d7f220e47 = []byte{
	// 647 bytes of a gzipped FileDescriptorProto
	,
}
