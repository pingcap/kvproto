...
type FollowerNotReady struct {
	RegionId             uint64   `protobuf:"varint,1,opt,name=region_id,json=regionId,proto3" json:"region_id,omitempty"`
	ReadIndex            uint64   `protobuf:"varint,2,opt,name=read_index,json=readIndex,proto3" json:"read_index,omitempty"`
	ApplyIndex           uint64   `protobuf:"varint,3,opt,name=apply_index,json=applyIndex,proto3" json:"apply_index,omitempty"`
...
func (m *FollowerNotReady) Reset()         { *m = FollowerNotReady{} }
func (m *FollowerNotReady) String() string { return proto.CompactTextString(m) }
func (*FollowerNotReady) ProtoMessage()    {}
func (*FollowerNotReady) Descriptor() ([]byte, []int) {
	return fileDescriptor_390aa86757fd1154, []int{19}
}
func (m *FollowerNotReady) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FollowerNotReady) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FollowerNotReady.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FollowerNotReady) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FollowerNotReady.Merge(m, src)
}
func (m *FollowerNotReady) XXX_Size() int {
	return m.Size()
}
func (m *FollowerNotReady) XXX_DiscardUnknown() {
	xxx_messageInfo_FollowerNotReady.DiscardUnknown(m)
}

var xxx_messageInfo_FollowerNotReady proto.InternalMessageInfo

func (m *FollowerNotReady) GetRegionId() uint64 {
	if m != nil {
		return m.RegionId
	}
	return 0
...
func (m *FollowerNotReady) GetReadIndex() uint64 {
	if m != nil {
		return m.ReadIndex
	}
	return 0
...
func (m *FollowerNotReady) GetApplyIndex() uint64 {
	if m != nil {
		return m.ApplyIndex
	}
	return 0
...
func (m *FollowerNotReady) GetPeerId() uint64 {
	if m != nil {
		return m.PeerId
	}
	return 0
...
type Error struct {
	...
	// FollowerNotReady is the error variant that tells a request be handle by follower, but follower
	// is not ready to handle this request.
	FollowerNotReady     *FollowerNotReady `protobuf:"bytes,21,opt,name=follower_not_ready,json=followerNotReady,proto3" json:"follower_not_ready,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Error) GetFollowerNotReady() *FollowerNotReady {
	if m != nil {
		return m.FollowerNotReady
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*FollowerNotReady)(nil), "errorpb.FollowerNotReady")
...
var fileDescriptor_390aa86757fd1154 = []byte{
	...
	,
}
...
func (m *FollowerNotReady) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FollowerNotReady) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FollowerNotReady) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ApplyIndex != 0 {
		i = encodeVarintErrorpb(dAtA, i, uint64(m.ApplyIndex))
		i--
		dAtA[i] = 0x18
	}
	if m.ReadIndex != 0 {
...
func (m *Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FollowerNotReady != nil {
		{
			size, err := m.FollowerNotReady.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *FollowerNotReady) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.ApplyIndex != 0 {
		n += 1 + sovErrorpb(uint64(m.ApplyIndex))
	}
	if m.PeerId != 0 {
		n += 1 + sovErrorpb(uint64(m.PeerId))
	}
...
func (m *FollowerNotReady) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FollowerNotReady: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FollowerNotReady: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FollowerNotReady", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FollowerNotReady == nil {
				m.FollowerNotReady = &FollowerNotReady{}
			}
			if err := m.FollowerNotReady.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
