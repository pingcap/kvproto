...
/*
Package autoid is a generated protocol buffer package.
...
func (*AutoIDRequest) Descriptor() ([]byte, []int) { return fileDescriptorAutoid, []int{0} }
...
func (*AutoIDResponse) Descriptor() ([]byte, []int) { return fileDescriptorAutoid, []int{1} }
...
func (*RebaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorAutoid, []int{2} }
...
func (*RebaseResponse) Descriptor() ([]byte, []int) { return fileDescriptorAutoid, []int{3} }
...
func (c *autoIDAllocClient) AllocAutoID(ctx context.Context, in *AutoIDRequest, opts ...grpc.CallOption) (*AutoIDResponse, error) {
	...
	err := grpc.Invoke(ctx, "/autoid.AutoIDAlloc/AllocAutoID", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *autoIDAllocClient) Rebase(ctx context.Context, in *RebaseRequest, opts ...grpc.CallOption) (*RebaseResponse, error) {
	...
	err := grpc.Invoke(ctx, "/autoid.AutoIDAlloc/Rebase", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("autoid.proto", fileDescriptorAutoid) }

var fileDescriptorAutoid = []byte{
