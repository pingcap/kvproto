...
type TraceContext struct {
	...
	// The trace info for sql
	SqlTraceInfo         *SQLTraceInfo `protobuf:"bytes,3,opt,name=sql_trace_info,json=sqlTraceInfo,proto3" json:"sql_trace_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *TraceContext) GetSqlTraceInfo() *SQLTraceInfo {
	if m != nil {
		return m.SqlTraceInfo
	}
	return nil
}
...
type SQLTraceInfo struct {
	...
	SessionAlias         string   `protobuf:"bytes,2,opt,name=session_alias,json=sessionAlias,proto3" json:"session_alias,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SQLTraceInfo) Reset()         { *m = SQLTraceInfo{} }
func (m *SQLTraceInfo) String() string { return proto.CompactTextString(m) }
func (*SQLTraceInfo) ProtoMessage()    {}
func (*SQLTraceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_26aed79969e856c7, []int{4}
}
func (m *SQLTraceInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SQLTraceInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SQLTraceInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SQLTraceInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SQLTraceInfo.Merge(m, src)
}
func (m *SQLTraceInfo) XXX_Size() int {
	return m.Size()
}
func (m *SQLTraceInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_SQLTraceInfo.DiscardUnknown(m)
}

var xxx_messageInfo_SQLTraceInfo proto.InternalMessageInfo

func (m *SQLTraceInfo) GetConnectionId() uint64 {
	if m != nil {
...
func (m *SQLTraceInfo) GetSessionAlias() string {
	if m != nil {
...
func (*Property) Descriptor() ([]byte, []int) {
	return fileDescriptor_26aed79969e856c7, []int{8}
}
...
func init() {
	...
	proto.RegisterType((*SQLTraceInfo)(nil), "tracepb.SQLTraceInfo")
...
var fileDescriptor_26aed79969e856c7 = []byte{
	...
	,
}
...
func (m *TraceContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SqlTraceInfo != nil {
		{
			size, err := m.SqlTraceInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SQLTraceInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SQLTraceInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SQLTraceInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.SessionAlias) > 0 {
		...
		i = encodeVarintTracepb(dAtA, i, uint64(len(m.SessionAlias)))
		i--
		dAtA[i] = 0x12
	}
	if m.ConnectionId != 0 {
		i = encodeVarintTracepb(dAtA, i, uint64(m.ConnectionId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SQLTraceInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ConnectionId != 0 {
		n += 1 + sovTracepb(uint64(m.ConnectionId))
	}
...
func (m *TraceContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SqlTraceInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SqlTraceInfo == nil {
				m.SqlTraceInfo = &SQLTraceInfo{}
			}
			if err := m.SqlTraceInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SQLTraceInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SQLTraceInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SQLTraceInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
