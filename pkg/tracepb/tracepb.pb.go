...
/*
Package tracepb is a generated protocol buffer package.
...
func (*TraceRecordRequest) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{0} }
...
func (*TraceRecord) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{1} }
...
func (*RemoteParentSpan) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{2} }
...
func (*TraceContext) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{3} }
...
func (*Report) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{4} }
...
func (*NotifyCollect) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{5} }
...
func (*Span) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{6} }
...
func (*Property) Descriptor() ([]byte, []int) { return fileDescriptorTracepb, []int{7} }
...
func (c *traceRecordPubSubClient) Subscribe(ctx context.Context, in *TraceRecordRequest, opts ...grpc.CallOption) (TraceRecordPubSub_SubscribeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_TraceRecordPubSub_serviceDesc.Streams[0], c.cc, "/tracepb.TraceRecordPubSub/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("tracepb.proto", fileDescriptorTracepb) }

var fileDescriptorTracepb = []byte{
