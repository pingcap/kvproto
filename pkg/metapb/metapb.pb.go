...
func (NodeState) EnumDescriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{1} }
...
func (PeerRole) EnumDescriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{2} }
...
func (*BucketStats) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{4} }
...
func (*Buckets) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{5} }
...
func (*Region) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{6} }
...
func (*Peer) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{7} }
