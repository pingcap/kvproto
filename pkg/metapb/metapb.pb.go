...
type Region struct {
	...
	// The key ranges that are in flashback state.
	KeyRangesInFlashback []*KeyRange `protobuf:"bytes,7,rep,name=key_ranges_in_flashback,json=keyRangesInFlashback,proto3" json:"key_ranges_in_flashback,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Region) GetKeyRangesInFlashback() []*KeyRange {
	if m != nil {
		return m.KeyRangesInFlashback
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*KeyRange)(nil), "metapb.KeyRange")
}
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *Region) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.KeyRangesInFlashback) > 0 {
		for iNdEx := len(m.KeyRangesInFlashback) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.KeyRangesInFlashback[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Region) Size() (n int) {
	...
	if len(m.KeyRangesInFlashback) > 0 {
		for _, e := range m.KeyRangesInFlashback {
			l = e.Size()
			n += 1 + l + sovMetapb(uint64(l))
		}
	}
...
func (m *Region) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KeyRangesInFlashback", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KeyRangesInFlashback = append(m.KeyRangesInFlashback, &KeyRange{})
			if err := m.KeyRangesInFlashback[len(m.KeyRangesInFlashback)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
