...
func (StoreState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{0}
}
...
func (*StoreLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{1}
}
...
// Represet a physical place of the Store. Different locations shall have
// high cost network transmission between each other.
...
func (*Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{2}
}
...
type Store struct {
	...
	// Indicates the location the store is at.
...
func (*Store) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{3}
}
...
func (*RegionEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{4}
}
...
func (*Region) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{5}
}
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_c894a3907bf11af3, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*Location)(nil), "metapb.Location")
...
func (m *Store) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Location != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(m.Location.Size()))
...
func init() { proto.RegisterFile("metapb.proto", fileDescriptor_metapb_c894a3907bf11af3) }

var fileDescriptor_metapb_c894a3907bf11af3 = []byte{
	// 569 bytes of a gzipped FileDescriptorProto
	,
}
