...
type Store struct {
	...
	// Flags for marking the store have support to specific feature.
	// The purpose of this field is to provide the information for deciding whether a feature can be safely
...
func (m *Store) GetFeatureFlags() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*BucketMeta)(nil), "metapb.BucketMeta")
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *Store) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.FeatureFlags != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.FeatureFlags))
		i--
		dAtA[i] = 0x70
	}
	if m.NodeState != 0 {
...
func (m *Store) Size() (n int) {
	...
	if m.FeatureFlags != 0 {
		n += 1 + sovMetapb(uint64(m.FeatureFlags))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 14:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FeatureFlags |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
