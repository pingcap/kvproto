...
type Message struct {
	...
	PriorityV2           int64    `protobuf:"varint,15,opt,name=priority_v2,json=priorityV2,proto3" json:"priority_v2,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Message) GetPriorityV2() int64 {
	if m != nil {
		return m.PriorityV2
	}
	return 0
...
var fileDescriptor_acd9f78e51523dd8 = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PriorityV2 != 0 {
		i = encodeVarintEraftpb(dAtA, i, uint64(m.PriorityV2))
		i--
		dAtA[i] = 0x78
	}
	if m.Priority != 0 {
...
func (m *Message) Size() (n int) {
	...
	if m.PriorityV2 != 0 {
		n += 1 + sovEraftpb(uint64(m.PriorityV2))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PriorityV2", wireType)
			}
			m.PriorityV2 = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PriorityV2 |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
