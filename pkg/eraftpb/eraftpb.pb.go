...
type Entry struct {
	...
	Context   uint64    `protobuf:"varint,6,opt,name=context,proto3" json:"context,omitempty"`
}
...
func (m *Entry) GetContext() uint64 {
	if m != nil {
		return m.Context
	}
	return 0
...
func (m *Entry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Context != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Context))
	}
	return i, nil
}
...
func (m *Entry) Size() (n int) {
	...
	if m.Context != 0 {
		n += 1 + sovEraftpb(uint64(m.Context))
	}
	return n
}
...
var fileDescriptorEraftpb = []byte{
	...
	0x04, 0x2f, 0x16, 0x85, 0xa6, 0x0f, 0x3a, 0x1c, 0xda, 0x36, 0x0d, 0x9c, 0x0a, 0x60, 0x6f, 0x0b,
	...
	,
}
